(function (f) {
      ...
      if ((t && typeof t == "object") || typeof t == "function")
        for (let i of es(t))
          !ts.call(e, i) &&
            ...
            ot(e, i, {
              get: () => t[i],
              enumerable: !(n = Zi(t, i)) || n.enumerable,
            });
      return e;
    };
  var is = (e) => ns(ot({}, "__esModule", { value: !0 }), e);
  var zt = (e, t, r) => rs(e, typeof t != "symbol" ? t + "" : t, r),
    ss = (e, t, r) => t.has(e) || Dr("Cannot " + r);
  var qe = (e, t, r) => (
  ...
  var cs = ke("at", function () {
      if (Array.isArray(this) || typeof this == "string") return ls;
    }),
    I = cs;
  var us = () => {},
    He = us;
  var Fe = "string",
    ...
    ht = "label",
    Le = "break-parent",
    mt = new Set([lt, be, we, ct, Te, ye, Ee, xe, ut, pt, z, ht, Le]);
  function ft(e, t, r) {
    if (!e.has(t)) {
      let n = r(t);
      e.set(t, n);
...
Expected it to be 'string' or 'object'.`;
    if (dt(e)) throw new Error("doc is valid.");
...
`),
  ...
  function Hr(e) {
    return fs(Number.NEGATIVE_INFINITY, e);
  }
  var G = { type: Le };
  function _t(e) {
  ...
  function $(e, t = "", r = {}) {
    return (
      D(e),
      t !== "" && D(t),
      { type: Ee, breakContents: e, flatContents: t, groupId: r.groupId }
    );
  }
  function Fr(e, t) {
    return (
      D(e),
      { type: xe, contents: e, groupId: t.groupId, negate: t.negate }
    );
  }
  function R(e, t) {
    (D(e), gt(t));
  ...
  var S = { type: z },
    ...
    ds = { type: z, hard: !0 },
    k = [ds, G],
    gs = { type: z, hard: !0, literal: !0 },
    Mr = [gs, G];
  var Vr = Object.freeze({ character: "'", codePoint: 39 }),
    Ur = Object.freeze({ character: '"', codePoint: 34 }),
    _s = Object.freeze({ preferred: Vr, alternate: Ur }),
    Ss = Object.freeze({ preferred: Ur, alternate: Vr });
  function Wr(e, t) {
    let { preferred: r, alternate: n } = t === !0 || t === "'" ? _s : Ss,
      { length: i } = e,
      s = 0,
      a = 0;
    for (let o = 0; o < i; o++) {
...
`,
  ...
  function ks(e, t, r, n) {
    ...
    return /^\s*$/.test(s)
      ? ""
      : E(s, e, { parser: "__ng_directive", __isInHtmlAttribute: !1 }, q);
  }
  var $r = ks;
  var bs =
      Object.hasOwn ??
  ...
  var ws =
    ...
    Ts = ke("toReversed", function () {
      if (Array.isArray(this)) return ws;
    }),
    jr = Ts;
  function ys() {
    let e = globalThis,
  ...
  var St = Ds;
  var vt = Symbol.for("PRETTIER_IS_FRONT_MATTER");
  function Is(e) {
    return !!e?.[vt];
  }
  var ae = Is;
...
`)),
  ...
  function kt(e, t) {
    return !!(
      ...
      (Tt(e, t) && !O(e, t) && e.kind !== "interpolation")
    );
  }
  function le(e) {
    return e.kind === "attribute" || !e.parent || !e.prev ? !1 : Hs(e.prev);
  }
  function Hs(e) {
  ...
  function O(e, t) {
    return (
      ...
      (e.fullName === "script" ||
        ...
        (oe(e) && (e.name === "script" || e.name === "style")))
    );
  }
  function rn(e, t) {
  ...
  function nn(e, t) {
    return O(e, t) || e.kind === "interpolation" || tr(e);
  }
  function tr(e) {
              ...
              : !(
                  (!e.prev &&
                    (e.parent.kind === "root" ||
                      ...
                      O(e.parent, t) ||
                      Ge(e.parent, t) ||
                      !Gs(e.parent.cssDisplay))) ||
                  (e.prev && !Ys(e.prev.cssDisplay))
                );
    }
  }
  function an(e, t) {
            ...
            : !(
                (!e.next &&
                  (e.parent.kind === "root" ||
                    ...
                    O(e.parent, t) ||
                    Ge(e.parent, t) ||
                    !$s(e.parent.cssDisplay))) ||
                (e.next && !js(e.next.cssDisplay))
              );
  }
  function on(e, t) {
    return Ks(e.cssDisplay) && !O(e, t);
  }
  function We(e) {
    return (
      ae(e) ||
    ...
    return (
      ...
      (e.kind === "element" &&
        ...
        (["body", "script", "style"].includes(e.name) ||
          e.children.some((t) => Vs(t)))) ||
      (e.firstChild &&
        e.firstChild === e.lastChild &&
        e.firstChild.kind !== "text" &&
        un(e.firstChild) &&
        (!e.lastChild.isTrailingSpaceSensitive || pn(e.lastChild)))
    );
  }
  function rr(e) {
    return (
  ...
  function bt(e) {
    return hn(e) || (e.prev && Fs(e.prev)) || cn(e);
  }
  function Fs(e) {
  ...
  function Us(e, t) {
    ...
    return !s && !i ? "babel" : (St(t, { language: s }) ?? mn(i));
  }
  function Ws(e, t) {
    if (!Tt(e, t)) return;
    let { attrMap: r } = e;
    if (se(r, "src")) return;
    let { type: n, lang: i } = r;
    return St(t, { language: i }) ?? mn(n);
  }
  function zs(e, t) {
    if (e.name === "style") {
      let { lang: r } = e.attrMap;
      return r ? St(t, { language: r }) : "css";
    }
    if (e.name === "mj-style" && t.parser === "mjml") return "css";
  }
  function nr(e, t) {
    return Us(e, t) ?? zs(e, t) ?? Ws(e, t);
  }
  function ze(e) {
  ...
  function fn(e, t) {
    ...
    if (e.kind === "element" && e.namespace === "svg")
      if (Qs(e, (n) => n.fullName === "svg:foreignObject")) r = !0;
  ...
  function dn(e) {
    return e.kind === "element" && (!e.namespace || oe(e)) && se(Zt, e.name)
      ? Zt[e.name]
      : en;
  }
  function ir(e) {
  ...
  var Xs = new Set(["template", "style", "script"]);
  function Ge(e, t) {
    return ce(e, t) && !Xs.has(e.fullName);
  }
  function ce(e, t) {
    return (
      t.parser === "vue" &&
  ...
  function Tt(e, t) {
    return (
      ce(e, t) && (Ge(e, t) || (e.attrMap.lang && e.attrMap.lang !== "html"))
    );
  }
  function gn(e) {
    let t = e.fullName;
  ...
  async function Cn(e, t, r) {
    let n = w(r.node),
      i = [];
    for (let [s, a] of n.split(Sn).entries())
      if (s % 2 === 0) i.push(L(a));
      else
        try {
          i.push(
  ...
  var sr = (e) => (t, r, n) => E(w(n.node), t, { parser: e }, q),
    Zs = [
      {
        test(e) {
      ...
      },
      {
        ...
        print: sr("__ng_binding"),
      },
      {
        test: (e) => e.node.fullName.startsWith("*"),
        print: sr("__ng_directive"),
      },
      { test: (e) => /^i18n(?:-.+)?$/.test(e.node.fullName), print: ea },
      { test: vn, print: Cn },
    ].map(({ test: e, print: t }) => ({
      test: (r, n) => n.parser === "angular" && e(r),
      print: t,
    }));
  function ea(e, t, { node: r }) {
    let n = w(r);
    return j(_t(yt(r, n.trim())), !n.includes("@@"));
  }
  var kn = Zs;
  var bn = ({ node: e }, t) =>
  ...
  var ra = new Set(ar),
    Tn = ({ node: e }, t) =>
      ra.has(e.fullName) && !t.parentParser && !e.value.includes("{{"),
    yn = (e, t, r) =>
      E(
        w(r.node),
        e,
...
` ||
  ...
  function ca(e) {
    ...
    for (;;) {
      ...
      ((l = o),
        (r = c(aa)),
        (n = []),
        r.slice(-1) === "," ? ((r = r.replace(oa, "")), _()) : d());
    }
    function d() {
      for (c(ia), i = "", s = "in descriptor"; ; ) {
        if (((a = e.charAt(o)), s === "in descriptor"))
          if (An(a)) i && (n.push(i), (i = ""), (s = "after descriptor"));
          else if (a === ",") {
            ((o += 1), i && n.push(i), _());
            return;
        ...
        else if (s === "after descriptor" && !An(a))
          if (a === "") {
            _();
            return;
    ...
    function _() {
      ...
      for (W = 0; W < n.length; W++)
        ((Q = n[W]),
          (at = Q[Q.length - 1]),
          (Ce = Q.substring(0, Q.length - 1)),
          (Be = parseInt(Ce, 10)),
          (Wt = parseFloat(Ce)),
          Pn.test(Ce) && at === "w"
            ? ((f || g) && (h = !0), Be === 0 ? (h = !0) : (f = Be))
            : la.test(Ce) && at === "x"
              ? ((f || g || v) && (h = !0), Wt < 0 ? (h = !0) : (g = Wt))
              : Pn.test(Ce) && at === "h"
                ? ((v || g) && (h = !0), Be === 0 ? (h = !0) : (v = Be))
                : (h = !0));
      if (!h)
        ((ie.source = { value: r, startOffset: l }),
          f && (ie.width = { value: f }),
          g && (ie.density = { value: g }),
          v && (ie.height = { value: v }),
          u.push(ie));
      else
  ...
  var Dn = (e) =>
    ...
    In = { width: "w", height: "h", density: "x" },
    ua = Object.keys(In);
  function Rn(e, t, r) {
    let n = w(r.node),
      i = Nn(n),
      s = ua.filter((h) => i.some((f) => se(f, h)));
    if (s.length > 1)
      throw new Error("Mixed descriptor in srcset is not supported");
    let [a] = s,
      o = In[a],
      l = i.map((h) => h.source.value),
      c = Math.max(...l.map((h) => h.length)),
      u = i.map((h) => (h[a] ? String(h[a].value) : "")),
      d = u.map((h) => {
        let f = h.indexOf(".");
  ...
  var On = ({ node: e }, t) =>
    ...
    Mn = async (e, t, r) =>
      j(await e(w(r.node), { parser: "css", __isHTMLStyleAttribute: !0 }));
  var pa = new WeakMap();
  function ha(e, t) {
    return ft(pa, e.root, (r) =>
      r.children.some(
        (n) => Et(n, t) && ["ts", "typescript"].includes(n.attrMap.lang),
      ),
    );
  }
  var H = ha;
  ...
  function qn(e, t, r, n) {
    let i = w(r.node),
      s = H(r, n) ? "babel-ts" : "babel";
    return E(`function _(${i}) {}`, e, { parser: s, __isVueBindings: !0 });
  }
  async function Hn(e, t, r, n) {
    let i = w(r.node),
      { left: s, operator: a, right: o } = ma(i),
      l = H(r, n);
    return [
      C(
        await E(`function _(${s}) {}`, e, {
  ...
  var fa = [
    { test: (e) => e.node.fullName === "v-for", print: Hn },
    {
      test: (e, t) => e.node.fullName === "generic" && Et(e.parent, t),
      print: Bn,
    },
    { test: ({ node: e }, t) => gn(e) || _n(e, t), print: qn },
    {
      test(e) {
        let t = e.node.fullName;
    ...
    { test: (e) => e.node.fullName.startsWith("v-"), print: Fn },
  ].map(({ test: e, print: t }) => ({
  ...
  async function da(e, t, r, n) {
    ...
    let i = w(r.node),
      s = H(r, n) ? "__vue_ts_event_binding" : "__vue_event_binding";
    return E(i, e, { parser: s }, q);
  }
  function ga(e, t, r, n) {
    let i = w(r.node),
      s = H(r, n) ? "__vue_ts_expression" : "__vue_expression";
    return E(i, e, { parser: s }, q);
  }
  function Fn(e, t, r, n) {
    let i = w(r.node),
      s = H(r, n) ? "__ts_expression" : "__js_expression";
    return E(i, e, { parser: s }, q);
  }
  var Vn = fa;
  var _a = [
    ...
    ...Vn,
    ...kn,
  ].map(({ test: e, print: t }) => ({ test: e, print: va(t) }));
  function Sa(e, t) {
    let { node: r } = e,
      { value: n } = r;
    if (n)
  ...
  function $e(e, t) {
    return [e.isSelfClosing ? "" : Ca(e, t), ue(e, t)];
  }
  function Ca(e, t) {
    return e.lastChild && K(e.lastChild) ? "" : [ka(e, t), Lt(e, t)];
  }
  function ue(e, t) {
  ...
  function M(e, t) {
    return K(e) ? Lt(e.parent, t) : je(e) ? At(e.next, t) : "";
  }
  function Lt(e, t) {
    if (zn(e, t)) return "";
    switch (e.kind) {
  ...
  function zn(e, t) {
    return !e.isSelfClosing && !e.endSourceSpan && (le(e) || kt(e.parent, t));
  }
  function V(e) {
    return (
      e.prev &&
  ...
  function K(e) {
    return (
      !e.next && !e.hasTrailingSpaces && e.isTrailingSpaceSensitive && N(wt(e))
    );
  }
  function je(e) {
    return (
  ...
  function wa(e, t, r) {
    let { node: n } = e,
      { attrs: i = [], startTagComments: s = [] } = n;
    if (i.length === 0 && s.length === 0) return n.isSelfClosing ? " " : "";
    let a = n.prev?.kind === "comment" && ba(n.prev.value),
      o =
        typeof a == "boolean"
          ? () => a
          : Array.isArray(a)
            ? (g) => a.includes(g.rawName)
            : () => !1,
      l = ["attrs", "startTagComments"].filter((g) => X(n[g])),
      c = l.flatMap((g) =>
        e.map(
          ({ node: v }) => ({
            loc: F(v),
            printed:
              v.kind === "attribute" && o(v)
                ? L(t.originalText.slice(F(v), J(v)))
                : r(),
          }),
          g,
        ),
    ...
    let u =
        ...
        n.children.length === 0 &&
        s.length === 0,
      d = s.some((g) => g.type === "single"),
      h = d || (t.singleAttributePerLine && i.length > 1 && !ce(n, t)) ? k : S,
      f = [
        A([
          u ? " " : d ? k : S,
          R(
    ...
    return (
      (n.firstChild && Ye(n.firstChild)) ||
      (n.isSelfClosing && he(n.parent)) ||
      u
        ? f.push(n.isSelfClosing ? " " : "")
        : f.push(
            t.bracketSameLine
              ? n.isSelfClosing
                ? " "
  ...
  function Ta(e) {
    return e.firstChild && Ye(e.firstChild) ? "" : Pt(e);
  }
  function Ke(e, t, r) {
    let { node: n } = e;
    return [me(n, t), wa(e, t, r), n.isSelfClosing ? "" : Ta(n)];
  }
  function me(e, t) {
    return e.prev && je(e.prev) ? "" : [B(e, t), At(e, t)];
  }
  function B(e, t) {
    return Ye(e) ? Pt(e.parent) : V(e) ? pe(e.prev, t) : "";
  }
  var Wn = "<!doctype";
  function At(e, t) {
    switch (e.kind) {
  ...
  function ya(e, t) {
    ...
    e.firstChild && Ye(e.firstChild) && (r -= Pt(e).length);
    let n = e.endSourceSpan.start.offset;
    return (
      e.lastChild && K(e.lastChild)
        ? (n += Lt(e, t).length)
        : he(e) && (n -= pe(e.lastChild, t).length),
      t.originalText.slice(r, n)
    );
  }
  var Nt = ya;
  var Ea = new Set(["if", "else if", "for", "switch", "case"]);
  function xa(e, t) {
    let { node: r } = e;
    switch (r.kind) {
      case "element":
        ...
        if (!r.isSelfClosing && Tt(r, t)) {
          ...
          return n
            ? async (i, s) => {
                ...
                return (
                  o ||
                    ((l = await i(er(a), { parser: n, __embeddedInHtml: !0 })),
                    (o = l === "")),
                  [
                    B(r, t),
                    C(Ke(e, t, s)),
        ...
        if (O(r.parent, t)) {
          ...
          if (n)
            return async (i) => {
              let s =
                  n === "markdown"
                    ? P.dedentString(r.value.replace(/^[^\S\n]*\n/, ""))
                    : r.value,
              ...
              if (t.parser === "html" && n === "babel") {
                ...
                (l &&
                  (l.type === "module" ||
                    ((l.type === "text/babel" || l.type === "text/jsx") &&
                      l["data-type"] === "module")) &&
                  (o = "module"),
          ...
          return async (n) => {
            ...
            return (
              ...
              [
                A([S, await n(r.value, i)]),
                r.parent.next && V(r.parent.next) ? " " : S,
              ]
            );
          };
        break;
      ...
      case "angularControlFlowBlockParameters":
        return Ea.has(e.parent.name) ? $r : void 0;
      case "angularLetDeclarationInitializer":
        return (n) =>
          E(r.value, n, { parser: "__ng_binding", __isInHtmlAttribute: !1 });
    }
  }
  var Gn = xa;
  var Qe = null;
  ...
  var La = 10;
  for (let e = 0; e <= La; e++) Xe();
  function or(e) {
    return Xe(e);
  }
  function Aa(e, t = "type") {
    or(e);
    function r(n) {
      let i = n[t],
        s = e[i];
  ...
  var Na = new Set([
    ...
    Da = new Set(["if", "else if", "for", "switch", "case"]);
  function lr(e, t, r) {
    ...
    if (
      (e.kind === "docType" &&
        (t.value = T(0, e.value.toLowerCase(), /\s+/g, " ")),
...
${e}`;
  ...
  function ri(e) {
    let t = J(e);
    return e.kind === "element" && !e.endSourceSpan && X(e.children)
      ? Math.max(t, ri(I(0, e.children, -1)))
      : t;
  }
  function Ze(e, t, r) {
    let n = e.node;
        ...
        L(
          P.trimEnd(
            t.originalText.slice(
              F(n) + (n.prev && je(n.prev) ? At(n).length : 0),
              i - (n.next && V(n.next) ? pe(n, t).length : 0),
            ),
          ),
        ),
        M(n, t),
  ...
  function Dt(e, t) {
    return N(e) && N(t)
      ...
      : (je(e) &&
          ...
          (e.kind === "element" && e.isSelfClosing && V(t))
        ? ""
        : t.kind === "comment" &&
  ...
  function Ae(e, t, r) {
    ...
    return e.map(({ node: s, index: a }) => {
      ...
      let o = [],
        ...
        c = [],
        u = [],
        d = s.prev ? Dt(s.prev, s) : "",
        _ = s.next ? Dt(s, s.next) : "";
      return (
        d &&
          (We(s.prev)
            ? o.push(k, k)
  ...
  function ni(e, t, r) {
    let { node: n } = e,
      i = [];
    (Ma(e) && i.push("} "), i.push("@", n.name));
    let s = Ra(n);
    if (
      (n.parameters && (s || i.push(" "), i.push("(", C(r("parameters")), ")")),
      s)
    )
      return (i.push(";"), i);
    if (!Oa(n)) {
  ...
  var Ia = (e) =>
    ...
    Ra = (e) =>
      e?.kind === "angularControlFlowBlock" && e.name === "default never";
  function Oa(e) {
    return (
      Ia(e) &&
      e.endSourceSpan &&
      ...
      C([
        A([
          ...
          e.map(({ node: i, isLast: s }) => {
            ...
            return (
              i.kind === "text" &&
                (i.hasLeadingSpaces && a.unshift(S),
                i.hasTrailingSpaces && !s && a.push(S)),
              a
            );
          }, "expression"),
        ]),
  ...
  function li(e, t, r) {
    let { node: n } = e;
    if (kt(n, t))
      return [B(n, t), C(Ke(e, t, r)), L(Nt(n, t)), ...$e(n, t), M(n, t)];
    let i =
        n.children.length === 1 &&
      ...
      a = (u) => C([C(Ke(e, t, r), { id: s }), u, $e(n, t)]);
    if (n.children.length === 0)
      return a(n.hasDanglingSpaces && n.isDanglingSpaceSensitive ? S : "");
    let o = (u) =>
        i
          ? Fr(u, { groupId: s })
          : (O(n, t) || Ge(n, t)) &&
  ...
  var mr = { name: "custom-elements" },
    fr = { name: "no-errors-schema" };
  var Ha = /-+([a-z0-9])/g;
  function pi(e) {
    return e.replace(Ha, (...t) => t[1].toUpperCase());
  }
  var hi = class {};
  var Fa = "boolean",
    Va = "number",
  ...
  var za = [
    ...
    Ga = Array.from(mi).reduce((e, [t, r]) => (e.set(t, r), e), new Map()),
    fi = class extends hi {
      _schema = new Map();
        ...
        (super(),
          za.forEach((e) => {
            let t = new Map(),
              ...
              [a, o] = n.split("^");
            a.split(",").forEach((c) => {
              (this._schema.set(c.toLowerCase(), t),
                this._eventSchema.set(c.toLowerCase(), r));
            });
              ...
              if (c.length > 0)
                switch (c[0]) {
                  ...
                  case "!":
                    ...
                    break;
                  case "#":
                    t.set(c.substring(1), Va);
                    break;
                  case "%":
                    t.set(c.substring(1), Wa);
                    break;
                  default:
                    t.set(c, Ua);
                }
      ...
      hasProperty(e, t, r) {
        if (r.some((i) => i.name === fr.name)) return !0;
        let n = It(e);
        if (n.includes("-")) {
          if (ur(n) || pr(n)) return !1;
          if (r.some((i) => i.name === mr.name)) return !0;
        }
        return (this._schema.get(n) || this._schema.get("unknown")).has(t);
      }
      hasElement(e, t) {
        if (t.some((n) => n.name === fr.name)) return !0;
        let r = It(e);
        return r.includes("-") &&
          (ur(r) || pr(r) || t.some((n) => n.name === mr.name))
          ? !0
          : this._schema.has(r);
      }
...
If '${e}' is a directive input, make sure the directive is imported by the current module.`,
      ...
      allKnownAttributesOfElement(e) {
        let t = It(e),
          r = this._schema.get(t) || this._schema.get("unknown");
  ...
  var m = class {
      ...
      constructor({
        ...
        (e && e.length > 0 && e.forEach((l) => (this.closedByChildren[l] = !0)),
          (this.isVoid = i),
    ...
    return (
      tt ||
        ...
        (tt = Object.assign(Object.create(null), {
          ...
          title: new m({ contentType: { default: 1, svg: 2 } }),
          textarea: new m({ contentType: 1, ignoreFirstLf: !0 }),
        })),
...
` && ++o == r
    ...
    te = class extends Error {
      ...
      contextualMessage() {
        ...
        return e
          ? `${this.msg} ("${e.before}[${ja[this.level]} ->]${e.after}")`
          : this.msg;
      }
      toString() {
...
`,
  ...
  function Di(e, t, r, n = {}) {
    let i = new eo(new rt(e, t), r, n);
    return (
      i.tokenize(),
      new Ya(oo(i.tokens), i.errors, i.nonNormalizedIcuExpressions)
    );
  }
  var Ka = /\r\n?/g;
  function Se(e) {
  ...
  var Xa = [
    ...
    eo = class {
      ...
      constructor(e, t, r) {
        ...
        ((this._cursor = r.escapedString ? new lo(e, n) : new Ii(e, n)),
...
`,
      ...
      _getBlockName() {
        ...
        return (
          Za.test(r) ? (r = "else if") : Ja.test(r) && (r = "default never"),
          r
        );
      }
      ...
      _consumeBlockParameters() {
        for (
          this._attemptCharCodeUntilFn(Ai);
      ...
      _consumeLetDeclaration(e) {
        ...
        (this._attemptCharCodeUntilFn((r) => b(r) && !Oe(r)),
          this._consumeLetDeclarationValue(),
          this._cursor.peek() === 59
            ? (this._beginToken(33), this._cursor.advance(), this._endToken([]))
      ...
      _tokenizeExpansionForm() {
        ...
        if (io(this._cursor.peek()) && this._isInExpansionForm())
      ...
      _isBlockStart() {
        return this._cursor.peek() === 64 && Xa.some((e) => this._peekStr(e));
      }
      _isLetStart() {
      ...
      _consumeEntity(e) {
        ...
        if ((this._cursor.advance(), this._attemptCharCode(35))) {
          ...
          try {
            ...
            throw this._createError(
              xi(this._cursor.getChars(t)),
              this._cursor.getSpan(),
            );
          }
        } else {
          let r = this._cursor.clone();
          if ((this._attemptCharCodeUntilFn(no), this._cursor.peek() != 59))
      ...
      _consumePrefixAndName(e) {
        let t = this._cursor.clone(),
          r = "";
        for (; this._cursor.peek() !== 58 && !to(this._cursor.peek()); )
          this._cursor.advance();
        let n;
      ...
      _consumeMultiLineComment(e) {
        ...
        let r = this._cursor.clone(),
          ...
          i = r;
        (this._attemptStr("*/") &&
          ((i = this._cursor.clone()), this._attemptCharCodeUntilFn(b)),
          this._beginToken(12, e),
          this._endToken([n, "multi"], i));
      }
      _consumeTagOpen(e) {
        let t,
          r,
          ...
          s = [];
        try {
          if (this._selectorlessEnabled && Mt(this._cursor.peek()))
          ...
          for (;;) {
            ...
            if (this._selectorlessEnabled && this._cursor.peek() === 64) {
              let o = this._cursor.clone(),
                l = o.clone();
              (l.advance(), Mt(l.peek()) && this._consumeDirective(o, l));
            } else {
        ...
        (this._handleFullNameStackForTagOpen(r, t),
          a === 0
            ...
            : a === 1 && this._consumeRawTextWithTagClose(r, i, n, !0));
      }
      _consumeRawTextWithTagClose(e, t, r, n) {
        (this._consumeRawText(n, () =>
          ...
          this._beginToken(t.type === 35 ? 38 : 3),
      ...
      _consumeComponentName() {
        ...
        return (
          this._cursor.peek() === 58 &&
            (this._cursor.advance(), ([r, n] = this._consumePrefixAndName(ve))),
          [t, r, n]
        );
      }
      _consumeAttribute() {
      ...
      _consumeAttributeName() {
        ...
        if (e === 39 || e === 34)
          throw this._createError(Se(e), this._cursor.getSpan());
        this._beginToken(15);
        let t;
      ...
      _consumeTagClose(e) {
        if (this._selectorlessEnabled) {
          let t = e.clone();
          for (; t.peek() !== 62 && !Mt(t.peek()); ) t.advance();
          if (Mt(t.peek())) {
        ...
        if (
          ...
          for (
            this._openDirectiveCount++,
              ...
              this._endToken([]),
              this._attemptCharCodeUntilFn(b);
            !Ni(this._cursor.peek()) && this._cursor.peek() !== 41;
          )
      ...
      _isInExpansionCase() {
        return (
          ...
          this._expansionCaseStack[this._expansionCaseStack.length - 1] === 23
        );
      }
      _isInExpansionForm() {
        return (
          this._expansionCaseStack.length > 0 &&
          this._expansionCaseStack[this._expansionCaseStack.length - 1] === 21
        );
      }
      isExpansionFormStart() {
        if (this._cursor.peek() !== 123) return !1;
        let e = this._cursor.clone(),
          t = this._attemptStr(it.start);
  ...
  var Ii = class vr {
      ...
      advanceState(t) {
        ...
        (r === 10 ? (t.line++, (t.column = 0)) : Oe(r) || t.column++,
          t.offset++,
          this.updatePeek(t));
      }
      updatePeek(t) {
      ...
      decodeHexDigits(t, r) {
        ...
        if (isNaN(i))
          throw (
            ...
            new kr("Invalid hexadecimal escape sequence", t)
          );
        return i;
      }
    },
    ...
    Bi = class {
      ...
      parse(e, t, r, n = !1, i) {
        let s =
          ...
          _ = new uo(c.tokens, a, u, d, n);
        return (_.build(), new co(_.rootNodes, [...c.errors, ..._.errors]));
      }
    },
    uo = class qi {
      tokens;
      ...
      build() {
        ...
        for (let t of this._containerStack)
          t instanceof ge &&
            this.errors.push(
              x.create(t.name, t.sourceSpan, `Unclosed block "${t.name}"`),
            );
      }
      _advance() {
        let t = this._peek;
      ...
      _consumeCdata(t) {
        let r = this._advance(),
          n = this._getText(r),
          i = this._advanceIf(14);
        this._addToParent(
          new Si(n, new p(t.sourceSpan.start, (i || r).sourceSpan.end), [r]),
        );
      }
      _consumeComment(t) {
      ...
      _consumeDocType(t) {
        let r = this._advanceIf(7),
          n = this._advanceIf(20),
          i = r != null ? r.parts[0].trim() : null,
          s = new p(t.sourceSpan.start, (n || r || t).sourceSpan.end);
      ...
      _consumeExpansion(t) {
        ...
        (this._addToParent(new vi(r.parts[0], n.parts[0], i, s, r.sourceSpan)),
          this._advance());
      }
      _parseExpansionCase() {
        let t = this._advance();
      ...
      _collectExpansionExpTokens(t) {
        ...
        for (;;) {
          if (
            ((this._peek.type === 21 || this._peek.type === 23) &&
...
`
        ...
        if (i.length > 0) {
          let a = t.sourceSpan;
          this._addToParent(
            new _i(i, new p(n.start, a.end, n.fullStart, n.details), r),
          );
        }
      }
      _closeVoidElement() {
      ...
      _consumeElementStartTag(t) {
        ...
        let c = this._peek.sourceSpan.fullStart,
          u = new p(t.sourceSpan.start, c, t.sourceSpan.fullStart),
          d = new p(t.sourceSpan.start, c, t.sourceSpan.fullStart),
          _ = new p(t.sourceSpan.start.moveBy(1), t.sourceSpan.end),
          h = new re(
            a,
            n,
            i,
          ...
          g =
            f !== null &&
            !!(
              !((r = this._getTagDefinition(f)) === null || r === void 0) &&
              r.isClosedByChild(h.name)
            );
        (this._pushContainer(h, g),
          l
            ? this._popContainer(a, re, u)
            : t.type === 4 &&
              (this._popContainer(a, re, null),
              this.errors.push(
                x.create(a, u, `Opening tag "${a}" not terminated.`),
              )));
      }
      _consumeComponentStartTag(t) {
        ...
        let o = this._getClosestElementLikeParent(),
          l = this._getComponentTagName(t, o),
          c = this._getComponentFullName(t, o),
          u = this._peek.type === 37;
        this._advance();
        let d = this._peek.sourceSpan.fullStart,
          _ = new p(t.sourceSpan.start, d, t.sourceSpan.fullStart),
          h = new U(
            n,
            l,
            c,
            ...
            u,
            _,
            new p(t.sourceSpan.start, d, t.sourceSpan.fullStart),
            void 0,
            void 0,
            a,
          ),
          ...
          g =
            ...
            !!(
              !((r = this._getTagDefinition(f)) === null || r === void 0) &&
              r.isClosedByChild(h.tagName)
            );
        (this._pushContainer(h, g),
          u
            ? this._popContainer(c, U, _)
            : t.type === 39 &&
              (this._popContainer(c, U, null),
              this.errors.push(
                x.create(c, _, `Opening tag "${c}" not terminated.`),
              )));
      }
      ...
      _consumeComponentEndTag(t) {
        ...
        if (!this._popContainer(r, U, t.sourceSpan)) {
          let n = this._containerStack[this._containerStack.length - 1],
            i;
          n instanceof U && n.componentName === t.parts[0]
      ...
      _popContainer(t, r, n) {
        ...
        for (let a = this._containerStack.length - 1; a >= 0; a--) {
          ...
          let o = this._containerStack[a],
            l = o instanceof U ? o.fullName : o.name;
          if (Pe(l) ? l === t : (l === t || t === null) && o instanceof r)
            return (
              (o.endSourceSpan = n),
      ...
      _consumeAttr(t) {
        ...
        if (this._peek.type === 17)
          for (
            o = this._peek.sourceSpan, l = this._peek.sourceSpan.end;
            this._peek.type === 17 ||
            this._peek.type === 18 ||
            this._peek.type === 9;
          ) {
            ...
            (a.push(u),
              u.type === 18
                ? (s += u.parts.join("").replace(/&([^;]+);/g, Oi))
                : u.type === 9
                  ? (s += u.parts[0])
                  : (s += u.parts.join("")),
              (l = n = u.sourceSpan.end));
          }
        ...
        return new ki(
          r,
          s,
          new p(t.sourceSpan.start, n, t.sourceSpan.fullStart),
          t.sourceSpan,
          c,
          a.length > 0 ? a : void 0,
          void 0,
      ...
      _consumeDirective(t) {
        ...
        let s = new p(t.sourceSpan.start, n, t.sourceSpan.fullStart),
          a = new p(
            s.start,
      ...
      _consumeBlockOpen(t) {
        ...
        for (; this._peek.type === 29; ) {
          let o = this._advance();
          r.push(new dr(o.parts[0], o.sourceSpan));
        }
        this._peek.type === 27 && this._advance();
        let n = this._peek.sourceSpan.fullStart,
          i = new p(t.sourceSpan.start, n, t.sourceSpan.fullStart),
          s = new p(t.sourceSpan.start, n, t.sourceSpan.fullStart),
          a = new ge(t.parts[0], r, [], i, t.sourceSpan, s);
        this._pushContainer(a, !1);
      }
      _consumeBlockClose(t) {
        let r = this._containerStack.length,
          n = this._containerStack[r - 1];
          ...
          if (this._containerStack.length < r) {
            ...
            this.errors.push(
              x.create(
                null,
                t.sourceSpan,
                `Unexpected closing block. The block may have been closed earlier. Did you forget to close the <${i}> element? If you meant to write the \`}\` character, you should use the "&#125;" HTML entity instead.`,
              ),
            );
            return;
          }
      ...
      _consumeIncompleteBlock(t) {
        ...
        let n = this._peek.sourceSpan.fullStart,
          ...
          a = new ge(t.parts[0], r, [], i, t.sourceSpan, s);
        (this._pushContainer(a, !1),
          this._popContainer(null, ge, null),
          this.errors.push(
            x.create(
              t.parts[0],
              i,
      ...
      _consumeLet(t) {
        ...
        let s = i.sourceSpan.end,
          a = new p(t.sourceSpan.start, s, t.sourceSpan.fullStart),
          o = t.sourceSpan.toString().lastIndexOf(r),
          l = new p(t.sourceSpan.start.moveBy(o), t.sourceSpan.end),
          c = new gr(r, n.parts[0], a, l, n.sourceSpan);
        this._addToParent(c);
      }
      _consumeIncompleteLet(t) {
        ...
        if (r.length > 0) {
          let i = t.sourceSpan.toString().lastIndexOf(r),
            s = new p(t.sourceSpan.start.moveBy(i), t.sourceSpan.end),
            a = new p(t.sourceSpan.start, t.sourceSpan.start.moveBy(0)),
            o = new gr(r, "", t.sourceSpan, s, a);
          this._addToParent(o);
        }
        this.errors.push(
          x.create(
  ...
  var po = [mo, fo, _o, vo, Co, wo, ko, bo, To, So];
  function ho(e, t) {
    for (let r of po) r(e, t);
    return e;
  }
  function mo(e) {
    e.walk((t) => {
...
`
      ...
      if (r.children)
        for (let n = 0; n < r.children.length; n++) {
          ...
          let s = i.prev,
            a = i.firstChild;
          (r.removeChild(s), n--);
          let o = new p(s.sourceSpan.start, a.sourceSpan.end),
            l = new p(o.start, i.sourceSpan.end);
      ...
      if (n.children)
        for (let i = 0; i < n.children.length; i++) {
          ...
          !a ||
            a.kind !== "text" ||
            ((a.value += s.value),
            (a.sourceSpan = new p(a.sourceSpan.start, s.sourceSpan.end)),
            n.removeChild(s),
            i--);
        }
    });
  ...
  function So(e) {
    let t = (r) =>
      r.kind === "element" &&
      r.attrs.length === 0 &&
      !X(r.startTagComments) &&
      r.children.length === 1 &&
      r.firstChild.kind === "text" &&
      !P.hasWhitespaceCharacter(r.children[0].value) &&
      ...
      if (r.children)
        for (let n = 0; n < r.children.length; n++) {
          ...
          ((s.value +=
            ...
            `</${i.rawName}>` +
            a.value),
            (s.sourceSpan = new p(s.sourceSpan.start, a.sourceSpan.end)),
      ...
      if (!i)
        for (let a = 0; a < n.length; a++) {
          ...
          c
            ? ((o.value = c),
              (o.sourceSpan = new p(
                o.sourceSpan.start.moveBy(l.length),
                o.sourceSpan.end.moveBy(-u.length),
              )),
              l && (d && (d.hasTrailingSpaces = !0), (o.hasLeadingSpaces = !0)),
              u && ((o.hasTrailingSpaces = !0), _ && (_.hasLeadingSpaces = !0)))
            : (r.removeChild(o),
              a--,
              (l || u) &&
                (d && (d.hasTrailingSpaces = !0),
                _ && (_.hasLeadingSpaces = !0)));
        }
  ...
  function To(e, t) {
    e.walk((r) => {
      ...
      if (n) {
        ...
        for (let i of n)
          ((i.isLeadingSpaceSensitive = sn(i, t)),
            (i.isTrailingSpaceSensitive = an(i, t)));
    ...
    switch (n.kind) {
      ...
      case "text": {
        if (n.parent.kind === "interpolation") {
          let o = /\n[^\S\n]*$/,
            l = o.test(n.value),
            c = l ? n.value.replace(o, "") : n.value;
          return [L(c), l ? k : ""];
        }
        let i = B(n, t),
          s = yt(n),
          a = M(n, t);
        return ((s[0] = [i, s[0]]), s.push([s.pop(), a]), _t(s));
      }
      case "docType":
        return [
          C([
  ...
  var Ft = { attrs: !0, children: !0, cases: !0, expression: !0 },
    ji = new Set(["parent"]),
    ne,
    yr,
    Er,
    Me = class Me {
      constructor(t = {}) {
        ...
        zt(this, "kind");
        zt(this, "parent");
        for (let r of new Set([...ji, ...Object.keys(t)]))
      ...
      setProperty(t, r) {
        if (this[t] !== r) {
          if (
            (t in Ft && (r = r.map((n) => this.createChild(n))), !ji.has(t))
          ) {
            this[t] = r;
            return;
          }
      ...
      map(t) {
        ...
        for (let n in Ft) {
          let i = this[n];
          if (i) {
            let s = Po(i, (a) => a.map(t));
            r !== i &&
              (r ?? (r = new Me({ parent: this.parent })), r.setProperty(n, s));
          }
        }
        if (r) for (let n in this) n in Ft || (r[n] = this[n]);
        return t(r || this);
      }
      walk(t) {
        for (let r in Ft) {
      ...
      get $children() {
        return this[qe(this, ne, yr)];
      }
      set $children(t) {
        this[qe(this, ne, yr)] = t;
      }
      get firstChild() {
  ...
  var No = [
    ...
    { regex: /^\[if(?<condition>[^\]]*)\]><!$/, parse: Io },
    { regex: /^<!\s*\[endif\]$/, parse: Ro },
  ];
  function Yi(e, t) {
    if (e.value)
      for (let { regex: r, parse: n } of No) {
    ...
    let { openingTagSuffix: n, condition: i, data: s } = t.groups,
      ...
      [c, u] = (() => {
        try {
          ...
          return [!1, [{ kind: "text", value: s, sourceSpan: new p(o, l) }]];
        }
      })();
    return {
  ...
  var xr = class extends _r {
    ...
    visit(t, { parseOptions: r }) {
      (qo(t), Ho(t, r), Vo(t, r), Fo(t));
    }
  };
  function Xi(e, t, r, n) {
    let i = r.name === "angular";
    (Rt(new xr(), e.children, { parseOptions: r }), t && e.children.unshift(t));
    let s = new Vt(e);
    return (
      s.walk((a) => {
        if (a.kind === "comment") {
          ...
          i &&
            a.kind === "element" &&
            a.comments &&
            ((a.startTagComments = a.comments), delete a.comments);
        i && (Oo(a), Mo(a), Bo(a));
      }),
      s
    );
  ...
  function Oo(e) {
    if (e.kind === "block") {
      if (
        ((e.name = T(0, e.name.toLowerCase(), /\s+/g, " ").trim()),
        (e.kind = "angularControlFlowBlock"),
        !X(e.parameters))
      ) {
        delete e.parameters;
      ...
      e.parameters = {
        ...
        sourceSpan: new p(
          ...
          I(0, e.parameters, -1).sourceSpan.end,
        ),
      };
    }
  }
  ...
  function Ho(e, t) {
    if (e.kind === "element") {
      ...
      !e.namespace || e.namespace === r.implicitNamespacePrefix || oe(e)
        ? (e.tagDefinition = r)
        : (e.tagDefinition = Ne(""));
    }
  }
  function Fo(e) {
    e.sourceSpan &&
      e.endSourceSpan &&
      (e.sourceSpan = new p(e.sourceSpan.start, e.endSourceSpan.end));
  }
  function Vo(e, t) {
    if (
      e.kind === "element" &&
      ...
      for (let r of e.attrs)
        r.namespace ||
          (r.name = Ki(
            r.name,
            (n) =>
              Ht.has(e.name) && (Ht.get("*").has(n) || Ht.get(e.name).has(n)),
          ));
  }
  function Ar(e, t) {
    let { rootNodes: r, errors: n } = Bt(e, Tr(t));
    return (n.length > 0 && Lr(n[0]), { parseOptions: t, rootNodes: r });
  }
  function Ji(e, t) {
    let r = Tr(t),
      { rootNodes: n, errors: i } = Bt(e, r);
    if (
      n.some(
        (c) =>
          (c.kind === "docType" && c.value === "html") ||
          (c.kind === "element" && c.name.toLowerCase() === "html"),
      )
    )
      return Ar(e, Ut);
    let a,
      o = () => a ?? (a = Bt(e, { ...r, getTagContentType: void 0 })),
      l = (c) => {
        let { offset: u } = c.startSourceSpan.start;
        return (
          o().rootNodes.find(
            (d) => d.kind === "element" && d.startSourceSpan.start.offset === u,
          ) ?? c
        );
      };
    for (let [c, u] of n.entries())
      if (u.kind === "element") {
        if (u.isVoid) ((i = o().errors), (n[c] = l(u)));
          ...
          let { endSourceSpan: d, startSourceSpan: _ } = u,
            h = o().errors.find(
              (f) =>
                f.span.start.offset > _.start.offset &&
                f.span.start.offset < d.end.offset,
            );
          (h && Lr(h), (n[c] = l(u)));
        }
      }
    return (i.length > 0 && Lr(i[0]), { parseOptions: t, rootNodes: n });
  }
  function Uo(e) {
  ...
  function Wo(e, t, r, n, i, s) {
    let { offset: a } = n,
      o = Ct(t.slice(0, a)) + r,
      l = Pr(o, e, { ...i, shouldParseFrontMatter: !1 }, s);
  ...
  function Pr(e, t, r, n = {}) {
    let { frontMatter: i, content: s } = r.shouldParseFrontMatter
        ? Xt(e)
        : { content: e },
      a = new rt(e, n.filepath),
      o = new De(a, 0, 0, 0),
      l = o.moveBy(e.length),
      { parseOptions: c, rootNodes: u } = t(s, r),
      d = { kind: "root", sourceSpan: new p(o, l), children: u },
      _;
    if (i) {
      let [f, g] = [i.start, i.end].map(
        (v) => new De(a, v.index, v.line - 1, v.column),
      );
      _ = { ...i, kind: "frontMatter", sourceSpan: new p(f, g) };
    }
    return Xi(d, _, c, (f, g) => Wo(t, e, f, g, c, n));
  }
  var Ut = qt({
    name: "html",
    normalizeTagName: !0,
  ...
  var zo = st(Ut),
    Go = new Set(["mj-style", "mj-raw"]),
    $o = st({ ...Ut, name: "mjml", shouldParseAsRawText: (e) => Go.has(e) }),
    jo = st({
      name: "angular",
