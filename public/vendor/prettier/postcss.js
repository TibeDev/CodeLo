(function (f) {
  ...
  var Ne = (t, e, s) => (
      ...
      mn(
        e || !t || !t.__esModule
          ? Tt(s, "default", { value: t, enumerable: !0 })
          : s,
        t,
      )
    ),
    Gl = (t) => mn(Tt({}, "__esModule", { value: !0 }), t);
  var Vi = w((Ux, ms) => {
    var _ = String,
      Yi = function () {
        return {
      ...
      ot = class t extends Error {
        ...
        showSourceCode(e) {
          ...
          let r = (f) => f,
            ...
            i = (f) => f;
          if (e) {
            let { bold: f, gray: h, red: l } = zi.createColors(!0);
            ((n = (d) => f(l(d))), (r = (d) => h(d)), ji && (i = (d) => ji(d)));
          }
          let o = s.split(/\r?\n/),
          ...
          return o.slice(u, a).map((f, h) => {
            ...
            if (l === this.line) {
              if (f.length > 160) {
                let m = 20,
                  p = Math.max(0, this.column - m),
                  y = Math.max(this.column + m, this.endColumn + m),
                  g = f.slice(p, y),
                  v =
                    r(d.replace(/\d/g, " ")) +
                    f
                      .slice(0, Math.min(this.column - 1, m - 1))
                      .replace(/[^\t]/g, " ");
                return (
                  n(">") +
                  r(d) +
  ...
  var Jt = w((Gx, Ki) => {
    ...
    function fe(t) {
      return typeof t != "string" || !t.includes("<")
        ? t
        : t.replace(Zc, "\\3c $2").replace(ef, "\\3c $2");
    }
    var Qi = {
      after: `
`,
...
`,
    ...
    var at = class {
      ...
      atrule(e, s) {
        ...
        if (
          (typeof r.afterName < "u" ? (n += r.afterName) : i && (n += " "),
          e.nodes)
        )
          this.block(e, n + i);
        else {
...
`)
      ...
      decl(e, s) {
        ...
        (e.important && (i += r.important || " !important"),
          s && (i += ";"),
          this.builder(fe(i), e));
      }
      document(e) {
...
`);
      ...
      root(e) {
        if ((this.body(e), e.raws.after)) {
          let s = e.raws.after,
            r = e.parent && e.parent.type === "document";
      ...
      rule(e) {
        (this.block(e, this.rawValue(e, "selector")),
          e.raws.ownSemicolon &&
            this.builder(fe(e.raws.ownSemicolon), e, "end"));
      }
      stringify(e, s) {
        if (!this[e.type])
          throw new Error(
    ...
    var ct = class {
      ...
      constructor(e = {}) {
        ...
        for (let s in e)
          if (s === "nodes") {
            this.nodes = [];
            for (let r of e[s])
              typeof r.clone == "function" && r.parent
                ? this.append(r.clone())
                : this.append(r);
          } else this[s] = e[s];
      }
      ...
      positionBy(e = {}) {
        ...
        if (e.index) r = this.positionInside(e.index);
          ...
          let i = s
            .slice(J(s, this.source.start), J(s, this.source.end))
            .indexOf(e.word);
...
`
      ...
      rangeBy(e = {}) {
        ...
        if (e.word) {
          ...
          (e.start
            ...
            : typeof e.index == "number" && (r = this.positionInside(e.index)),
            e.end
              ? (n = {
                  column: e.end.column,
                  line: e.end.line,
  ...
  var pe = w((Qx, lo) => {
    ...
    function ao(t) {
      return t.map(
        (e) => (e.nodes && (e.nodes = ao(e.nodes)), delete e.source, e),
      );
    }
    function uo(t) {
      if (((t[so] = !1), t.proxyOf.nodes)) for (let e of t.proxyOf.nodes) uo(e);
    }
    ...
    z.rebuild = (t) => {
      (t.type === "atrule"
        ...
        : t.type === "rule"
          ? Object.setPrototypeOf(t, xs.prototype)
          : t.type === "decl"
            ? Object.setPrototypeOf(t, ro.prototype)
            : t.type === "comment"
              ? Object.setPrototypeOf(t, to.prototype)
              : t.type === "root" && Object.setPrototypeOf(t, oo.prototype),
        (t[no] = !0),
        t.nodes &&
          t.nodes.forEach((e) => {
            z.rebuild(e);
  ...
  var fo = w((Kx, co) => {
    var ff = "useandom-26T198340PX75pxJACKVERYMINDBUSHWOLF_GQZbfghjklqvwyzrict",
      pf =
        (t, e = 21) =>
        (s = e) => {
          let r = "",
  ...
  var $e = w((t_, vo) => {
    "use strict";
    var { nanoid: mf } = fo(),
      { isAbsolute: Ss, resolve: Ts } = {},
      { SourceMapConsumer: df, SourceMapGenerator: yf } = po(),
      { fileURLToPath: mo, pathToFileURL: er } = {},
      yo = Xt(),
      gf = _s(),
      bs = ds(),
      Es = Symbol("lineToIndexCache"),
      wf = !!(df && yf),
      go = !!(Ts && Ss);
    function wo(t) {
      if (t[Es]) return t[Es];
...
`),
    ...
    var We = class {
      ...
      constructor(e, s = {}) {
        ...
        (this.file || (this.id = "<input css " + mf(6) + ">"),
      ...
      error(e, s, r, n = {}) {
        ...
        return (
          ...
          this.file &&
            (er && (c.input.url = er(this.file).toString()),
      ...
      origin(e, s, r, n) {
        ...
        let i = this.map.consumer(),
          o = i.originalPositionFor({ column: s - 1, line: e });
        if (!o.source) return !1;
        let u;
        typeof r == "number" &&
          (u = i.originalPositionFor({ column: n - 1, line: r }));
        let a;
        Ss(o.source)
          ? (a = er(o.source))
          : (a = new URL(
              o.source,
              this.map.consumer().sourceRoot || er(this.map.mapFile),
            ));
        let c = {
          column: o.column + 1,
      ...
      function se(k) {
        ...
        switch (((i = r.charCodeAt(p)), i)) {
          ...
          case 64: {
            ((sr.lastIndex = p + 1),
              sr.test(r),
              sr.lastIndex === 0 ? (a = r.length - 1) : (a = sr.lastIndex - 2),
    ...
    var As = class {
      ...
      decl(e, s) {
        ...
        (n[0] === ";" && ((this.semicolon = !0), e.pop()),
          (r.source.end = this.getPosition(n[3] || n[2] || kf(e))),
          r.source.end.offset++);
        let i = 0;
        for (; e[i][0] !== "word"; )
          (i === e.length - 1 && this.unknownWord([e[i]]), i++);
        ((r.raws.before += Os(e, 0, i)),
          (r.source.start = this.getPosition(e[i][2])));
        let o = i;
        for (; i < e.length; ) {
          let l = e[i][0];
        ...
        let u = i,
          a;
        for (; i < e.length && ((a = e[i]), i++, a[0] !== ":"); )
          a[0] === "word" && /\w/.test(a[1]) && this.unknownWord([a]);
        ((r.raws.between = Os(e, u, i)),
          (r.prop[0] === "_" || r.prop[0] === "*") &&
        ...
        for (let l = e.length - 1; l >= 0; l--) {
          if (((a = e[l]), a[1].toLowerCase() === "!important")) {
            ...
            ((d = this.spacesFromEnd(e) + d),
              d !== " !important" && (r.raws.important = d));
            break;
            ...
            x.trim().startsWith("!") &&
              ((r.important = !0), (r.raws.important = x), (e = d));
          }
          if (a[0] !== "space" && a[0] !== "comment") break;
        }
        (e.some((l) => l[0] !== "space" && l[0] !== "comment") &&
          ((r.raws.between += f.map((l) => l[1]).join("")), (f = [])),
          this.raw(r, "value", f.concat(e), s),
...
`),
          ...
          return (
            ...
            n && ((this.input = new Pf(n)), (this.tokenizer = Nf(this.input))),
            !0
          );
        } else if (t[1] === "/") {
          ...
          if (e[0] === "comment" && /^\/\*/.test(e[1]))
            return (
              ...
              Cs.exports.isInlineComment.bind(this)(t)
            );
        }
        return !1;
      },
  ...
  var Uo = w((f_, Bo) => {
    var Rf = /^#[0-9a-fA-F]{6}$|^#[0-9a-fA-F]{3}$/,
      If = /\.[0-9]/,
      Lf = (t) => {
        let [, e] = t,
          [s] = e;
        return (
          (s === "." || s === "#") && Rf.test(e) === !1 && If.test(e) === !1
        );
      };
  ...
  var Ho = w((d_, jo) => {
    ...
    jo.exports = class extends Bf {
      ...
      atrule(e) {
        zo.bind(this)(e) ||
          (super.atrule(e), Wf(this.lastNode), $f(this.lastNode));
      }
      decl(...e) {
        (super.decl(...e),
      ...
      mixin(e) {
        ...
        let u = [];
        for (let c of e)
          if (((c[1] === "!" || u.length) && u.push(c), c[1] === "important"))
            break;
        if (u.length) {
          let [c] = u,
            f = e.indexOf(c),
            ...
            l = [c[2], c[3]],
            d = [h[4], h[5]],
            m = ["word", u.map((p) => p[1]).join("")].concat(l, d);
      ...
      rule(e) {
        ...
        if (
          r[0] === "at-word" &&
          s[0] === "{" &&
          (this.tokenizer.back(s), zo.bind(this)(r))
        ) {
  ...
  var ra = w((x_, ta) => {
    ...
    function gt(t, e) {
      ...
      let n;
      if (
        (r.nodes && ((n = t.nodes.map((o) => gt(o, e))), delete r.nodes),
        r.source)
      ) {
  ...
  var Is = w((T_, aa) => {
    ...
    aa.exports = function (e) {
      oa[e] ||
        ((oa[e] = !0), typeof console < "u" && console.warn && console.warn(e));
    };
  });
  var Ds = w((O_, fa) => {
    "use strict";
    var sp = pe(),
      ...
      pp = { Once: !0, postcssPlugin: !0, prepare: !0 },
      ze = 0;
    function xt(t) {
      ...
      me = class t {
        ...
        constructor(e, s, r) {
          ...
          if (
            ...
            n = Ls(s);
          else if (s instanceof t || s instanceof ua)
            ((n = Ls(s.root)),
              s.map &&
          ...
          ((this.result = new ua(e, n, r)),
            (this.helpers = { ...qs, postcss: qs, result: this.result }),
        ...
        visitTick(e) {
          ...
          for (; s.eventIndex < i.length; ) {
            ...
            if (((s.eventIndex += 1), o === ze)) {
              r.nodes &&
                r.nodes.length &&
                ((r[Z] = !0), (s.iterator = r.getIterator()));
              return;
      ...
      _t = class {
        ...
        constructor(e, s, r) {
          ((s = s.toString()),
            ...
            (this._map = void 0));
          let n = yp;
          ((this.result = new dp(this._processor, void 0, this._opts)),
            (this.result.css = s));
          let i = this;
...
https://evilmartians.com/chronicles/postcss-8-plugin-migration`,
        ...
        return (
          (u.postcssPlugin = e),
          (u.postcssVersion = new Ms().version),
          u
        );
      }
      let i;
        ...
        switch (((i = r.charCodeAt(m)), i)) {
          ...
          case 40: {
            if (
              ...
              ((a = r.slice(m, o + 1)), (d = ["brackets", a, m, o]), (m = o));
            } else
              ((o = r.indexOf(")", m + 1)),
                (a = r.slice(m, o + 1)),
                o === -1 || Ip.test(a)
                  ? (d = ["(", "(", m])
                  : ((d = ["brackets", a, m, o]), (m = o)));
            break;
          }
          case 39:
          case 34: {
            for (
              ...
              i === 92 ? (f = !f) : f ? (f = !1) : i === 35 && l === 123 && W();
            ((d = ["string", r.slice(m, o + 1), m, o]), (m = o));
            break;
          }
          case 64: {
            ((fr.lastIndex = m + 1),
              fr.test(r),
              fr.lastIndex === 0 ? (o = r.length - 1) : (o = fr.lastIndex - 2),
              (d = ["at-word", r.slice(m, o + 1), m, o]),
              (m = o));
            break;
          }
          case 92: {
            for (o = m, c = !0; r.charCodeAt(o + 1) === 92; )
              ((o += 1), (c = !c));
            if (
              ((i = r.charCodeAt(o + 1)),
              c &&
          ...
          default:
            ((l = r.charCodeAt(m + 1)),
              i === 35 && l === 123
                ...
                : i === 47 && l === 42
                  ? ((o = r.indexOf("*/", m + 2) + 1),
                    o === 0 && (n || b ? (o = r.length) : C("comment")),
                    (d = ["comment", r.slice(m, o + 1), m, o]),
                    (m = o))
                  : i === 47 && l === 47
                    ? ((hr.lastIndex = m + 1),
                      hr.test(r),
...
`)
        ...
        (n
          ...
          n &&
            ...
            i.type === "media-feature-expression" &&
              (i.nodes = Da(i.value, i.sourceIndex)),
            s.push(
              Array.isArray(i.nodes) ? new Ys.default(i) : new La.default(i),
            ),
            (i = o()),
            (n = !1)));
      }
  ...
  var M = w((B) => {
    ...
    var Q_ = (B.TAG = "tag"),
      K_ = (B.STRING = "string"),
      X_ = (B.SELECTOR = "selector"),
      J_ = (B.ROOT = "root"),
      Z_ = (B.PSEUDO = "pseudo"),
      eb = (B.NESTING = "nesting"),
      tb = (B.ID = "id"),
      rb = (B.COMMENT = "comment"),
      sb = (B.COMBINATOR = "combinator"),
      nb = (B.CLASS = "class"),
      ib = (B.ATTRIBUTE = "attribute"),
      ob = (B.UNIVERSAL = "universal");
  });
  var yr = w((dr, za) => {
    "use strict";
    dr.__esModule = !0;
      ...
      for (
        ...
        switch (((r = s.charCodeAt(y)), r === St && ((m = y), (p += 1)), r)) {
          ...
          case Zs:
            ...
            (e.push(["space", s.slice(y, n), p, y - m, y]), (y = n - 1));
            break;
          case bu:
          case Eu:
          case Su:
          case Tu:
            ...
            (e.push(["combinator", s.slice(y, n), p, y - m, y]), (y = n - 1));
            break;
          case ku:
            e.push(["*", "*", p, y - m, y]);
            break;
          ...
          case md:
            ...
            do
              for (
                ...
                ((d -= 1), (l = !l));
            while (l);
            (e.push(["string", s.slice(y, n + 1), p, y - m, p, n - m, y]),
              (y = n));
            break;
          case Ed:
            ((Pr.lastIndex = y + 1),
              Pr.test(s),
              Pr.lastIndex === 0 ? (n = s.length - 1) : (n = Pr.lastIndex - 2),
              e.push(["at-word", s.slice(y, n + 1), p, y - m, p, n - m, y]),
              (y = n));
            break;
          case Xs:
            for (n = y, c = !0; s.charCodeAt(n + 1) === Xs; )
              ((n += 1), (c = !c));
            ((r = s.charCodeAt(n + 1)),
              c &&
                r !== _u &&
                ...
                r !== Zs &&
                (n += 1),
              e.push(["word", s.slice(y, n + 1), p, y - m, p, n - m, y]),
              (y = n));
            break;
          default:
            r === _u && s.charCodeAt(y + 1) === ku
              ? ((n = s.indexOf("*/", y + 2) + 1),
                n === 0 && g("comment", "*/"),
                (a = s.slice(y, n + 1)),
                (o = a.split(`
`)),
                ...
                u > 0
                  ...
                  : ((f = p), (h = m)),
                e.push(["comment", a, p, y - m, f, n - h, y]),
                (m = h),
                (p = f),
                (y = n))
              : ((Rr.lastIndex = y + 1),
    ...
    var ay = (function () {
      function t(e) {
        (oy(this, t),
          ...
          (this.position = 0),
          (this.root = new Rd.default()));
        var s = new sn.default();
        return (
          this.root.append(s),
          (this.current = s),
          this.lossy
            ? (this.tokens = (0, Cu.default)({
                safe: e.safe,
                css: e.css.trim(),
              }))
            : (this.tokens = (0, Cu.default)(e)),
          this.loop()
        );
      }
      return (
        ...
        (t.prototype.splitWord = function (s, r) {
          ...
          var l = (0, ty.default)(
            (0, Nd.default)((0, Od.default)([[0], c, f])),
          );
          (l.forEach(function (d, x) {
            var m = l[x + 1] || o.length,
              p = o.slice(d, m);
      ...
      for (; a < i; ) {
        switch (((h = n.charCodeAt(a)), h === 10 && ((o = a), (u += 1)), h)) {
          ...
          case 12:
            ...
            (r.push(["space", n.slice(a, l), u, a - o, u, l - o, a]),
              (a = l - 1));
            break;
          case 58:
            ((l = a + 1),
          ...
          case 34:
            ...
            do
              for (
                ...
                ((q -= 1), (C = !C));
            while (C);
            (r.push(["string", n.slice(a, l + 1), u, a - o, u, l - o, a]),
              (a = l));
            break;
          case 64:
            ((jr.lastIndex = a + 1),
              jr.test(n),
              jr.lastIndex === 0 ? (l = n.length - 1) : (l = jr.lastIndex - 2),
...
`)),
                (m = x.length - 1),
                m > 0
                  ? ((g = u + m), (v = l - x[m].length))
                  : ((g = u), (v = o)),
                r.push(["comment", p, u, a - o, g, l - v, a]),
                (o = v),
                (u = g),
                (a = l));
            } else if (h === 35 && !My.test(n.slice(a + 1, a + 2)))
              ((l = a + 1),
                r.push(["#", n.slice(a, l), u, a - o, u, l - o, a]),
                (a = l - 1));
            else if ((h === 117 || h === 85) && n.charCodeAt(a + 1) === 43) {
              l = a + 2;
              do ((l += 1), (h = n.charCodeAt(l)));
              ...
              if (
                ...
                (b.lastIndex = a + 1),
                b.test(n),
                b.lastIndex === 0 ? (l = n.length - 1) : (l = b.lastIndex - 2),
                b === Qe || h === 46)
              ) {
                let S = n.charCodeAt(l),
                  fn = n.charCodeAt(l + 1),
                  pn = n.charCodeAt(l + 2);
                (S === 101 || S === 69) &&
                  (fn === 45 || fn === 43) &&
  ...
  var Ke = "string",
    ...
    Nt = "label",
    Le = "break-parent",
    Pt = new Set([Ot, ne, Pe, At, ie, oe, ge, Ct, Re, Ie, H, Nt, Le]);
  function dn(t, e, s) {
    if (!t.has(e)) {
      let r = s(e);
      t.set(e, r);
...
`),
  ...
  function Rt(t, e = "", s = {}) {
    return (
      F(t),
      e !== "" && F(e),
      { type: ge, breakContents: t, flatContents: e, groupId: s.groupId }
    );
  }
  function Y(t, e) {
    (F(t), we(e));
  ...
  var le = tc;
  var Sn = Object.freeze({ character: "'", codePoint: 39 }),
    Tn = Object.freeze({ character: '"', codePoint: 34 }),
    rc = Object.freeze({ preferred: Sn, alternate: Tn }),
    sc = Object.freeze({ preferred: Tn, alternate: Sn });
  function kn(t, e) {
    let { preferred: s, alternate: r } = e === !0 || e === "'" ? rc : sc,
      { length: n } = t,
      i = 0,
      o = 0;
    for (let u = 0; u < n; u++) {
...
`,
  ...
  function Mn(t, e) {
    ...
    if (typeof t.sourceIndex == "number")
      return t.type === "value-word" ? Dn(t, t.sourceIndex) : t.sourceIndex;
  ...
  function Bn(t, e) {
    if (t.type === "css-comment" && t.inline)
      return Bt(e, t.source.startOffset);
    if (t.type === "value-paren" && typeof t.sourceIndex == "number")
      return t.sourceIndex + (t.value === ")" ? t.value.length : 0);
    ...
    if (t.source) {
      ...
      if (t.type === "css-atrule" && typeof t.name == "string")
        return (
          Mn(t, e) +
          1 +
          t.name.length +
          t.raws.afterName.length +
          t.raws.params.length
        );
    }
    return typeof t.sourceIndex == "number" && typeof t.value == "string"
      ? t.sourceIndex + t.value.length
      : null;
  }
  function Un(t, e) {
    ss(t, e, 0, !1);
  ...
  function ss(t, e, s, r) {
    if (r && typeof t.type == "string")
      (t.source ?? (t.source = {}),
        (t.source.startOffset = s),
        (t.source.endOffset = s + e.length));
    else if (
      !(
        typeof t.source?.startOffset == "number" &&
        typeof t.source?.endOffset == "number"
      )
    ) {
    ...
    for (let n in t) {
      ...
      for (let u of o) {
        ...
        let a = fc(t, u, s);
        (a ? ss(u, a.text, a.rootOffset, !0) : ss(u, e, s, !1), $n(u, t));
      }
    }
    (mc(t), dc(t));
  }
  function fc(t, e, s) {
    if (e.type === "value-root" || e.type === "value-unknown")
      return { rootOffset: Fn(t), text: e.text || e.value || "" };
    if (e.type === "media-query-list" || t.params === e)
      return { rootOffset: Wn(t), text: t.raws?.params || e.value || "" };
  ...
  function pc(t, e) {
    ...
    if (t.selector === e) {
      if (t.mixin)
        return t.raws.identifier + t.name + t.raws.afterName + t.raws.params;
      if (typeof t.raws?.selector == "string") return t.raws.selector;
      if (t.customSelector && typeof t.raws?.params == "string")
        return t.raws.params.slice(t.customSelector.length).trim();
  ...
  function hc(t, e, s, r) {
    return typeof e.sourceIndex == "number" &&
      typeof e.raws?.selector == "string"
      ? r + e.sourceIndex
      : t.mixin
        ? t.source.startOffset
        : typeof t.raws?.selector == "string"
          ? t.source.startOffset + rs(t.raws.selector, s)
          : typeof t.raws?.params == "string"
            ? Wn(t) + rs(t.raws.params, s)
            : t.type === "css-decl" && typeof t.raws?.value == "string"
              ? Fn(t) + rs(t.raws.value, s)
              : r;
  }
  function rs(t, e) {
    let s = t.indexOf(e);
  ...
  function mc(t) {
    ...
    for (let c in t) {
      ...
      for (let l of h)
        !l ||
          typeof l != "object" ||
          typeof l.source?.startOffset != "number" ||
          typeof l.source?.endOffset != "number" ||
          (l.source.startOffset < r &&
            ((r = l.source.startOffset), (i = l.source.start)),
          l.source.endOffset > n &&
            ((n = l.source.endOffset), (o = l.source.end)));
    }
    r !== Number.POSITIVE_INFINITY &&
      (t.source ?? (t.source = {}),
      e || ((t.source.startOffset = r), (t.source.endOffset = n)),
      (u = t.source).start ?? (u.start = i),
      (a = t.source).end ?? (a.end = o));
  }
  function $n(t, e) {
    typeof t.type != "string" ||
      t.source ||
      typeof e.source?.startOffset != "number" ||
      typeof e.source?.endOffset != "number" ||
      !yc(t) ||
      (t.source = {
...
` ||
    ...
    for (let [o, u] of i)
      t = t.slice(0, o) + T(0, t.slice(o, u), /["'*]/g, " ") + t.slice(u);
    return t;
  }
  var N = (t) => t.source.startOffset,
    P = (t) => t.source.endOffset;
  var Ut = Symbol.for("PRETTIER_IS_FRONT_MATTER");
  function gc(t) {
    return !!t?.[Ut];
  }
  var De = gc;
...
`)),
  ...
  function ns(t, e, s) {
    if (
      ...
      s.type === "css-root" &&
      s.nodes.length > 0 &&
      (((s.nodes[0] === t || (De(s.nodes[0]) && s.nodes[1] === t)) &&
        (delete e.text, /^\*\s*@(?:format|prettier)\s*$/.test(t.text))) ||
        (s.type === "css-root" && $(0, s.nodes, -1) === t))
    )
      return null;
    if (
      ...
      (t.type === "media-query" ||
        ...
        delete e.value,
      t.type === "css-rule" &&
        (delete e.params, t.extend && Ec(t.selector) && delete e.extend),
      (t.type === "media-feature" ||
        ...
        (e.value = bc(t.value)),
      t.type === "selector-combinator" &&
        (e.value = T(0, e.value, /\s+/g, " ")),
      t.type === "media-feature" && (e.value = T(0, e.value, " ", "")),
      ((t.type === "value-word" &&
        ((t.isColor && t.isHex) ||
      ...
      t.type === "value-unknown" && (e.value = T(0, e.value, /;$/g, "")),
      t.type === "selector-attribute" &&
      ...
      let { value: r } = e;
      (/\s[a-z]$/i.test(r) &&
        ((e.__prettier_attribute_selector_flag = $(0, r, -1)),
        (r = r.slice(0, -1))),
        (r = r.trim()),
        (r = r.replace(/^(?<quote>["'])(?<value>.*?)\k<quote>$/, "$<value>")),
        (e.value = r),
        delete e.quoted);
    }
    if (
      ((t.type === "media-value" ||
        ...
        t.type === "selector-tag") &&
        t.value &&
        (e.value = T(0, e.value, /([\d+.e-]+)([a-z]*)/gi, (r, n, i) => {
          let o = Number(n);
    ...
    if (
      t.type === "value-func" &&
      t.value === "if" &&
      t.group.type === "value-paren_group" &&
      t.group.groups.length === 1 &&
      t.group.groups[0].type === "value-comma_group"
    ) {
      let r = t.group.groups[0].groups,
        n = e.group.groups[0].groups;
      for (let i = r.length - 1; i >= 0; i--) {
        ...
        if (
          ...
          if (o.value === ";") {
            r[i - 1]?.type === "value-number" &&
              n.splice(i - 1, 2, { type: "#node-placeholder" });
            continue;
          }
  ...
  function Ec(t) {
    return t?.nodes?.some((e) =>
      e.nodes?.some(
        (s) => s.type === "selector-pseudo" && s.value === ":extend",
      ),
    );
  }
  var Sc =
...
`
  ...
  function zn(t, e) {
    return [...Hn, ...(Array.isArray(e) ? e : [e])].map((s) =>
      `@${t} ${s}`.trim(),
    );
  }
  var Zn = ["noformat", "noprettier"],
    ei = ["format", "prettier"],
    ti = "format";
  function Nc(t) {
...
`);
  ...
  function ii(t) {
    let { shebang: e, text: s, pragmas: r, comments: n } = os(t),
      i = Kn(s),
      o = Jn({ pragmas: { [ti]: "", ...r }, comments: n.trimStart() });
    return (
      (e
        ? `${e}
`
...
`) +
  ...
  var oi = (t) => si(xe(t).content),
    ai = (t) => ni(xe(t).content),
    ui = (t) => {
...
`
  ...
  var Rc = new Set(["initial", "inherit", "unset", "revert"]);
  function ci(t) {
  ...
  function ls(t, e) {
    ...
    if (
      s.groups.length === 0 ||
      (s.type === "value-paren_group" &&
        s.open &&
        s.close &&
        s.groups.length === 1 &&
        s.groups[0].type !== "value-comma_group")
    )
      return !1;
    let r = t.parent;
    ...
    return !as(s) && !(n && as(n))
      ? !1
      : t.findAncestor((o) => o.type === "css-decl")?.prop?.startsWith("$")
        ? !0
        : as(n)
          ? !r.groups.some((o) => tt(o))
          : n.type === "value-func";
  }
  function st(t) {
    ...
    for (let p = 0; p < r.groups.length; ++p) {
      ...
      if (
        ...
        (e.parser === "scss" &&
          ...
          t.match(
            void 0,
            (b, S) => S === "groups" && b.type === "value-paren_group",
            (b, S) =>
              S === "group" && b.type === "value-func" && b.value === "if",
          )) ||
        (g.type === "value-word" && ce(v) && P(g) === N(v))
      )
        continue;
      if (g.type === "value-string" && g.quoted) {
        let b = g.value.lastIndexOf("#{"),
          S = g.value.lastIndexOf("}");
        b !== -1 && S !== -1
          ? (x = b > S)
          : b !== -1
            ? (x = !0)
      ...
      if (e.parser === "less") {
        ...
        if (
          ...
          G(
            r.groups.some(
              (b, S) =>
                S > p && (b.value?.startsWith("]") || b.value?.endsWith("]")),
            ),
          );
          continue;
        }
      ...
      if (
        ...
        (y?.value &&
          y.value.indexOf("\\") === y.value.length - 1 &&
      ...
      if (
        ...
        (K(v) && _e(t, "type") && X(v)) ||
        (!y && Ee(g)) ||
        (_e(t, "calc") && (K(g) || K(v) || Se(g) || Se(v)) && X(v))
      )
        continue;
      if (
        e.parser === "scss" &&
      ...
      if (
        ...
        if (
          ...
          if (v?.value !== "..." && !(ce(g) && ce(v) && P(g) === N(v))) {
            ...
            if (
              !(g.value?.endsWith("#") && v.value === "{" && it(v.group)) &&
              !(st(v) && !W)
            ) {
              if (
                !a &&
                g.type === "value-comment" &&
                !g.inline &&
                r.groups.slice(0, p).every((b) => b.type === "value-comment")
              ) {
                l.push(ue(A), "");
                continue;
              }
  ...
  var Ii = /(["'])(?:(?!\1)[^\\]|\\.)*\1/gs,
    ...
    Bc = /[$@]?[_a-z\u0080-\uFFFF][\w\u0080-\uFFFF-]*/gi,
    Uc = new RegExp(
      Ii.source + `|(${Bc.source})?(${Dc.source})(${Mc.source})?`,
      "gi",
    );
  function V(t, e) {
  ...
  function Te(t) {
    return T(0, t, Uc, (e, s, r, n, i) =>
      !r &&
      n &&
      (i ?? (i = ""), (i = i.toLowerCase()), !i || i === "n" || jt.has(i))
        ? ps(n) + (i ? fs(i) : "")
        : e,
    );
  }
...
`
  ...
  var Ht = Fc;
  function Wc(t, e, s = {}) {
    let r = Mt(t, s.backwards ? e - 1 : e, s),
      n = Ht(t, r, s);
    return r !== n;
  }
  var Qt = Wc;
  ...
  function Yc(t, e) {
    ...
    return ((r = Bi(t, r)), (r = Ht(t, r)), r !== !1 && Qt(t, r));
  }
  var Kt = Yc;
  ...
  function zc(t, e) {
    return di(t.grandparent) && Vc(t, e)
      ? ","
  ...
  function Ui(t, e, s) {
    ...
    let o = t.map(({ node: d, isLast: x, index: m }) => {
        ...
        Gt(d) &&
          ...
          d.groups[2]?.type === "value-paren_group" &&
          ae(p) === ie &&
          ae(p.contents) === ne &&
          ae(p.contents.contents) === oe &&
          (p = D(ue(p)));
        let y = [p, x ? zc(t, e) : ","];
        if (!x && d.type === "value-comma_group" && le(d.groups)) {
          let g = $(0, d.groups, -1);
          (!g.source && g.close && (g = g.close),
            g.source && Kt(e.originalText, P(g)) && y.push(O));
        }
        return y;
      }, "groups"),
      u = ki(r, n),
  ...
  function Qc(t, e, s) {
    ...
    return (
      t.each(() => {
        ...
        let { next: o } = t;
        (o.type === "css-comment" &&
          !Qt(e.originalText, N(o), { backwards: !0 }) &&
          !De(n)) ||
        (o.type === "css-atrule" &&
          o.name === "else" &&
          n.type !== "css-comment")
          ? r.push(" ")
          : (r.push(e.__isHTMLStyleAttribute ? A : O),
            Kt(e.originalText, P(n)) && !De(n) && r.push(O));
      }, "nodes"),
      r
    );
  }
    ...
    switch (r.type) {
      case "css-root": {
        ...
        return (
          ...
          [
            r.frontMatter
              ? [s("frontMatter"), O, r.nodes.length > 0 ? O : ""]
              : "",
            n,
            i ? ` ${i}` : "",
            r.nodes.length > 0 ? O : "",
      ...
      case "css-comment": {
        let n = r.inline || r.raws.inline,
          i = e.originalText.slice(N(r), P(r));
      ...
      case "css-rule":
        return [
          ...
          r.nodes
            ? [
                r.selector?.type === "selector-unknown" && Be(r.selector.value)
                  ? A
                  : r.selector
                    ? " "
                    : "",
      ...
      case "css-decl": {
        let n = t.parent,
          ...
          u = o === ":",
          a = i.endsWith(" ") && u,
          c = typeof r.value == "string" && /^ *$/.test(r.value),
          f = typeof r.value == "string" ? r.value : s("value");
        return (
          (f = Si(r) ? wn(f) : f),
          !u &&
            Be(o) &&
            !t.call(() => hs(t), "value", "group", "group") &&
            (f = R([O, ue(f)])),
          [
            T(0, r.raws.before, /[\s;]/g, ""),
            (n.type === "css-atrule" && n.variable) || pi(t)
              ? r.prop
              : Me(r.prop),
            o.startsWith("//") ? " " : "",
            o,
            ...
            (!a &&
              r.isNested &&
              (ce(r.value.group.group) || ce(r.value.group.group.groups?.[0])))
              ? ""
              : " ",
            e.parser === "less" && r.extend && r.selector
              ? r.selector.nodes.length > 1
                ? D(["extend(", R([I, s("selector")]), I, ")"])
                : ["extend(", s("selector"), ")"]
              : "",
            f,
            r.raws.important
            ...
            r.raws.scssGlobal
              ...
              : r.scssGlobal
                ...
                : "",
            r.nodes
              ? [" {", r.nodes.length > 0 ? R([I, Ue(t, e, s)]) : "", I, "}"]
              : bi(r) && !n.raws.semicolon && e.originalText[P(r) - 1] !== ";"
                ? ""
      ...
      case "css-atrule": {
        let n = t.parent,
          i = $t(r) && !n.raws.semicolon && e.originalText[P(r) - 1] !== ";";
        if (e.parser === "less") {
          if (r.mixin)
            return [
              s("selector"),
        ...
        return [
          "@",
          us(r) || r.name.endsWith(":") || $t(r) ? r.name : Me(r.name),
          r.params
            ? [
                us(r)
                  ? ""
      ...
      case "selector-root":
        return D([
          be(t, "custom-selector")
            ? [t.findAncestor((n) => n.type === "css-atrule").customSelector, A]
            : "",
          Y(
            [",", be(t, ["extend", "custom-selector", "nest"]) ? A : O],
            t.map(s, "nodes"),
          ),
        ]);
      ...
      case "selector-tag":
        return [
          ...
          t.previous?.type === "selector-nesting"
            ? r.value
            : Te(fi(t, r.value) ? r.value.toLowerCase() : r.value),
        ];
      case "selector-id":
        return ["#", r.value];
      case "selector-class":
      ...
      case "selector-attribute":
        return [
          ...
          r.attribute.trim(),
          r.operator ?? "",
          r.value ? vn(Li(V(r.value.trim(), e), e), Xr) : "",
          r.insensitive ? " i" : "",
          "]",
        ];
      case "selector-combinator": {
        ...
        let n = r.value.trim().startsWith("(") ? A : "",
          i = Te(V(r.value.trim(), e)) || A;
        return [n, i];
      }
      ...
      case "selector-pseudo":
        return [
          Me(r.value),
          le(r.nodes)
            ? D(["(", R([I, Y([",", A], t.map(s, "nodes"))]), I, ")"])
            : "",
        ];
      case "selector-nesting":
        return r.value;
      case "selector-unknown": {
        if (t.findAncestor((u) => u.type === "css-rule")?.isScssNestedProperty)
          return Te(V(Me(r.value), e));
        let i = t.parent;
        if (i.raws?.selector) {
          let u = N(i),
        ...
        if (
          ...
          let u = P(i.open) + 1,
            a = N(i.close),
            c = e.originalText.slice(u, a).trim();
          return Be(c) ? [ve, c] : c;
        }
        return r.value;
      }
      ...
      case "value-operator":
        return r.value;
      case "value-word":
        return (r.isColor && r.isHex) || ci(r.value)
          ? r.value.toLowerCase()
          : r.value;
      case "value-colon": {
        let { previous: n } = t;
  ...
  var Jc = { singleQuote: $i.singleQuote },
    Gi = Jc;
  var cn = {};
  hn(cn, { css: () => mg, less: () => dg, scss: () => yg });
  var Pl = Ne(yt(), 1),
    Rl = Ne(Xo(), 1),
    Il = Ne(Pa(), 1);
  function Fp(t, e) {
  ...
  function ag(t, e) {
    ...
    for (let a = 0; a < s.length; ++a) {
      ...
      if (
        ...
        c.type === "func" && c.value === "selector")
      ) {
        let f = Hr(t).text.slice(
            c.group.open.sourceIndex + 1,
            c.group.close.sourceIndex,
          ),
          h = re(f);
        ((h.sourceIndex = c.group.open.sourceIndex + 1),
          h.raws ?? (h.raws = {}),
          (h.raws.selector = f),
          (c.group.groups = [h]));
      }
      if (c.type === "func" && c.value === "url") {
        let f = c.group?.groups ?? [],
          h = [];
      ...
      if (c.type === "paren" && c.value === "(")
        ((r = { open: c, close: null, groups: [], type: "paren_group" }),
          n.push(r),
          (o = { groups: [], type: "comma_group" }),
          u.push(o));
      else if (kl(c)) {
        ...
        if (a === s.length - 3 && s[a + 1].type === "comment" && kl(s[a + 2]))
          continue;
        (r.groups.push(o),
          (o = { groups: [], type: "comma_group" }),
          (u[u.length - 1] = o));
    ...
    if (Ae(t))
      for (let s in t)
        s !== "parent" &&
          (Al(t[s], e),
          s === "nodes" &&
            ((t.type === "atword" && t.nodes.length === 0) ||
              (t.group = Qr(ag(t, e))),
            delete t[s]));
    return t;
  }
  function ug(t, e) {
    ...
    let s;
    try {
      s = new Ol.default(t, { loose: !0 }).parse();
    } catch {
      return { type: "value-unknown", value: t };
    }
    s.text = t;
  ...
  var de = ug;
  var lg = new Set(["import", "use", "forward"]);
  function cg(t) {
    return lg.has(t);
  }
  var Cl = cg;
    ...
    if (Ae(t)) {
      ...
      if (
        ...
        return s.startsWith("@") && s.endsWith(":")
          ...
          : t.mixin
            ? ((t.selector = de(s, e)), t)
            : (Nl(t, e) && (t.isScssNestedProperty = !0),
              (t.selector = re(s)),
              t);
      if (r.trim().length > 0) {
        let i = r.match(pg);
      ...
      if (
        (e.parser === "less" &&
          t.type === "css-decl" &&
          typeof t.prop == "string" &&
          /^\s*\+\s*:/.test(t.raws.between) &&
          ((t.prop += "+"), (t.raws.between = t.raws.between.replace("+", ""))),
        e.parser === "less" &&
          t.type === "css-decl" &&
          r.startsWith("extend(") &&
          ...
          t.extend &&
            !t.selector &&
            (delete t.value, (t.selector = re(r.slice(7, -1))))),
        t.type === "css-atrule")
      ) {
        if (e.parser === "less") {
          if (t.mixin) {
        ...
        if (e.parser === "css" && t.name === "custom-selector") {
          ...
          return (
            (t.customSelector = i),
            (t.selector = re(t.params.slice(i.length).trim())),
            delete t.params,
            t
          );
        }
      ...
      if (t.type === "css-atrule" && n.length > 0) {
        let { name: i } = t;
        if (i === "warn" || i === "error")
          return ((t.params = { type: "media-unknown", value: n }), t);
        if (i === "extend" || i === "nest")
          return ((t.selector = re(n)), delete t.params, t);
        if (i === "at-root")
          return (
            /^\(\s*(?:without|with)\s*:.+\)$/s.test(n)
              ? (t.params = de(n, e))
              : ((t.selector = re(n)), delete t.params),
            t
          );
        let o = i.toLowerCase();
        return Cl(o)
          ...
          : [
            ...
            ? ((n = n.replace(/(\$\S+?)(\s+)?\.{3}/, "$1...$2")),
              (n = n.replace(/^(?!if)([^"'\s(]+)(\s+)\(/, "$1($2")),
              (t.value = de(n, e)),
              delete t.params,
              t)
  ...
  function un(t, e, s) {
    let { frontMatter: r, content: n } = xe(e),
      i;
    try {
      i = t(n, { map: !1 });
    } catch (o) {
