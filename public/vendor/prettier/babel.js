(function (f) {
  ...
  var $t = (a, e) => {
      for (var t in e) qt(a, t, { get: e[t], enumerable: !0 });
    },
    ai = (a, e, t, s) => {
      if ((e && typeof e == "object") || typeof e == "function")
        for (let i of ii(e))
          !ri.call(a, i) &&
            ...
            qt(a, i, {
              get: () => e[i],
              enumerable: !(s = si(e, i)) || s.enumerable,
            });
      return a;
    };
  var ni = (a) => ai(qt({}, "__esModule", { value: !0 }), a);
  var Ia = {};
  $t(Ia, { parsers: () => wa });
  var Me = {};
  $t(Me, {
    ...
    __js_expression: () => xa,
    __ts_expression: () => Pa,
    __vue_event_binding: () => ma,
    __vue_expression: () => xa,
    __vue_ts_event_binding: () => ya,
    __vue_ts_expression: () => Pa,
    babel: () => ma,
    "babel-flow": () => ti,
    "babel-ts": () => ya,
  });
  var X =
    (a, e) =>
    (t, s, ...i) =>
      t | 1 && s == null ? void 0 : (e.call(s) ?? s[a]).apply(s, i);
  var oi =
  ...
  var L = class {
      constructor(e, t, s) {
        ((this.line = void 0),
          (this.column = void 0),
          s !== void 0 && (this.index = void 0),
          (this.line = e),
          (this.column = t),
          s !== void 0 && (this.index = s));
      }
    },
    st = class {
      start;
  ...
  var Be = "BABEL_PARSER_SOURCETYPE_MODULE_REQUIRED",
    li = {
...
- Did you mean \`import { "${a}" as foo }\`?`,
      ImportCallArity: ({ phase: a }) =>
        `\`import${a ? `.${a}` : ""}()\` requires exactly one or two arguments.`,
      ImportCallNotNewExpression: ({ phase: a }) =>
        `Cannot use new with import${a ? `.${a}` : ""}().`,
      ImportCallSpreadArgument: ({ phase: a }) =>
        `\`...\` is not allowed in \`import${a ? `.${a}` : ""}()\`.`,
      ...
      InvalidLhsBinding: ({ ancestor: a }) =>
        `Binding invalid left-hand side in ${wt(a)}.`,
      InvalidLhsOptionalChaining: ({ ancestor: a }) =>
        `Invalid optional chaining in the left-hand side of ${wt(a)}.`,
      ...
      UnexpectedToken: ({ expected: a, unexpected: e }) =>
      ...
      UnsupportedMetaProperty: ({ target: a, onlyValidPropertyName: e }) =>
    ...
    mi = {
      ...
      PipeUnparenthesizedBody: ({ type: a }) =>
        `Hack-style pipe body cannot be an unparenthesized ${wt({ type: a })}; please wrap it in parentheses.`,
  ...
  function Ue(a, e, t) {
    Object.defineProperty(a, e, { enumerable: !1, configurable: !0, value: t });
  }
  function xi({ toMessage: a, code: e, reasonCode: t, syntaxPlugin: s }) {
    ...
    return function r(n, o, h) {
      ...
      return (
        ...
        (c.pos = o),
        (c.syntaxPlugin = s),
        i && (c.missingPlugin = h.missingPlugin),
        Ue(c, "clone", function (f = {}) {
        ...
        Object.defineProperty(c, "message", {
          ...
          set(p) {
            Object.defineProperty(this, "message", { value: p, writable: !0 });
          },
        }),
        c
      );
  ...
  function gi(a) {
    ...
    if (e.startLine === 1)
      a.startIndex == null && e.startColumn > 0
        ? (e.startIndex = e.startColumn)
        : a.startColumn == null &&
          e.startIndex > 0 &&
          (e.startColumn = e.startIndex);
  ...
  function Y(a) {
    ...
    return (
      (a.loc.start = new L(e.line, e.column)),
      (a.loc.end = new L(t.line, t.column)),
      a
    );
  }
  var Ti = (a) =>
      class extends a {
        ...
        estreeParseChainExpression(t, s) {
          ...
          return (
            (i.expression = t),
            this.finishNodeAtNode(i, "ChainExpression", s)
          );
        }
        directiveToStmt(t) {
          let s = t.value;
        ...
        cloneEstreeStringLiteral(t) {
          let { start: s, end: i, loc: r, range: n, raw: o, value: h } = t,
            c = Object.create(t.constructor.prototype);
          return (
            (c.type = "Literal"),
            (c.start = s),
            (c.end = i),
        ...
        convertPrivateNameToPrivateIdentifier(t) {
          ...
          return (
            delete t.id,
            (t.name = s),
            this.castNodeTo(t, "PrivateIdentifier")
          );
        }
        isPrivateName(t) {
        ...
        parseMethod(t, s, i, r, n, o, h = !1) {
          ...
          p &&
            ...
            (c.typeParameters = p),
            this.resetStartLocationFromNode(c, p));
          let f = this.castNodeTo(
            c,
            this.hasPlugin("typescript") && !c.body
          ...
          return (
            ...
            this.hasPlugin("typescript") && t.abstract
              ? (delete t.abstract,
                this.finishNode(t, "TSAbstractMethodDefinition"))
              : o === "ObjectMethod"
                ? (t.kind === "method" && (t.kind = "init"),
                  (t.shorthand = !1),
        ...
        isAssignable(t, s) {
          return t != null && this.isObjectProperty(t)
            ? this.isAssignable(t.value, s)
            : super.isAssignable(t, s);
        }
        toAssignable(t, s = !1) {
          if (t != null && this.isObjectProperty(t)) {
            let { key: i, value: r } = t;
            (this.isPrivateName(i) &&
              this.classScope.usePrivateName(this.getPrivateNameSV(i), i.start),
              this.toAssignable(r, s));
          } else super.toAssignable(t, s);
        }
        toAssignableObjectExpressionProp(t, s, i) {
          t.type === "Property" && (t.kind === "get" || t.kind === "set")
            ? this.raise(l.PatternHasAccessor, t.key)
            : t.type === "Property" && t.method
              ? this.raise(l.PatternHasMethod, t.key)
        ...
        stopParseSubscript(t, s) {
          ...
          return s.optionalChainMember
            ? this.estreeParseChainExpression(i, t)
            : i;
        }
        ...
        isOptionalMemberExpression(t) {
          return t.type === "ChainExpression"
            ? t.expression.type === "MemberExpression"
            : super.isOptionalMemberExpression(t);
        }
        ...
        cloneStringLiteral(t) {
          return t.type === "Literal"
            ? this.cloneEstreeStringLiteral(t)
            : super.cloneStringLiteral(t);
        }
        finishNodeAt(t, s, i) {
  ...
  function g(a, e = {}) {
    return (
      ...
      be.push(a),
      Ae.push(e.binop ?? -1),
      Se.push(e.beforeExpr ?? !1),
      Ce.push(e.startsExpr ?? !1),
      Ee.push(e.prefix ?? !1),
      Te.push(new kt(a, e)),
      mt
    );
  ...
  function b(a, e = {}) {
    return (
      ...
      Ce.push(e.startsExpr ?? !1),
      Ee.push(e.prefix ?? !1),
      Te.push(new kt("name", e)),
      mt
    );
  }
  var Ai = {
    bracketL: g("[", { beforeExpr: A, startsExpr: y }),
    bracketR: g("]"),
    braceL: g("{", { beforeExpr: A, startsExpr: y }),
    braceBarL: g("{|", { beforeExpr: A, startsExpr: y }),
    braceR: g("}"),
    braceBarR: g("|}"),
    parenL: g("(", { beforeExpr: A, startsExpr: y }),
    parenR: g(")"),
    ...
    dollarBraceL: g("${", { beforeExpr: A, startsExpr: y }),
    templateTail: g("...`", { startsExpr: y }),
    templateNonTail: g("...${", { beforeExpr: A, startsExpr: y }),
    at: g("@"),
    hash: g("#", { startsExpr: y }),
    interpreterDirective: g("#!..."),
    eq: g("=", { beforeExpr: A, isAssign: pt }),
    assign: g("_=", { beforeExpr: A, isAssign: pt }),
    slashAssign: g("_=", { beforeExpr: A, isAssign: pt }),
    xorAssign: g("_=", { beforeExpr: A, isAssign: pt }),
    moduloAssign: g("_=", { beforeExpr: A, isAssign: pt }),
    incDec: g("++/--", { prefix: V, postfix: bi, startsExpr: y }),
    bang: g("!", { beforeExpr: A, prefix: V, startsExpr: y }),
    tilde: g("~", { beforeExpr: A, prefix: V, startsExpr: y }),
    ...
    bitShiftL: M("<</>>/>>>", 8),
    bitShiftR: M("<</>>/>>>", 8),
    plusMin: g("+/-", { beforeExpr: A, binop: 9, prefix: V, startsExpr: y }),
    modulo: g("%", { binop: 10, startsExpr: y }),
    star: g("*", { binop: 10 }),
    slash: M("/", 10),
    exponent: g("**", { beforeExpr: A, binop: 11, rightAssociative: !0 }),
    _in: S("in", { beforeExpr: A, binop: 7 }),
    _instanceof: S("instanceof", { beforeExpr: A, binop: 7 }),
    _break: S("break"),
    ...
    _switch: S("switch"),
    _throw: S("throw", { beforeExpr: A, prefix: V, startsExpr: y }),
    _try: S("try"),
    _var: S("var"),
    _const: S("const"),
    _with: S("with"),
    _new: S("new", { beforeExpr: A, startsExpr: y }),
    ...
    _typeof: S("typeof", { beforeExpr: A, prefix: V, startsExpr: y }),
    _void: S("void", { beforeExpr: A, prefix: V, startsExpr: y }),
    _delete: S("delete", { beforeExpr: A, prefix: V, startsExpr: y }),
    _do: S("do", { isLoop: zt, beforeExpr: A }),
    _for: S("for", { isLoop: zt }),
    _while: S("while", { isLoop: zt }),
      ...
      : a <= 90
        ...
        : a < 97
          ...
          : a <= 122
            ? !0
            : a <= 65535
              ? a >= 170 && Oi.test(String.fromCharCode(a))
              : Yt(a, es);
  }
  function W(a) {
    return a < 48
          ...
          : a <= 90
            ...
            : a < 97
              ...
              : a <= 122
                ? !0
                : a <= 65535
                  ? a >= 170 && Fi.test(String.fromCharCode(a))
                  : Yt(a, es) || Yt(a, Mi);
  }
  var Ie = {
      keyword: [
    ...
    Bi = new Set(Ie.keyword),
    Ri = new Set(Ie.strict),
    Ui = new Set(Ie.strictBind);
  function ss(a, e) {
  ...
  var yt = class {
    ...
    xt = class {
      ...
      declareName(e, t, s) {
        ...
        if (t & 8 || t & 16) {
          ...
          (t & 16
            ? (r = r | 4)
            : (i.firstLexicalName || (i.firstLexicalName = e), (r = r | 2)),
            i.names.set(e, r),
            t & 8 && this.maybeExportDefined(i, e));
        } else if (t & 4)
          for (
            ...
            ((i = this.scopeStack[r]),
            this.checkRedeclarationInScope(i, e, t, s),
            i.names.set(e, (i.names.get(e) || 0) | 1),
      ...
      checkRedeclarationInScope(e, t, s, i) {
        this.isRedeclaredInScope(e, t, s) &&
          this.parser.raise(l.VarRedeclaration, i, { identifierName: t });
      }
      isRedeclaredInScope(e, t, s) {
        ...
        return s & 16
          ? (i & 2) > 0 || (!this.treatFunctionsAsVarInScope(e) && (i & 1) > 0)
          : ((i & 2) > 0 && !(e.flags & 8 && e.firstLexicalName === t)) ||
              (!this.treatFunctionsAsVarInScope(e) && (i & 4) > 0);
      }
      checkLocalExport(e) {
        let { name: t } = e;
    ...
    zi = {
      ...
      EnumBooleanMemberNotInitialized: ({ memberName: a, enumName: e }) =>
        `Boolean enum members need to be initialized. Use either \`${a} = true,\` or \`${a} = false,\` in enum \`${e}\`.`,
      EnumDuplicateMemberName: ({ memberName: a, enumName: e }) =>
      ...
      EnumInvalidExplicitType: ({ invalidEnumType: a, enumName: e }) =>
      ...
      EnumInvalidMemberName: ({ enumName: a, memberName: e, suggestion: t }) =>
        `Enum member names cannot start with lowercase 'a' through 'z'. Instead of using \`${e}\`, consider using \`${t}\`, in enum \`${a}\`.`,
      EnumNumberMemberNotInitialized: ({ enumName: a, memberName: e }) =>
      ...
      class extends a {
        ...
        flowParsePredicate() {
          ...
          return (
            ...
            this.state.lastTokStartLoc.index > s.index + 1 &&
              this.raise(P.UnexpectedSpaceBetweenModuloChecks, s),
            this.eat(6)
          ...
          return (
            t && this.match(50)
              ...
              : ((i = this.flowParseType()),
                (this.state.inType = s),
                this.match(50) && (r = this.flowParsePredicate())),
            [i, r]
          );
        }
        ...
        flowParseDeclare(t, s) {
          ...
          if (this.eatContextual(123))
            return this.match(12)
              ...
              : (s &&
                  this.raise(P.NestedDeclareModule, this.state.lastTokStartLoc),
            ...
            this.match(79)
              ? (this.next(),
                !this.isContextual(126) &&
                  !this.match(83) &&
                  this.raise(
                    P.InvalidNonTypeImportInDeclareModule,
                    this.state.lastTokStartLoc,
                  ),
                i.push(super.parseImport(o)))
              : (this.expectContextual(
                  121,
                  P.UnsupportedStatementInDeclareModule,
                ),
                i.push(this.flowParseDeclare(o, !0)));
          }
          (this.scope.exit(),
            this.expect(4),
            (t.body = this.finishNode(s, "BlockStatement")));
          let r = null,
            n = !1;
          return (
            i.forEach((o) => {
              Hi(o)
                ? (r === "CommonJS" &&
                    this.raise(P.AmbiguousDeclareModuleKind, o),
                  (r = "ES"))
                : o.type === "DeclareModuleExports" &&
                  (n && this.raise(P.DuplicateDeclareModuleExports, o),
                  r === "ES" && this.raise(P.AmbiguousDeclareModuleKind, o),
                  (r = "CommonJS"),
                  (n = !0));
            }),
            (t.kind = r || "CommonJS"),
        ...
        flowParseDeclareExportDeclaration(t, s) {
          ...
          if (
            ...
            throw this.raise(
              P.UnsupportedDeclareExportKind,
              this.state.startLoc,
          ...
          if (
            ...
            return i.type === "ExportNamedDeclaration"
              ? ((i.default = !1),
                delete i.exportKind,
                this.castNodeTo(i, "DeclareExportDeclaration"))
              : this.castNodeTo(i, "DeclareExportAllDeclaration");
          }
          throw this.unexpected();
        }
        ...
        flowParseInterfaceish(t, s) {
          if (
            ((t.id = this.flowParseRestrictedIdentifier(!s, !0)),
            this.scope.declareName(t.id.name, s ? 17 : 8201, t.id.start),
            this.match(43)
          ...
          if (s) {
            ...
            if (this.eatContextual(113))
              do r.push(this.flowParseInterfaceExtends());
              while (this.eat(8));
            if (this.eatContextual(109))
              do i.push(this.flowParseClassImplements());
              while (this.eat(8));
        ...
        checkNotUnderscore(t) {
          t === "_" &&
            this.raise(P.UnexpectedReservedUnderscore, this.state.startLoc);
        }
        checkReservedType(t, s, i) {
          $i.has(t) &&
            this.raise(i ? P.AssignReservedType : P.UnexpectedReservedType, s, {
              reservedType: t,
            });
        }
        flowParseRestrictedIdentifierName(t, s) {
          return (
            ...
            this.parseIdentifierName(t)
          );
        }
        flowParseRestrictedIdentifier(t, s) {
          let i = this.startNode(),
            r = this.flowParseRestrictedIdentifierName(t, s);
          return this.createIdentifier(i, r);
        }
        flowParseTypeAlias(t) {
          return (
            (t.id = this.flowParseRestrictedIdentifier(!1, !0)),
            this.scope.declareName(t.id.name, 8201, t.id.start),
            this.match(43)
              ? (t.typeParameters = this.flowParseTypeParameterDeclaration())
              : (t.typeParameters = null),
            (t.right = this.flowParseTypeInitialiser(25)),
            this.semicolon(),
        ...
        flowParseOpaqueType(t, s) {
          return (
            ...
            this.match(43)
              ...
              : (t.typeParameters = null),
            (t.supertype = null),
            this.match(10) && (t.supertype = this.flowParseTypeInitialiser(10)),
            (t.impltype = null),
            s || (t.impltype = this.flowParseTypeInitialiser(25)),
            this.semicolon(),
            this.finishNode(t, s ? "DeclareOpaqueType" : "OpaqueType")
          );
        }
        flowParseTypeParameterBound() {
          if (this.match(10) || this.isContextual(77)) {
            ...
            return (
              this.next(),
              (t.typeAnnotation = this.flowParseType()),
        ...
        flowParseTypeParameter(t = !1) {
          ...
          return (
            (i.name = this.flowParseRestrictedIdentifierName()),
            (i.variance = r),
            (i.bound = this.flowParseTypeParameterBound()),
            this.match(25)
              ? (this.eat(25), (i.default = this.flowParseType()))
              : t && this.raise(P.MissingTypeParamDefault, s),
        ...
        flowParseInterfaceType() {
          let t = this.startNode();
          if ((this.expectContextual(125), (t.extends = []), this.eat(77)))
            do t.extends.push(this.flowParseInterfaceExtends());
            while (this.eat(8));
          return (
            (t.body = this.flowParseObjectType({
        ...
        flowParseObjectTypeMethodish(t) {
          for (
            ...
            (t.params.push(this.flowParseFunctionTypeParam(!1)),
              this.match(7) || this.expect(8));
          return (
            this.eat(17) && (t.rest = this.flowParseFunctionTypeParam(!1)),
            this.expect(7),
        ...
        flowParseObjectType({
          ...
          for (
            s && this.match(3)
              ? (this.expect(3), (c = 5), (p = !0))
              : (this.expect(2), (c = 4), (p = !1)),
              h.exact = p;
            !this.match(c);
          ) {
            let x = !1,
            ...
            if (r && this.isContextual(114)) {
              ...
              I.type !== 10 &&
                I.type !== 13 &&
                (this.next(), (T = this.state.startLoc), (t = !1));
            }
            ...
            if (this.eat(0))
              (T != null && this.unexpected(T),
                this.eat(0)
                  ? (E && this.unexpected(E.start),
                    h.internalSlots.push(
                      this.flowParseObjectTypeInternalSlot(v, x),
                    ))
                  : h.indexers.push(this.flowParseObjectTypeIndexer(v, x, E)));
            else if (this.match(6) || this.match(43))
              (T != null && this.unexpected(T),
                E && this.unexpected(E.start),
                h.callProperties.push(
                  this.flowParseObjectTypeCallProperty(v, x),
                ));
            else {
              let I = "init";
              ...
              let At = this.flowParseObjectTypeProperty(
                v,
                x,
                T,
                E,
              ...
              At === null
                ? ((f = !0), (D = this.state.lastTokStartLoc))
                : h.properties.push(At);
            }
            (this.flowObjectTypeSemicolon(),
              D &&
                !this.match(4) &&
                !this.match(5) &&
                this.raise(P.UnexpectedExplicitInexactInObject, D));
          }
        ...
        flowParseObjectTypeProperty(t, s, i, r, n, o, h) {
          if (this.eat(17))
            return this.match(8) ||
              ...
              ? (o
                  ? h ||
                    this.raise(P.InexactInsideExact, this.state.lastTokStartLoc)
                  : this.raise(
                      P.InexactInsideNonObject,
                      this.state.lastTokStartLoc,
                    ),
                r && this.raise(P.InexactVariance, r),
                null)
              : (o ||
                  this.raise(
                    P.UnexpectedSpreadType,
                    this.state.lastTokStartLoc,
                  ),
                i != null && this.unexpected(i),
                r && this.raise(P.SpreadVariance, r),
                ...
                ? ((t.method = !0),
                  ...
                  n === "get" || n === "set"
                    ...
                    : !s &&
                      ...
                      t.value.this &&
                      this.raise(P.ThisParamBannedInConstructor, t.value.this))
        ...
        flowCheckGetterSetterParams(t) {
          let s = t.kind === "get" ? 0 : 1,
            i = t.value,
            r = i.params.length + (i.rest ? 1 : 0);
          (i.this &&
            this.raise(
              t.kind === "get"
                ? P.GetterMayNotHaveThisParam
                : P.SetterMayNotHaveThisParam,
              i.this,
            ),
            r !== s &&
              this.raise(
            ...
            t.kind === "set" &&
              i.rest &&
              this.raise(l.BadSetterRestParameter, t));
        }
        ...
        flowParseGenericType(t, s) {
          ...
          return (
            (i.typeParameters = null),
            (i.id = this.flowParseQualifiedTypeIdentifier(t, s)),
            this.match(43) &&
        ...
        flowParseTupleType() {
          ...
          for (
            ...
            !this.match(1) &&
            (t.types.push(this.flowParseType()), !this.match(1));
          )
            this.expect(8);
        ...
        flowParseFunctionTypeParam(t) {
          let s = null,
            ...
            n = this.startNode(),
            o = this.lookahead(),
            h = this.state.type === 74;
          return (
            o.type === 10 || o.type === 13
              ? (h && !t && this.raise(P.ThisParamMustBeFirst, n),
                (s = this.parseIdentifier(h)),
                this.eat(13) &&
                  ((i = !0), h && this.raise(P.ThisParamMayNotBeOptional, n)),
        ...
        flowParseFunctionTypeParams(t = []) {
          ...
          for (
            ...
            (t.push(this.flowParseFunctionTypeParam(!1)),
              this.match(7) || this.expect(8));
          return (
            this.eat(17) && (s = this.flowParseFunctionTypeParam(!1)),
            { params: t, rest: s, _this: i }
          );
        }
          ...
          switch (this.state.type) {
            ...
            case 6: {
              ...
              if ((this.next(), !this.match(7) && !this.match(17)))
                if (C(this.state.type) || this.match(74)) {
              ...
              if (n) {
                if (
                  ...
                  this.state.noAnonFunctionType ||
                    !(
                      this.match(8) ||
                      (this.match(7) && this.lookahead().type === 15)
                    ))
                )
                  return (this.expect(7), r);
                this.eat(8);
              }
              return (
                r
            ...
            case 49:
              if (this.state.value === "-") {
                ...
                throw this.raise(
                  P.UnexpectedSubtractionOperand,
                  this.state.startLoc,
                );
              }
              throw this.unexpected();
        ...
        flowParseAnonFunctionWithoutParens() {
          ...
          if (!this.state.noAnonFunctionType && this.eat(15)) {
            let s = this.startNodeAtNode(t);
            return (
              (s.params = [this.reinterpretTypeAsFunctionTypeParam(t)]),
              (s.rest = null),
              (s.this = null),
        ...
        flowParseTypeAnnotatableIdentifier() {
          ...
          return (
            this.match(10) &&
              (t.typeAnnotation = this.flowParseTypeAnnotation()),
            this.createIdentifier(t, s)
          );
        }
        typeCastToParameter(t) {
          return (
            (t.expression.typeAnnotation = t.typeAnnotation),
            this.resetEndLocationFromNode(t.expression, t.typeAnnotation),
            t.expression
          );
        }
        flowParseVariance() {
        ...
        parseFunctionBodyAndFinish(t, s, i = !1) {
          if (this.match(10)) {
            ...
            s === "ArrowFunctionExpression"
              ? ([r.typeAnnotation, t.predicate] =
                  this.flowParseTypeAndPredicateInitialiser(!0))
              : (r.typeAnnotation = this.flowParseTypeInitialiser()),
              (t.returnType = r.typeAnnotation
        ...
        parseConditional(t, s, i) {
          ...
          let r = this.state.clone(),
            ...
            p = this.getArrowLikeExpressions(h),
            f = p[0],
            d = p[1];
          if (c || d.length > 0) {
            let x = [...n];
            if (d.length > 0) {
              ...
              (({ consequent: h, failed: c } =
                ...
                ([f] = this.getArrowLikeExpressions(h)));
            }
            (c &&
              f.length > 1 &&
              this.raise(P.AmbiguousConditionalArrow, r.startLoc),
              c &&
                f.length === 1 &&
                ((this.state = r),
                x.push(f[0].start),
                (this.state.noArrowAt = x),
                ({ consequent: h } = this.tryParseConditionalConsequent())));
          }
          return (
        ...
        getArrowLikeExpressions(t, s) {
          ...
          return s
            ...
            : Wi(r, (n) => n.params.every((o) => this.isAssignable(o, !0)));
        }
        finishArrowValidation(t) {
          (this.toAssignableList(t.params, t.extra?.trailingCommaLoc, !1),
        ...
        forwardNoArrowParamsConversionAt(t, s) {
          ...
          return (
            this.state.noArrowParamsConversionAt.includes(
              this.offsetToSourcePos(t.start),
            )
              ? (this.state.noArrowParamsConversionAt.push(this.state.start),
                (i = s()),
                this.state.noArrowParamsConversionAt.pop())
        ...
        parseParenItem(t, s) {
          ...
          if (
            (this.eat(13) && ((i.optional = !0), this.resetEndLocation(t)),
            this.match(10))
          ) {
        ...
        assertModuleNodeAllowed(t) {
          (t.type === "ImportDeclaration" &&
            ...
            (t.type === "ExportNamedDeclaration" && t.exportKind === "type") ||
        ...
        eatExportStar(t) {
          return super.eatExportStar(t)
            ? !0
            : this.isContextual(126) && this.lookahead().type === 51
        ...
        parseClassMember(t, s, i) {
          ...
          (super.parseClassMember(t, s, i),
            s.declare &&
              (s.type !== "ClassProperty" &&
              s.type !== "ClassPrivateProperty" &&
              s.type !== "PropertyDefinition"
                ? this.raise(P.DeclareClassElement, r)
                : s.value &&
                  this.raise(P.DeclareClassFieldInitializer, s.value)));
        }
        isIterator(t) {
        ...
        readIterator() {
          ...
          ((!this.isIterator(t) || !this.state.inType) &&
            this.raise(l.InvalidIdentifier, this.state.curPosition(), {
              identifierName: s,
            }),
        ...
        toAssignableListItem(t, s, i) {
          ...
          (r.type === "TypeCastExpression" &&
            (t[s] = this.typeCastToParameter(r)),
            super.toAssignableListItem(t, s, i));
        }
        toReferencedList(t, s) {
          for (let i = 0; i < t.length; i++) {
            ...
            r?.type === "TypeCastExpression" &&
              ...
              (t.length > 1 || !s) &&
              this.raise(P.TypeCastInPattern, r.typeAnnotation);
          }
          return t;
        }
        parseArrayLike(t, s) {
          ...
          return (
            i.type === "ArrayExpression" && this.toReferencedList(i.elements),
            i
          );
        }
        isValidLVal(t, s, i, r) {
        ...
        pushClassMethod(t, s, i, r, n, o) {
          if (
            ...
            super.pushClassMethod(t, s, i, r, n, o),
            s.params && n)
          ) {
            let h = s.params;
            h.length > 0 &&
              this.isThisParam(h[0]) &&
              this.raise(P.ThisParamBannedInConstructor, s);
        ...
        pushClassPrivateMethod(t, s, i, r) {
          (s.variance && this.unexpected(s.variance.start),
            ...
            this.match(43) &&
              (s.typeParameters = this.flowParseTypeParameterDeclaration()),
            super.pushClassPrivateMethod(t, s, i, r));
        }
        flowParseClassImplements() {
          ...
          return (
            ...
            this.match(43)
              ? (t.typeParameters = this.flowParseTypeParameterInstantiation())
              : (t.typeParameters = null),
            this.finishNode(t, "ClassImplements")
          );
        }
        parseClassSuper(t) {
          if (
            ...
            let s = (t.implements = []);
            do s.push(this.flowParseClassImplements());
            while (this.eat(8));
          }
        }
        checkGetterSetterParams(t) {
          ...
          if (s.length > 0) {
            let i = s[0];
            this.isThisParam(i) && t.kind === "get"
              ? this.raise(P.GetterMayNotHaveThisParam, i)
              : this.isThisParam(i) &&
                this.raise(P.SetterMayNotHaveThisParam, i);
          }
        }
        ...
        parseFunctionParamType(t) {
          return (
            this.eat(13) &&
              (t.type !== "Identifier" && this.raise(P.PatternIsOptional, t),
              this.isThisParam(t) && this.raise(P.ThisParamMayNotBeOptional, t),
              (t.optional = !0)),
            this.match(10)
              ? (t.typeAnnotation = this.flowParseTypeAnnotation())
              : this.isThisParam(t) &&
                this.raise(P.ThisParamAnnotationRequired, t),
            this.match(25) &&
              this.isThisParam(t) &&
              this.raise(P.ThisParamNoDefault, t),
        ...
        parseMaybeDefault(t, s) {
          ...
          return (
            i.type === "AssignmentPattern" &&
              ...
              this.raise(P.TypeBeforeInitializer, i.typeAnnotation),
            i
          );
        }
        parseImportSpecifierLocal(t, s, i) {
          ((s.local = Ve(t)
            ...
            : this.parseIdentifier()),
            t.specifiers.push(this.finishImportSpecifier(s, i)));
        }
        ...
        applyImportPhase(t, s, i, r) {
          if ((super.applyImportPhase(t, s, i, r), s)) {
            ...
            (i === "type" && this.match(51) && this.unexpected(),
              (t.importKind = i === "type" || i === "typeof" ? i : "value"));
        }
        parseImportSpecifier(t, s, i, r, n) {
          ...
          if (this.isContextual(89) && !this.isLookaheadContextual("as")) {
            ...
            h !== null && !B(this.state.type)
              ? ((t.imported = f),
                (t.importKind = h),
                (t.local = this.cloneIdentifier(f)))
              : ((t.imported = o),
                (t.importKind = null),
                (t.local = this.parseIdentifier()));
          } else {
            if (h !== null && B(this.state.type))
              ((t.imported = this.parseIdentifier(!0)), (t.importKind = h));
            else {
              if (s)
            ...
            this.eatContextual(89)
              ? (t.local = this.parseIdentifier())
              : ((c = !0), (t.local = this.cloneIdentifier(t.imported)));
          }
          let p = Ve(t);
          return (
            i && p && this.raise(P.ImportTypeShorthandOnlyInPureImport, t),
            (i || p) && this.checkReservedType(t.local.name, t.local.start, !0),
            c &&
              !i &&
              !p &&
        ...
        parseFunctionParams(t, s) {
          ...
          (i !== "get" &&
            ...
            this.match(43) &&
            (t.typeParameters = this.flowParseTypeParameterDeclaration()),
            super.parseFunctionParams(t, s));
        }
        parseVarId(t, s) {
          (super.parseVarId(t, s),
            this.match(10) &&
        ...
        parseMaybeAssign(t, s) {
          ...
          if (this.hasPlugin("jsx") && (this.match(138) || this.match(43))) {
            if (
              ((i = this.state.clone()),
              (r = this.tryParse(() => super.parseMaybeAssign(t, s), i)),
              !r.error)
            )
              return r.node;
          ...
          if (r?.error || this.match(43)) {
            ...
            let n,
              o = this.tryParse((c) => {
                ...
                return (
                  f.type !== "ArrowFunctionExpression" && c(),
                  (f.typeParameters = n),
            ...
            if (
              ...
              if (!o.error && !o.aborted)
                return (
                  o.node.async &&
                    this.raise(
                      P.UnexpectedTypeParameterBeforeAsyncArrowFunction,
                      n,
                    ),
                  o.node
                );
            ...
            throw r?.thrown
              ...
              : o.thrown
                ? o.error
                : this.raise(P.UnexpectedTokenAfterTypeParameter, n);
          }
        ...
        parseArrow(t) {
          if (this.match(10)) {
            ...
            (s.error && (this.state = s.failState),
              (t.returnType = s.node.typeAnnotation
        ...
        setArrowFunctionParameters(t, s) {
          this.state.noArrowParamsConversionAt.includes(
            ...
            ? (t.params = s)
            : super.setArrowFunctionParameters(t, s);
        }
        checkParams(t, s, i, r = !0) {
          if (
            ...
            for (let n = 0; n < t.params.length; n++)
              this.isThisParam(t.params[n]) &&
                n > 0 &&
                this.raise(P.ThisParamMustBeFirst, t.params[n]);
        ...
        parseTopLevel(t, s) {
          ...
          return (
            this.state.hasFlowComment &&
              this.raise(P.UnterminatedFlowComment, this.state.curPosition()),
            i
          );
        }
        skipBlockComment() {
          if (this.hasPlugin("flowComments") && this.skipFlowComment()) {
            if (this.state.hasFlowComment)
              throw this.raise(P.NestedFlowComment, this.state.startLoc);
        ...
        skipFlowComment() {
          ...
          return i === 58 && r === 58
            ? s + 2
            : this.input.slice(s + t, s + t + 12) === "flow-include"
              ? s + 12
              : i === 58 && r !== 58
                ? s
                : !1;
        ...
        flowEnumCheckExplicitTypeMismatch(t, s, i) {
          ...
          r !== null &&
            r !== i &&
            this.flowEnumErrorInvalidMemberInitializer(t, s);
        }
        flowEnumMembers({ enumName: t, explicitType: s }) {
          ...
          for (; !this.match(4); ) {
            ...
            if (p === "") continue;
            (/^[a-z]/.test(p) &&
              this.raise(P.EnumInvalidMemberName, h, {
                memberName: p,
                suggestion: p[0].toUpperCase() + p.slice(1),
                enumName: t,
              }),
              i.has(p) &&
                this.raise(P.EnumDuplicateMemberName, h, {
                  memberName: p,
                  enumName: t,
                }),
              i.add(p));
        ...
        flowEnumParseExplicitType({ enumName: t }) {
          ...
          if (!C(this.state.type))
            throw this.raise(
              P.EnumInvalidExplicitTypeUnknownSupplied,
              this.state.startLoc,
              { enumName: t },
            );
          ...
          return (
            ...
            s !== "boolean" &&
              ...
              s !== "string" &&
              s !== "symbol" &&
              this.raise(P.EnumInvalidExplicitType, this.state.startLoc, {
                enumName: t,
                invalidEnumType: s,
              }),
            s
        ...
        flowEnumBody(t, s) {
          ...
          switch (((t.hasUnknownMembers = h), n)) {
            ...
            default: {
              ...
              if (!f && !d && p >= x) {
                for (let T of o.defaultedMembers)
                ...
                return (
                  this.raise(P.EnumInconsistentMemberValues, r, {
                    enumName: i,
                  }),
                  c()
                );
        ...
        flowParseEnumDeclaration(t) {
          ...
          return (
            (t.id = s),
            (t.body = this.flowEnumBody(this.startNode(), s)),
        ...
        jsxParseOpeningElementAfterName(t) {
          return (
            this.shouldParseTypes() &&
              ...
              (t.typeArguments =
                this.flowParseTypeParameterInstantiationInExpression()),
            super.jsxParseOpeningElementAfterName(t)
          );
        }
        isLookaheadToken_lt() {
        ...
        reScan_lt_gt() {
          ...
          t === 43
            ...
            : t === 44 && ((this.state.pos -= 1), this.readToken_gt());
        }
        reScan_lt() {
          let { type: t } = this.state;
          return t === 47
  ...
  var Qi = {
      ...
      UnexpectedToken: ({ unexpected: a, HTMLEntity: e }) =>
        ...
        jsxReadToken() {
          ...
          for (;;) {
            if (this.state.pos >= this.length)
              throw this.raise(_.UnterminatedJsxContent, this.state.startLoc);
            ...
            switch (i) {
              ...
              case 62:
              case 125:
                this.raise(_.UnexpectedToken, this.state.curPosition(), {
...
`))
          ...
          switch (this.state.type) {
            case 2:
              return (
                ...
                this.next(),
                (t = this.jsxParseExpressionContainer(t, w.j_oTag)),
                t.expression.type === "JSXEmptyExpression" &&
                  this.raise(_.AttributeIsEmpty, t),
                t
              );
            case 138:
            case 130:
        ...
        jsxParseExpressionContainer(t, s) {
          if (this.match(4)) t.expression = this.jsxParseEmptyExpression();
            ...
            (i.type === "SequenceExpression" &&
              ...
              this.raise(_.UnexpectedSequenceExpression, i.expressions[1]),
              (t.expression = i));
          }
          return (
            this.setContext(s),
        ...
        jsxParseAttribute() {
          ...
          return (
            ...
            (t.value = this.eat(25) ? this.jsxParseAttributeValue() : null),
        ...
        jsxParseElementAt(t) {
          let s = this.startNodeAt(t),
            i = [],
            r = this.jsxParseOpeningElementAt(t),
            n = null;
          if (!r.selfClosing) {
            t: for (;;)
              switch (this.state.type) {
            ...
            q(r) && !q(n) && n !== null
              ? this.raise(_.MissingClosingTagFragment, n)
              : !q(r) && q(n)
                ? this.raise(_.MissingClosingTagElement, n, {
          ...
          if (
            ...
            throw this.raise(
              _.UnwrappedAdjacentJSXElements,
              this.state.startLoc,
            );
          return q(r)
        ...
        parseExprAtom(t) {
          return this.match(138)
            ...
            : this.match(43) && this.input.charCodeAt(this.state.pos) !== 33
    ...
    ee = class extends xt {
      get inTSNamespace() {
        ...
        return (
          e.length >= 2 &&
          e[e.length - 1].flags === 0 &&
          (e[e.length - 2].flags & 2048) > 0
        );
      }
      importsStack = [];
      createScope(e) {
        return (this.importsStack.push(new Set()), new te(e));
      }
      enter(e) {
        (e & 3072 && this.importsStack.push(new Set()), super.enter(e));
      }
      exit() {
        let e = super.exit();
      ...
      declareName(e, t, s) {
        if (t & 4096) {
          (this.hasImport(e, !0) &&
            this.parser.raise(l.VarRedeclaration, s, { identifierName: e }),
  ...
  function ns(a, e) {
    a.trailingComments === void 0
      ? (a.trailingComments = e)
      : a.trailingComments.unshift(...e);
  }
  function tr(a, e) {
    a.leadingComments === void 0
      ? (a.leadingComments = e)
      : a.leadingComments.unshift(...e);
  }
  function Pt(a, e) {
    a.innerComments === void 0
      ? (a.innerComments = e)
      : a.innerComments.unshift(...e);
  }
  function $(a, e, t) {
    let s = null,
      i = e.length;
  ...
  var ie = class extends se {
      ...
      finalizeComment(e) {
        ...
        if (e.leadingNode !== null || e.trailingNode !== null)
          (e.leadingNode !== null && ns(e.leadingNode, t),
            e.trailingNode !== null && tr(e.trailingNode, t));
        else {
    ...
    re = class a {
      ...
      init({
        ...
        ((this.strict = e === !1 ? !1 : e === !0 ? !0 : t === "module"),
          ...
          (this.curLine = i),
          (this.lineStart = -r),
          (this.startLoc = this.endLoc = new L(i, r, s)));
      }
      errors = [];
      noArrowAt = [];
  ...
  function ze(a, e, t, s, i, r) {
    ...
    for (;;) {
      ...
      if (x === 92) {
        ...
        (T.ch === null && !p
          ? (p = { pos: t, lineStart: s, curLine: i })
          : (c += T.ch),
          ({ pos: t, lineStart: s, curLine: i } = T),
          (f = t));
      } else
        x === 8232 || x === 8233
          ? (++t, ++i, (s = t))
...
`),
  ...
  function sr(a, e, t, s) {
    return a === "template"
      ? e === 96 || (e === 36 && t.charCodeAt(s + 1) === 123)
      : e === (a === "double" ? 34 : 39);
  }
  function ir(a, e, t, s, i, r) {
    let n = !i;
    e++;
    let o = (c) => ({ pos: e, ch: c, lineStart: t, curLine: s }),
      h = a.charCodeAt(e++);
    switch (h) {
      case 110:
        return o(`
`);
      ...
      case 120: {
        let c;
        return (
          ({ code: c, pos: e } = ae(a, e, t, s, 2, !1, n, r)),
  ...
  function ae(a, e, t, s, i, r, n, o) {
    let h = e,
      c;
    return (
      ({ n: c, pos: e } = os(a, e, t, s, 16, i, r, !1, o, !n)),
      c === null && (n ? o.invalidEscapeSequence(h, t, s) : (e = h - 1)),
      { code: c, pos: e }
    );
  }
  function os(a, e, t, s, i, r, n, o, h, c) {
    let p = e,
      f = i === 16 ? $e.hex : $e.decBinOct,
      d = i === 16 ? Ct.hex : i === 10 ? Ct.dec : i === 8 ? Ct.oct : Ct.bin,
      x = !1,
      T = 0;
    for (let D = 0, v = r ?? 1 / 0; D < v; ++D) {
      let E = a.charCodeAt(e),
        I;
      if (E === 95 && o !== "bail") {
        let At = a.charCodeAt(e - 1),
          ct = a.charCodeAt(e + 1);
        if (o) {
  ...
  function hs(a, e, t, s, i, r) {
    ...
    if (n === 123) {
      if (
        (++e,
        ({ code: o, pos: e } = ae(a, e, t, s, a.indexOf("}", e) - e, !0, i, r)),
        ++e,
        o !== null && o > 1114111)
      )
        if (i) r.invalidCodePoint(e, t, s);
        else return { code: null, pos: e };
    } else ({ code: o, pos: e } = ae(a, e, t, s, 4, !1, i, r));
    return { code: o, pos: e };
  }
  function ut(a, e, t) {
    return new L(t, a - e, a);
  }
  var rr = new Set([103, 109, 115, 105, 121, 117, 100, 118]),
    ne = class {
      constructor(e) {
        ...
        ((this.type = e.type),
          ...
          (this.end = t + e.end),
          (this.loc = new st(e.startLoc, e.endLoc)));
      }
    },
    Et,
    oe = class extends ie {
      ...
      constructor(e, t) {
        (super(),
          ...
          (this.comments = []),
          (this.isLookahead = !1),
          (!Et || Et.length < (this.length + 1) * 2) &&
            (Et = new Uint32Array((this.length + 1) * 2)),
          (this.locData = Et));
      }
      setLoc(e) {
      ...
      next() {
        (this.checkKeywordEscapes(),
          this.optionFlags & 512 && this.pushToken(new ne(this.state)),
      ...
      setStrict(e) {
        ((this.state.strict = e),
          e &&
            (this.state.strictErrors.forEach(([t, s]) => this.raise(t, s)),
      ...
      skipBlockComment(e) {
        ...
        if (i === -1)
          throw this.raise(l.UnterminatedComment, this.state.curPosition());
        for (
          this.state.pos = i + e.length, St.lastIndex = s + 2;
          St.test(this.input) && St.lastIndex <= i;
        )
          (++this.state.curLine, (this.state.lineStart = St.lastIndex));
      ...
      skipLineComment(e) {
        ...
        if (this.state.pos < this.length)
          for (; !tt(i) && ++this.state.pos < this.length; )
      ...
      readToken_interpreter() {
        ...
        if (e !== 33) return !1;
        let t = this.state.pos;
        for (this.state.pos += 1; !tt(e) && ++this.state.pos < this.length; )
      ...
      readToken_mult_modulo(e) {
        ...
        (e === 42 &&
          ...
          i === 61 && !this.state.inType && (s++, (t = e === 37 ? 29 : 26)),
          this.finishOp(t, s));
      }
      ...
      readRegexp() {
        ...
        for (; r < this.length; ) {
          ...
          if (rr.has(c))
            (c === 118
              ? o.includes("u") && this.raise(l.IncompatibleRegExpUVFlags, h())
              : c === 117 &&
                o.includes("v") &&
                this.raise(l.IncompatibleRegExpUVFlags, h()),
              o.includes(p) && this.raise(l.DuplicateRegExpFlags, h()));
      ...
      readRadixNumber(e) {
        ...
        if (
          (r == null && this.raise(l.InvalidDigit, O(s, 2), { radix: e }),
          this.input.charCodeAt(this.state.pos) === 110 &&
            (++this.state.pos, (i = !0)),
          R(this.codePointAtPos(this.state.pos)))
        )
      ...
      readNumber(e) {
        ...
        !e &&
          ...
          this.raise(l.InvalidNumber, this.state.curPosition());
        let o = this.state.pos - t >= 2 && this.input.charCodeAt(t) === 48;
        if (o) {
          let f = this.input.slice(t, this.state.pos);
          if (
            (this.recordStrictModeErrors(l.StrictOctalLiteral, s),
            !this.state.strict)
          ) {
            let d = f.indexOf("_");
        ...
        (h === 46 &&
          ...
          (h === 69 || h === 101) &&
            ...
            this.readInt(10) === null &&
              this.raise(l.InvalidOrMissingExponent, s),
            (i = !0),
            (h = this.input.charCodeAt(this.state.pos))));
        let c = U(0, this.input.slice(t, this.state.pos), "_", "");
        if (
          (h === 110 &&
            ((i || o) && this.raise(l.InvalidBigIntLiteral, s),
            ++this.state.pos,
            (r = !0)),
          R(this.codePointAtPos(this.state.pos)))
        )
      ...
      readTemplateToken() {
        ...
        ((this.state.pos = i + 1),
          ...
          s &&
            (this.state.firstInvalidTemplateEscapePos = new L(
              s.curLine,
              s.pos - s.lineStart,
        ...
        for (
          ...
          if (W(r)) this.state.pos += r <= 65535 ? 1 : 2;
            ...
            let n = this.state.curPosition(),
              o = this.state.pos === s ? R : W;
            if (this.input.charCodeAt(++this.state.pos) !== 117) {
              (this.raise(l.MissingUnicodeEscape, this.state.curPosition()),
                (i = this.state.pos - 1));
              continue;
            }
            ++this.state.pos;
            ...
            (h !== null &&
              (o(h) || this.raise(l.EscapedCharNotAnIdentifier, n),
              (t += String.fromCodePoint(h))),
              (i = this.state.pos));
          } else break;
        }
      ...
      checkKeywordEscapes() {
        ...
        we(e) &&
          this.state.containsEsc &&
          this.raise(l.InvalidEscapedReservedWord, this.state.startLoc, {
            reservedWord: z(e),
          });
      }
      raise(e, t, s = {}) {
            ...
            t instanceof L
              ...
              : typeof t == "number"
                ...
                : this.optionFlags & 256
                  ? t.loc.start
                  : this.getLoc(t.start),
          r = t instanceof L ? i.index : typeof t == "number" ? t : t.start,
          n = e(i, r, s);
        ...
        let i =
            t instanceof L
              ...
              : this.optionFlags & 256
                ? t.loc.start
                : this.getLoc(t.start),
          r = t instanceof L ? i.index : t.start,
          n = this.state.errors;
      ...
      updateContext(e) {}
      unexpected(e, t) {
        throw this.raise(l.UnexpectedToken, e ?? this.state.startLoc, {
          expected: t ? z(t) : null,
        });
      }
      expectPlugin(e, t) {
        if (this.hasPlugin(e)) return !0;
        throw this.raise(l.MissingPlugin, t ?? this.state.startLoc, {
          missingPlugin: [e],
        });
      }
      expectOnePlugin(e) {
      ...
      errorHandlers_readInt = {
        invalidDigit: (e, t, s, i) =>
          this.optionFlags & 4096
            ? (this.raise(l.InvalidDigit, ut(e, t, s), { radix: i }), !0)
            : !1,
        numericSeparatorInEscapeSequence: this.errorBuilder(
          l.NumericSeparatorInEscapeSequence,
        ),
        unexpectedNumericSeparator: this.errorBuilder(
          l.UnexpectedNumericSeparator,
        ),
      };
    ...
    ce = class {
      ...
      exit() {
        ...
        for (let [s, i] of Array.from(e.undefinedPrivateNames))
          t
            ...
            : this.parser.raise(l.InvalidPrivateFieldResolution, i, {
                identifierName: s,
              });
      }
      declarePrivateName(e, t, s) {
        ...
        (o &&
          this.parser.raise(l.PrivateNameRedeclaration, s, {
            identifierName: e,
          }),
          i.add(e),
          n.delete(e));
      ...
      usePrivateName(e, t) {
        ...
        s
          ...
          : this.parser.raise(l.InvalidPrivateFieldResolution, t, {
              identifierName: e,
            });
      }
    },
    ...
    le = class {
      ...
      recordAsyncArrowParametersError(e) {
        ...
        for (; i.canBeArrowParameterDeclaration(); )
          (i.type === 2 &&
            i.recordDeclarationError(l.AwaitBindingIdentifier, e),
            (i = t[--s]));
      }
      validateAsPattern() {
        let { stack: e } = this,
        ...
        t.canBeArrowParameterDeclaration() &&
          t.iterateErrors((s, i) => {
            ...
            for (; n.canBeArrowParameterDeclaration(); )
              (n.clearDeclarationError(i), (n = e[--r]));
          });
      }
    };
  function ar() {
  ...
  var ue = class extends oe {
      ...
      semicolon(e = !0) {
        (e ? this.isLineTerminator() : this.eat(9)) ||
          this.raise(l.MissingSemicolon, this.state.lastTokEndLoc);
      }
      expect(e, t) {
      ...
      checkExpressionErrors(e, t) {
        ...
        let {
          ...
          h = !!s || !!i || !!n || !!r || !!o;
        if (!t) return h;
        (s != null && this.raise(l.InvalidCoverInitializedName, s),
          i != null && this.raise(l.DuplicateProto, i),
          r != null && this.raise(l.UnexpectedPrivateField, r),
          n != null && this.unexpected(n),
          o != null && this.raise(l.InvalidCoverDiscardElement, o));
      }
      ...
      initializeScopes(e = this.options.sourceType === "module") {
        ...
        return (
          (this.expressionScope = new le(this)),
          () => {
            ((this.state.labels = t),
      ...
      enterInitialScopes() {
        let e = 0;
        ((this.inModule || this.optionFlags & 1) && (e |= 2),
          this.optionFlags & 32 && (e |= 1));
    ...
    K = class {
      constructor(e, t, s, i) {
        ((this.start = s),
          (this.end = 0),
          i !== void 0 && (this.loc = new st(i)),
          e & 128 && (this.range = [s, 0]),
          i !== void 0 && t && (this.loc.filename = t));
      }
      type = "";
    },
    He = K.prototype,
    fe = class extends ue {
      ...
      startNodeAt(e) {
        ...
        return t & 256
          ? new K(t, s, e.index, this.createPosition(e))
          : new K(t, s, e.index);
      }
      startNodeAtNode(e) {
        let { optionFlags: t, filename: s } = this;
        return t & 256
          ? new K(t, s, e.start, e.loc.start)
          : new K(t, s, e.start);
      }
      finishNode(e, t) {
      ...
      finishNodeAt(e, t, s) {
        ...
        return (
          i & 256 && (e.loc.end = this.createPosition(s)),
          i & 128 && (e.range[1] = s.index),
          i & 8192 && this.processComment(e),
          e
        );
      }
      finishNodeAtNode(e, t, s) {
        ...
        let { optionFlags: i } = this;
        return (
          i & 256 && (e.loc.end = s.loc.end),
          i & 128 && (e.range[1] = e.end),
          i & 8192 && this.processComment(e),
          e
        );
      }
      resetStartLocation(e, t) {
        ...
        (s & 256 && (e.loc.start = this.createPosition(t)),
          s & 128 && (e.range[0] = t.index));
      }
      resetEndLocation(e, t = this.state.lastTokEndLoc) {
        e.end = t.index;
        let { optionFlags: s } = this;
        (s & 256 && (e.loc.end = this.createPosition(t)),
          s & 128 && (e.range[1] = t.index));
      }
      resetStartLocationFromNode(e, t) {
        e.start = t.start;
        let { optionFlags: s } = this;
        (s & 256 && (e.loc.start = t.loc.start),
          s & 128 && (e.range[0] = t.start));
      }
    ...
    de = (a) => (a.type === "ParenthesizedExpression" ? de(a.expression) : a),
    me = class extends fe {
      toAssignable(e, t = !1) {
        let s;
        switch (
          ((e.type === "ParenthesizedExpression" || e.extra?.parenthesized) &&
            ((s = de(e)),
            t
              ? s.type === "Identifier"
                ...
                : s.type !== "CallExpression" &&
                  ...
                  this.raise(l.InvalidParenthesizedAssignment, e)
              : this.raise(l.InvalidParenthesizedAssignment, e)),
          e.type)
        ) {
          case "Identifier":
          ...
          case "ObjectExpression":
            ...
            for (let i = 0, r = e.properties.length, n = r - 1; i < r; i++) {
              let o = e.properties[i],
                h = i === n;
              (this.toAssignableObjectExpressionProp(o, h, t),
                h &&
                  o.type === "RestElement" &&
                  e.extra?.trailingCommaLoc &&
                  this.raise(l.RestTrailingComma, e.extra.trailingCommaLoc));
            }
            break;
          case "ObjectProperty": {
            let { key: i, value: r } = e;
          ...
          case "ArrayExpression":
            (this.castNodeTo(e, "ArrayPattern"),
              this.toAssignableList(e.elements, e.extra?.trailingCommaLoc, t));
            break;
          case "AssignmentExpression":
            (e.operator !== "=" &&
              this.raise(
                l.MissingEqInAssignment,
                this.optionFlags & 256 ? e.left.loc.end : e.left,
              ),
              this.castNodeTo(e, "AssignmentPattern"),
              delete e.operator,
              e.left.type === "VoidPattern" &&
                this.raise(l.VoidPatternInitializer, e.left),
      ...
      toAssignableObjectExpressionProp(e, t, s) {
        if (e.type === "ObjectMethod")
          ...
          (this.checkToRestConversion(i, !1),
            ...
            t || this.raise(l.RestTrailingComma, e));
      ...
      toAssignableList(e, t, s) {
        ...
        for (let r = 0; r <= i; r++) {
          ...
          n &&
            ...
            n.type === "RestElement" &&
              (r < i
                ? this.raise(l.RestTrailingComma, n)
                : t && this.raise(l.RestTrailingComma, t)));
        }
      }
      ...
      parseRestBinding() {
        ...
        return (
          t.type === "VoidPattern" && this.raise(l.UnexpectedVoidPattern, t),
          (e.argument = t),
      ...
      parseBindingList(e, t, s) {
        let i = s & 1,
          ...
          n = !0;
        for (; !this.eat(e); )
          if ((n ? (n = !1) : this.expect(8), i && this.match(8))) r.push(null);
          else {
            if (this.eat(e)) break;
            if (this.match(17)) {
              ...
              if (s & 2)
                for (
                  ...
                  this.raise(
                    l.UnsupportedParameterDecorator,
                    this.state.startLoc,
                  );
                  this.match(22);
                )
        ...
        return (
          ...
          this.hasPlugin("discardBinding") && this.match(84)
            ? ((e.argument = this.parseVoidPattern(null)),
              this.raise(l.UnexpectedVoidPattern, e.argument))
      ...
      parseBindingElement(e, t) {
        ...
        return (
          e & 2 && this.parseFunctionParamType(i),
          t.length &&
      ...
      parseMaybeDefault(e, t) {
        ...
        return (
          t.type === "VoidPattern" && this.raise(l.VoidPatternInitializer, t),
          (s.left = t),
      ...
      isValidLVal(e, t, s, i) {
        switch (e) {
          ...
          case "VoidPattern":
            return !0;
          case "CallExpression":
            if (!t && !this.state.strict && this.optionFlags & 16384) return !0;
        }
        return !1;
      }
      ...
      checkLVal(e, t, s = 64, i = !1, r = !1, n = !1, o = !1) {
        ...
        if (c || h === "MemberExpression") {
          (c &&
            ...
            t.type !== "AssignmentExpression" &&
              this.raise(l.InvalidLhsOptionalChaining, e, { ancestor: t })),
            s !== 64 && this.raise(l.InvalidPropertyBindingPattern, e));
          return;
        }
        if (h === "Identifier") {
          ...
          h === "VoidPattern" &&
            t.type === "CatchClause" &&
            this.raise(l.VoidPatternCatchClauseParam, e);
        let p = de(e);
        o ||
          (o =
            p.type === "CallExpression" &&
            (p.callee.type === "Import" || p.callee.type === "Super"));
        let f = this.isValidLVal(
          h,
          o,
          !(n || e.extra?.parenthesized) && t.type === "AssignmentExpression",
          s,
        );
        if (f === !0) return;
        if (f === !1) {
        ...
        typeof f == "string"
          ...
          : ([d, x] = f);
        let T = h === "ArrayPattern" || h === "ObjectPattern" ? { type: h } : t,
          D = e[d];
        if (Array.isArray(D))
          for (let v of D) v && this.checkLVal(v, T, s, i, r, x, !0);
        else D && this.checkLVal(D, T, s, i, r, x, o);
      }
      checkIdentifier(e, t, s = !1) {
        (this.state.strict &&
          (s ? as(e.name, this.inModule) : rs(e.name)) &&
          (t === 64
            ? this.raise(l.StrictEvalArguments, e, { referenceName: e.name })
            : this.raise(l.StrictEvalArgumentsBinding, e, {
                bindingName: e.name,
              })),
          t & 8192 && e.name === "let" && this.raise(l.LetInLexicalBinding, e),
          t & 64 || this.declareNameFromIdentifier(e, t));
      }
    ...
    ye = class extends me {
      ...
      getExpression() {
        if ((this.enterInitialScopes(), this.nextToken(), this.match(135)))
          throw this.raise(l.ParseExpressionEmptyInput, this.state.startLoc);
        let e = this.parseExpression();
        if (!this.match(135))
          throw this.raise(l.ParseExpressionExpectsEOF, this.state.startLoc, {
        ...
        return (
          ...
          this.optionFlags & 512 && (e.tokens = ls(this.tokens)),
          e
        );
      }
      parseExpression(e, t) {
      ...
      parseMaybeAssign(e, t) {
        ...
        if (i) {
          ...
          if (
            ...
            return (
              this.raiseOverwrite(l.YieldNotInGeneratorFunction, s),
              this.parseYield(s)
            );
        }
        return n;
      ...
      parseExprOp(e, t, s) {
        if (this.isPrivateName(e)) {
          ...
          ((s >= It(54) || !this.prodParam.hasIn || !this.match(54)) &&
            this.raise(l.PrivateInExpectedIn, t, { identifierName: r }),
            this.classScope.usePrivateName(r, t));
        }
      ...
      parseHackPipeBody() {
        ...
        return (
          di.has(t.type) &&
            ...
            this.raise(l.PipeUnparenthesizedBody, e, { type: t.type }),
          this.topicReferenceWasUsedInCurrentContext() ||
            this.raise(l.PipeTopicUnused, e),
          t
        );
      }
      checkExponentialAfterUnary(e) {
        this.match(53) &&
          this.raise(l.UnexpectedTokenUnaryExponentiation, e.argument);
      }
      parseMaybeUnary(e, t) {
        let s = this.state.startLoc,
        ...
        if (Ni(this.state.type)) {
          ...
          if (
            ...
            let c = n.argument;
            c.type === "Identifier"
              ? this.raise(l.StrictDelete, n)
              : this.hasPropertyAsPrivateName(c) &&
                this.raise(l.DeletePrivateField, n);
          }
          if (!r)
            return (
        ...
        if (i) {
          ...
          if (
            ...
            return (
              this.raiseOverwrite(l.AwaitNotInAsyncContext, s),
              this.parseAwait(s)
            );
        }
        return o;
      ...
      parseSubscript(e, t, s, i) {
        ...
        if (r === 14) {
          if (
            s &&
            (this.raise(l.OptionalChainingNoNew, this.state.startLoc),
        ...
        {
          let o = this.eat(0);
          return o || n || this.eat(12)
            ? this.parseMember(e, t, i, o, n)
      ...
      parseMember(e, t, s, i, r) {
        ...
        return (
          ...
          i
            ...
            : this.match(134)
              ? (e.type === "Super" && this.raise(l.SuperPrivateField, t),
      ...
      parseBind(e, t, s) {
        ...
        if (
          n.type === "Super" ||
          (r && n.type === "ImportExpression") ||
          n.type === "Import"
        )
          throw this.raise(l.UnsupportedBindRHS, n);
        return (
          (i.callee = n),
          (s.stop = !0),
      ...
      parseCoverCallAndAsyncArrowHead(e, t, s, i) {
        ...
        (o && (this.expressionScope.enter(or()), (r = new et())),
          h && (n.optional = i),
          i
            ? (n.arguments = this.parseCallExpressionArguments())
            : (n.arguments = this.parseCallExpressionArguments(
      ...
      parseTaggedTemplateExpression(e, t, s) {
        ...
        return (
          ...
          s.optionalChainMember && this.raise(l.OptionalChainingNoTemplate, t),
      ...
      finishCallExpression(e, t) {
        if (e.callee.type === "Import")
          if (e.arguments.length === 0 || e.arguments.length > 2)
            this.raise(l.ImportCallArity, e);
          else
            for (let s of e.arguments)
              s.type === "SpreadElement" &&
                this.raise(l.ImportCallSpreadArgument, s);
      ...
      parseAsyncArrowFromCallExpression(e, t) {
        return (
          ...
          t.innerComments && Pt(e, t.innerComments),
          t.callee.trailingComments && Pt(e, t.callee.trailingComments),
          e
        );
      }
      parseNoCallExpr() {
      ...
      parseExprAtom(e) {
        ...
        switch (i) {
          ...
          case 134:
            return (
              this.raise(l.PrivateInExpectedIn, this.state.startLoc, {
          ...
          default:
            if (C(i)) {
              ...
              let { canStartArrow: r, containsEsc: n } = this.state,
              ...
              if (!n && o.name === "async" && !this.canInsertSemicolon()) {
                ...
                if (C(h))
                  return r && this.lookaheadCharCode() === 61
              ...
              return r && this.match(15) && !this.canInsertSemicolon()
                ? (this.next(),
        ...
        if (this.testTopicReferenceConfiguration(s, t, i))
          return (
            this.topicReferenceIsAllowedInCurrentContext() ||
              this.raise(l.PipeTopicUnbound, t),
      ...
      parseAsyncArrowUnaryFunction(e) {
        ...
        return (
          ...
          this.hasPrecedingLineBreak() &&
            this.raise(l.LineTerminatorBeforeArrow, this.state.curPosition()),
          this.expect(15),
      ...
      parseSuper() {
        ...
        return (
          ...
          this.match(6) && !this.scope.allowDirectSuper
            ? this.raise(l.SuperNotAllowed, e)
            : this.scope.allowSuper || this.raise(l.UnexpectedSuper, e),
          !this.match(6) &&
            !this.match(0) &&
            !this.match(12) &&
            this.raise(l.UnsupportedSuper, e),
          this.finishNode(e, "Super")
        );
      }
      parsePrivateName() {
        let e = this.startNode(),
          t = this.startNodeAt(O(this.state.startLoc, 1)),
          s = this.state.value;
        return (
          this.next(),
      ...
      parseMetaProperty(e, t, s) {
        ...
        return (
          ...
          (e.property.name !== s || i) &&
            this.raise(l.UnsupportedMetaProperty, e.property, {
              target: t.name,
        ...
        if ((this.next(), this.isContextual(101) || this.isContextual(93))) {
          ...
          return (
            this.isContextual(97) &&
              (this.inModule || this.raise(l.ImportMetaOutsideModule, t),
      ...
      parseParenAndDistinguishExpression(e) {
        ...
        for (; !this.match(7); ) {
          if (o) o = !1;
            ...
            (this.expect(
              8,
              n.optionalParametersLoc === null ? null : n.optionalParametersLoc,
            ),
            this.match(7))
          ) {
          ...
          if (this.match(17)) {
            ...
            if (
              ...
              r.push(this.parseParenItem(this.parseRestBinding(), d)),
        ...
        return e && this.shouldParseArrow(r) && (f = this.parseArrow(f))
          ? (this.checkDestructuringPrivate(n),
            this.expressionScope.validateAsPattern(),
            this.expressionScope.exit(),
            this.parseArrowExpression(f, r, !1),
            f)
          : (this.expressionScope.exit(),
            ...
            r.length > 1
              ? ((s = this.startNodeAt(i)),
                (s.expressions = r),
                this.finishNode(s, "SequenceExpression"),
                this.resetEndLocation(s, p))
              : (s = r[0]),
      ...
      parseNewOrNewTarget() {
        ...
        if ((this.next(), this.match(12))) {
          ...
          return (
            this.scope.allowNewTarget || this.raise(l.UnexpectedNewTarget, s),
            s
          );
        }
      ...
      parseNewCallee(e) {
        ...
        ((e.callee = s),
          t &&
            s.type === "ImportExpression" &&
            this.raise(l.ImportCallNotNewExpression, s, s),
          s.type === "Import" && this.raise(l.ImportCallNotNewExpression, s),
          s.type === "Super" && this.raise(l.SuperCallNotNewExpression, s));
      }
      parseTemplateElement(e) {
        let { start: t, startLoc: s, end: i, value: r } = this.state,
          n = t + 1,
          o = this.startNodeAt(O(s, 1));
        r === null &&
          (e ||
            this.raise(
              l.InvalidEscapeSequenceTemplate,
              O(this.state.firstInvalidTemplateEscapePos, 1),
            ));
        let h = this.match(20),
          c = h ? -1 : -2,
          p = i + c;
...
`,
      ...
      parseObjectLike(e, t, s) {
        ...
        for (n.properties = [], this.next(); !this.match(e); ) {
          ...
          let h;
          (t
            ? (h = this.parseBindingProperty())
            : ((h = this.parsePropertyDefinition(s)),
              (i = this.checkProto(h, i, s))),
            n.properties.push(h));
        }
        this.next();
      ...
      parsePropertyDefinition(e) {
        ...
        if (this.match(22))
          for (
            this.hasPlugin("decorators") &&
            this.raise(l.UnsupportedPropertyDecorator, this.state.startLoc);
            this.match(22);
          )
        ...
        if (
          ...
          (p === "async" &&
            ...
            (p === "get" || p === "set") &&
              ...
              this.match(51) &&
                ((o = !0),
                this.raise(l.AccessorIsGenerator, this.state.curPosition(), {
                  kind: p,
                }),
                this.next()),
              this.parsePropertyName(s)));
      ...
      checkGetterSetterParams(e) {
        ...
        (s.length !== t &&
          this.raise(e.kind === "get" ? l.BadGetterArity : l.BadSetterArity, e),
          e.kind === "set" &&
            s[s.length - 1]?.type === "RestElement" &&
            this.raise(l.BadSetterRestParameter, e));
      }
        ...
        if (!e.computed && e.key.type === "Identifier") {
          if ((this.checkReservedWord(e.key.name, e.key.start, !0, !1), s))
            ...
            (i != null
              ...
              : this.raise(l.InvalidCoverInitializedName, r),
          ...
          if (B(s)) r = this.parseIdentifier(!0);
            ...
            switch (s) {
              ...
              case 134: {
                ...
                (t != null
                  ? t.privateKeyLoc === null && (t.privateKeyLoc = n)
                  : this.raise(l.UnexpectedPrivateField, n),
      ...
      parseMethod(e, t, s, i, r, n, o = !1) {
        (this.initFunction(e, s),
          ...
          this.prodParam.enter(Nt(s, e.generator)),
      ...
      parseArrowExpression(e, t, s, i) {
        ...
        let r = Nt(s, !1);
        return (
          this.match(2) || (r |= this.prodParam.currentFlags() & 24),
      ...
      parseFunctionBody(e, t, s = !1) {
        ...
        if ((this.expressionScope.enter(cs()), i))
          ...
          ((this.state.labels = []),
            ...
            (e.body = this.parseBlock(!0, !1, (o) => {
              ...
              o &&
                h &&
                this.raise(
                  l.IllegalLanguageModeDirective,
              ...
              (this.checkParams(e, !this.state.strict && !t && !s && !h, t, c),
                this.state.strict && e.id && this.checkIdentifier(e.id, 65, c));
            })),
            this.prodParam.exit(),
            (this.state.labels = n));
        }
      ...
      parseExprListItem(e, t, s, i) {
        ...
        if (this.match(8))
          (t ||
            this.raise(l.UnexpectedToken, this.state.curPosition(), {
              unexpected: ",",
            }),
            (r = null));
          ...
          (this.expectPlugin("partialApplication"),
            i ||
              this.raise(l.UnexpectedArgumentPlaceholder, this.state.startLoc));
      ...
      createIdentifier(e, t) {
        return (
          (e.name = t),
          this.optionFlags & 256 && (e.loc.identifierName = t),
      ...
      parseAwait(e, t) {
        ...
        return (
          ...
          this.eat(51) && this.raise(l.ObsoleteAwaitStar, e),
      ...
      isAmbiguousPrefixOrIdentifier() {
        ...
        return (
          ...
          e === 0 ||
          Xt(e) ||
          (e === 98 && !this.state.containsEsc) ||
          e === 133 ||
          e === 52 ||
          (this.hasPlugin("v8intrinsic") && e === 50)
        );
      }
      parseYield(e) {
        this.setLoc(e);
      ...
      parseImportCall(e) {
        ...
        if (t.length === 0 || t.length > 2) this.raise(l.ImportCallArity, e, e);
          ...
          for (let s of t)
            s.type === "SpreadElement" &&
              this.raise(l.ImportCallSpreadArgument, s, e);
        return (
          (e.source = t[0]),
          (e.options = t[1] ?? null),
      ...
      parseFSharpPipelineBody(e) {
        ...
        if (this.isContextual(92) && this.recordAwaitIfAllowed()) {
          ...
          je(i) &&
            i !== 35 &&
            (this.prodParam.hasIn || i !== 54) &&
            this.raise(l.PipelineUnparenthesized, t);
        } else
          ((this.state.canStartArrow = !0),
            (s = this.parseExprOp(this.parseMaybeUnaryOrPrivate(), t, e)));
      ...
      parseVoidPattern(e) {
        ...
        let t = this.startNode();
        return (
          e != null && (e.voidPatternLoc = this.state.startLoc),
          this.next(),
      ...
      parseMaybeAssignAllowInOrVoidPattern(e, t, s) {
        if (t != null && this.match(84)) {
          ...
          if (i === 44 || i === (e === 1 ? 93 : e === 4 ? 125 : 41) || i === 61)
  ...
  var xe = class extends ye {
        ...
        if (
          ...
          if (!(this.optionFlags & 64) && this.scope.undefinedExports.size > 0)
            for (let [r, n] of Array.from(this.scope.undefinedExports))
              this.raise(l.ModuleExportUndefined, n, { localName: r });
          this.addExtra(e, "topLevelAwait", this.state.hasTopLevelAwait);
        }
        let i;
        return (
          t === 135
            ? (i = this.finishNode(e, "Program"))
            : (i = this.finishNodeAt(e, "Program", O(this.state.startLoc, -1))),
          i
        );
      }
      stmtToDirective(e) {
      ...
      hasFollowingBindingAtom() {
        let e = this.nextTokenStart(),
          t = this.codePointAtPos(e);
        return (
          this.chStartsBindingPattern(t) || this.chStartsBindingIdentifier(t, e)
        );
      }
      ...
      parseStatementContent(e, t) {
        ...
        switch (s) {
                ...
                this.allowsUsing()
                  ? r
                    ? this.recordAwaitIfAllowed() ||
                      this.raise(l.AwaitUsingNotInAsyncContext, i)
                    : this.raise(l.UnexpectedLexicalDeclaration, i)
                  : this.raise(l.UnexpectedUsingDeclaration, i),
                this.next(),
          ...
          case 103:
            ...
            return (
              this.allowsUsing()
                ? r ||
                  this.raise(
                    l.UnexpectedLexicalDeclaration,
                    this.state.startLoc,
                  )
                : this.raise(l.UnexpectedUsingDeclaration, this.state.startLoc),
              this.parseVarStatement(i, "using")
            );
          case 96: {
            if (this.state.containsEsc) break;
            let p = this.nextTokenStart(),
              f = this.codePointAtPos(p);
            if (
              f !== 91 &&
              ((!r && this.hasFollowingLineBreak()) ||
                (!this.chStartsBindingIdentifier(f, p) && f !== 123))
            )
              break;
          }
          case 71:
            r ||
              this.raise(l.UnexpectedLexicalDeclaration, this.state.startLoc);
          case 70: {
          ...
          case 78: {
            (!(this.optionFlags & 8) &&
              !o &&
              this.raise(l.UnexpectedImportExport, this.state.startLoc),
              this.next());
            let p;
            return (
              s === 79
                ? (p = this.parseImport(i))
                : (p = this.parseExport(i, t)),
          ...
          default:
            if (this.isAsyncFunction())
              return (
                r ||
                  this.raise(
                    l.AsyncFunctionInSingleStatementContext,
                    this.state.startLoc,
                  ),
                this.next(),
        ...
        return C(s) && c.type === "Identifier" && this.eat(10)
          ? this.parseLabeledStatement(i, h, c, e)
          : this.parseExpressionStatement(i, c, t);
      }
      assertModuleNodeAllowed(e) {
        !(this.optionFlags & 8) &&
          !this.inModule &&
          this.raise(l.ImportOutsideModule, e);
      }
      maybeTakeDecorators(e, t, s) {
        return (
          e &&
            (t.decorators?.length
              ? (this.raise(l.DecoratorsBeforeAfterExport, t.decorators[0]),
      ...
      parseDecorator() {
        ...
        if ((this.next(), this.hasPlugin("decorators"))) {
          ...
          if (this.match(6)) {
            ...
            let r = this.state.startLoc;
            ((e.expression = this.parseMaybeDecoratorArguments(s, i)),
              e.expression !== s &&
                this.raise(l.DecoratorArgumentsOutsideParentheses, r));
          } else {
      ...
      verifyBreakContinue(e, t) {
        ...
        for (s = 0; s < this.state.labels.length; ++s) {
          ...
          if (
            ...
            ((i.kind != null && (t || i.kind === 1)) || (e.label && t))
          )
            break;
        }
      ...
      parseForStatement(e) {
        ...
        let s = this.isContextual(96);
        {
          let h = this.isAwaitUsing(),
            c = h || this.isForUsing(),
            p = (s && this.hasFollowingBindingAtom()) || c;
          if (this.match(70) || this.match(71) || p) {
            ...
            let x = this.finishNode(f, "VariableDeclaration"),
              T = this.match(54);
            return (
              T && c && this.raise(l.ForInUsing, x),
              (T || this.isContextual(98)) && x.declarations.length === 1
                ? this.parseForIn(e, x, t)
                : (t !== null && this.unexpected(t), this.parseFor(e, x))
            );
          }
        }
        ...
        if (
          (o &&
            (s && this.raise(l.ForOfLet, n),
            t === null &&
              i &&
              n.type === "Identifier" &&
              this.raise(l.ForOfAsync, n)),
          o || this.match(54))
        ) {
      ...
      parseReturnStatement(e) {
        return (
          this.prodParam.hasReturn ||
            this.raise(l.IllegalReturn, this.state.startLoc),
          this.next(),
          this.isLineTerminator()
            ? (e.argument = null)
      ...
      parseThrowStatement(e) {
        return (
          this.next(),
          this.hasPrecedingLineBreak() &&
            this.raise(l.NewlineAfterThrow, this.state.lastTokEndLoc),
      ...
      parseTryStatement(e) {
        ...
        return (
          ...
          !e.handler && !e.finalizer && this.raise(l.NoCatchOrFinally, e),
      ...
      parseWithStatement(e) {
        return (
          this.state.strict && this.raise(l.StrictWith, this.state.startLoc),
          this.next(),
      ...
      parseLabeledStatement(e, t, s, i) {
        for (let n of this.state.labels)
          n.name === t && this.raise(l.LabelRedeclaration, s, { labelName: t });
      ...
      parseForIn(e, t, s) {
        ...
        return (
          this.next(),
          i ? s !== null && this.unexpected(s) : (e.await = s !== null),
          t.type === "VariableDeclaration" &&
            ...
            this.raise(l.ForInOfLoopInitializer, t, {
              type: i ? "ForInStatement" : "ForOfStatement",
            }),
          t.type === "AssignmentPattern" &&
            this.raise(l.InvalidLhs, t, { ancestor: { type: "ForStatement" } }),
          (e.left = t),
          (e.right = i
          ...
          if (
            ...
            n.init === null &&
              ...
              !(t && (this.match(54) || this.isContextual(98)))
                ? this.raise(
                    l.DeclarationMissingInitializer,
      ...
      parseVarId(e, t) {
        ...
        (t === "using" || t === "await using"
          ? (s.type === "ArrayPattern" || s.type === "ObjectPattern") &&
            this.raise(l.UsingDeclarationHasBindingPattern, s)
          : s.type === "VoidPattern" && this.raise(l.UnexpectedVoidPattern, s),
          this.checkLVal(
            s,
      ...
      parseFunction(e, t = 0) {
        ...
        return (
          ...
          this.match(51) &&
            (s &&
              this.raise(
                l.GeneratorInSingleStatementContext,
                this.state.startLoc,
              ),
            this.next(),
            (e.generator = !0)),
          ...
          this.prodParam.enter(Nt(n, e.generator)),
      ...
      parseFunctionParams(e, t) {
        (this.expect(6),
          ...
          (e.params = this.parseBindingList(7, 41, 2 | (t ? 4 : 0))),
          this.expressionScope.exit());
      }
      ...
      parseClassMemberWithIsStatic(e, t, s, i) {
        ...
        if (
          ...
          (this.isNonstaticConstructor(r) &&
            this.raise(l.ConstructorIsGenerator, r.key),
            this.pushClassMethod(e, r, !0, !1, !1, !1));
          return;
        }
        let d = !this.state.containsEsc && C(this.state.type),
          x = this.parseClassElementName(t),
          T = d ? x.name : null,
          D = this.isPrivateName(x),
        ...
        if ((this.parsePostMemberNameModifiers(f), this.isClassMethod())) {
          ...
          let E = this.isNonstaticConstructor(r),
            I = !1;
          (E &&
            ((r.kind = "constructor"),
            r.decorators &&
              r.decorators.length > 0 &&
              this.raise(l.DecoratorConstructor, t),
            s.hadConstructor &&
              !this.hasPlugin("typescript") &&
              this.raise(l.DuplicateConstructor, x),
            E &&
              this.hasPlugin("typescript") &&
              t.override &&
              this.raise(l.OverrideOnConstructor, x),
            (s.hadConstructor = !0),
            (I = s.hadSuperClass)),
            this.pushClassMethod(e, r, !1, !1, E, I));
        } else if (this.isClassProperty())
          D
            ? this.pushClassPrivateProperty(e, h)
          ...
          (this.parseClassElementName(p),
            ...
            I
              ? this.pushClassPrivateMethod(e, n, E, !0)
              : (this.isNonstaticConstructor(r) &&
                  this.raise(l.ConstructorIsAsync, r.key),
                this.pushClassMethod(e, r, E, !0, !1, !1)));
        } else if (
          (T === "get" || T === "set") &&
          ...
          (this.parseClassElementName(r),
            E
              ? this.pushClassPrivateMethod(e, n, !1, !1)
              : (this.isNonstaticConstructor(r) &&
                  this.raise(l.ConstructorIsAccessor, r.key),
          ...
          (this.parseClassElementName(o),
            this.pushClassAccessorProperty(e, c, E));
        } else
          this.isLineTerminator()
            ? D
              ? this.pushClassPrivateProperty(e, h)
      ...
      parseClassElementName(e) {
        ...
        if (
          ((t === 128 || t === 130) &&
            e.static &&
            s === "prototype" &&
            this.raise(l.StaticPrototype, this.state.startLoc),
          t === 134)
        ) {
          s === "constructor" &&
            this.raise(l.ConstructorClassPrivateField, this.state.startLoc);
      ...
      parseClassStaticBlock(e, t) {
        ...
        (this.parseBlockOrModuleBlockBody(i, void 0, !1, 4),
          ...
          t.decorators?.length && this.raise(l.DecoratorStaticBlock, t));
      }
      pushClassProperty(e, t) {
        (!t.computed &&
          this.nameIsConstructor(t.key) &&
          this.raise(l.ConstructorClassField, t.key),
      ...
      parseExport(e, t) {
        let s = this.parseMaybeImportPhase(e, !0),
          ...
          o = n && this.maybeParseExportNamespaceSpecifier(e),
          h = r && (!o || this.eat(8)),
          c = i || n;
        if (n && !o) {
          if ((i && this.unexpected(), t))
            throw this.raise(l.UnsupportedDecoratorExport, e);
          return (
        ...
        (i && r && !n && !p && this.unexpected(null, 2),
          o && h && this.unexpected(null, 94));
        let f;
        if (c || p) {
        ...
        if (c || p || f) {
          ...
          if (
            ...
            this.maybeTakeDecorators(t, d.declaration, d);
        ...
        if (this.eat(61)) {
          ...
          if (((d.declaration = x), x.type === "ClassDeclaration"))
            this.maybeTakeDecorators(t, x, d);
          else if (t) throw this.raise(l.UnsupportedDecoratorExport, e);
          return (
      ...
      isExportDefaultSpecifier() {
        ...
        if (this.input.charCodeAt(t) === 44 || (C(this.state.type) && s))
          return !0;
        if (this.match(61) && s) {
      ...
      shouldParseExportDeclaration() {
        ...
        return e === 22 &&
          ...
          ? !0
          : this.isUsing()
            ? (this.raise(l.UsingDeclarationExport, this.state.startLoc), !0)
            : this.isAwaitUsing()
              ? (this.raise(l.UsingDeclarationExport, this.state.startLoc), !0)
              : e === 70 ||
                e === 71 ||
          ...
          if (s) {
            if (
              ...
              r.type === "Identifier" &&
                ...
                r.end - r.start === 4 &&
                !r.extra?.parenthesized &&
                this.raise(l.ExportDefaultFromAsIdentifier, r);
            }
            ...
            for (let r of e.specifiers) {
              ...
              if ((this.checkDuplicateExports(r, o), !i && r.local)) {
                let { local: h } = r;
                h.type !== "Identifier"
                  ? this.raise(l.ExportBindingIsString, r, {
                      localName: h.value,
                      exportName: o,
                    })
                  : (this.checkReservedWord(h.name, h.start, !0, !1),
      ...
      checkDuplicateExports(e, t) {
        (this.exportedIdentifiers.has(t) &&
          (t === "default"
            ? this.raise(l.DuplicateDefaultExport, e)
            : this.raise(l.DuplicateExport, e, { exportName: t })),
      ...
      parseModuleExportName() {
        if (this.match(130)) {
          ...
          return (
            t &&
              this.raise(l.ModuleExportNameHasLoneSurrogate, e, {
      ...
      checkImportPhase(e) {
        let { specifiers: t } = e,
          s = t.length === 1 ? t[0].type : null;
        e.phase === "source"
          ? s !== "ImportDefaultSpecifier" &&
            this.raise(l.SourcePhaseImportRequiresDefault, t[0])
          : e.phase === "defer" &&
            s !== "ImportNamespaceSpecifier" &&
            this.raise(l.DeferImportRequiresNamespace, t[0]);
      }
      ...
      parseMaybeImportPhase(e, t) {
        ...
        let s = this.startNode(),
          ...
          { type: r } = this.state;
        return (B(r) ? r !== 94 || this.lookaheadCharCode() === 102 : r !== 8)
      ...
      parseImportSpecifiersAndAfter(e, t) {
        e.specifiers = [];
        let i = !this.maybeParseDefaultImportSpecifier(e, t) || this.eat(8),
          r = i && this.maybeParseStarImportSpecifier(e);
        return (
          i && !r && this.parseNamedImportSpecifiers(e),
      ...
      parseImportAttributes() {
        ...
        do {
          ...
          if (
            (t.has(i) &&
              this.raise(
                l.ModuleAttributesWithDuplicateKeys,
                this.state.startLoc,
                { key: i },
              ),
            t.add(i),
      ...
      parseImportSpecifier(e, t, s, i, r) {
        if (this.eatContextual(89)) e.local = this.parseIdentifier();
          ...
          let { imported: n } = e;
          if (t)
            throw this.raise(l.ImportBindingIsString, e, {
              importName: n.value,
            });
          (this.checkReservedWord(n.name, e.start, !0, !0),
            e.local || (e.local = this.cloneIdentifier(n)));
        }
  ...
  var pr = {
      ...
      DecoratorAbstractMethod: ({ kind: a }) =>
        `Decorators can't be used with ${a.startsWith("a") ? "an" : "a"} ${a}.`,
      ...
      UnexpectedTypeDeclaration: (a) =>
        `'${a}' declarations can only be declared inside a block.`,
  ...
  var dr = (a) =>
    class extends a {
      ...
      tsParseModifier(t, s, i) {
        ...
        if (t.includes(r)) {
          if ((i && this.match(102)) || (s && this.tsIsStartOfStaticBlocks()))
            return;
      ...
      tsParseModifiers(
        {
          ...
          errorTemplate: r = m.InvalidModifierOnTypeMember,
        },
        n,
      ) {
        let o = (c, p, f, d) => {
            p === f &&
              n[d] &&
              this.raise(m.InvalidModifiersOrder, c, {
                orderedModifiers: [f, d],
              });
          },
          h = (c, p, f, d) => {
            ((n[f] && p === d) || (n[d] && p === f)) &&
              this.raise(m.IncompatibleModifiers, c, { modifiers: [f, d] });
          };
        for (;;) {
          let { startLoc: c } = this.state,
            p = this.tsParseModifier(t.concat(s ?? []), i, n.static);
          if (!p) break;
          (We(p)
            ? n.accessibility
              ? this.raise(m.DuplicateAccessibilityModifier, c, { modifier: p })
              : (o(c, p, p, "override"),
                o(c, p, p, "static"),
                o(c, p, p, "readonly"),
                (n.accessibility = p))
            : fr(p)
              ? (n[p] && this.raise(m.DuplicateModifier, c, { modifier: p }),
                (n[p] = !0),
                o(c, p, "in", "out"))
              : (lt(n, p)
                  ? this.raise(m.DuplicateModifier, c, { modifier: p })
                  : (o(c, p, "static", "readonly"),
                    o(c, p, "static", "override"),
                    o(c, p, "override", "readonly"),
                    o(c, p, "abstract", "override"),
                    h(c, p, "declare", "override"),
                    h(c, p, "static", "abstract")),
                (n[p] = !0)),
            s?.includes(p) && this.raise(r, c, { modifier: p }));
        }
      }
      ...
      tsParseDelimitedList(t, s, i) {
        return lr(this.tsParseDelimitedListWorker(t, s, !0, i));
      }
      ...
      tsParseImportType() {
        ...
        return (
          ...
          this.expect(6),
          this.match(130)
            ? (t.source = this.parseStringLiteral(this.state.value))
            : (this.raise(m.UnsupportedImportTypeArgument, this.state.startLoc),
              (t.source = this.tsParseNonConditionalType())),
          this.eat(8)
            ? (t.options = this.tsParseImportTypeOptions())
            : (t.options = null),
          this.expect(7),
          this.eat(12) && (t.qualifier = this.tsParseEntityName(3)),
          this.match(43) && (t.typeArguments = this.tsParseTypeArguments()),
      ...
      tsParseImportTypeOptions() {
        ...
        return (
          ...
          (t.properties = [this.finishObjectProperty(s)]),
          this.eat(8),
          this.expect(4),
      ...
      tsParseEntityName(t) {
        let s;
        if (t & 1 && this.match(74))
          if (t & 2) s = this.parseIdentifier(!0);
          else {
            let i = this.startNode();
        ...
        for (; this.eat(12); ) {
          ...
          ((i.left = s),
            (i.right = this.parseIdentifier(!!(t & 1))),
      ...
      tsParseTypeReference() {
        ...
        return (
          ...
          !this.hasPrecedingLineBreak() &&
            this.match(43) &&
            (t.typeArguments = this.tsParseTypeArguments()),
      ...
      tsParseTypeQuery() {
        ...
        return (
          ...
          this.match(79)
            ...
            : (t.exprName = this.tsParseEntityName(1)),
          !this.hasPrecedingLineBreak() &&
            this.match(43) &&
            (t.typeArguments = this.tsParseTypeArguments()),
      ...
      tsParseTypeParameter(t) {
        ...
        return (
          ...
          (s.constraint = this.tsEatThenParseType(77)),
          (s.default = this.tsEatThenParseType(25)),
      ...
      tsParseTypeParameters(t) {
        ...
        return (
          ...
          s.params.length === 0 && this.raise(m.EmptyTypeParameters, s),
      ...
      tsFillSignature(t, s) {
        ...
        ((s.typeParameters = this.tsTryParseTypeParameters(
          ...
          i
            ? (s[n] = this.tsParseTypeOrTypePredicateAnnotation(t))
            : this.match(t) &&
              (s[n] = this.tsParseTypeOrTypePredicateAnnotation(t)));
      }
      tsParseBindingListForSignature() {
        ...
        for (let s of t) {
          ...
          (i === "AssignmentPattern" || i === "TSParameterProperty") &&
            this.raise(m.UnsupportedSignatureParameterKind, s, { type: i });
        }
        return t;
      }
      ...
      tsIsUnambiguouslyIndexSignature() {
        return (
          this.next(),
          C(this.state.type) ? (this.next(), this.match(10)) : !1
        );
      }
      ...
      tsParsePropertyOrMethodSignature(t, s) {
        if (
          (this.eat(13) && (t.optional = !0), this.match(6) || this.match(43))
        ) {
          ...
          if (
            (i.kind &&
              this.match(43) &&
              this.raise(
                m.AccessorCannotHaveTypeParameters,
                this.state.curPosition(),
              ),
            this.tsFillSignature(10, i),
            this.tsParseTypeMemberSemicolon(),
            i.kind === "get")
          )
            i.params.length > 0 &&
              (this.raise(l.BadGetterArity, this.state.curPosition()),
              this.isThisParam(i.params[0]) &&
                this.raise(
                  m.AccessorCannotDeclareThisParameter,
                  this.state.curPosition(),
                ));
          else if (i.kind === "set") {
            if (i.params.length !== 1)
              ...
              (this.isThisParam(r) &&
                ...
                r.type === "Identifier" &&
                  r.optional &&
                  this.raise(
                    m.SetAccessorCannotHaveOptionalParameter,
                    this.state.curPosition(),
                  ),
                r.type === "RestElement" &&
                  this.raise(
                    m.SetAccessorCannotHaveRestParameter,
                    this.state.curPosition(),
                  ));
            }
            i.returnType &&
              this.raise(m.SetAccessorCannotHaveReturnType, i.returnType);
          } else i.kind = "method";
      ...
      tsParseTupleType() {
        ...
        let s = !1;
        return (
          t.elementTypes.forEach((i) => {
            let { type: r } = i;
            (s &&
              r !== "TSRestType" &&
              r !== "TSOptionalType" &&
              !(r === "TSNamedTupleMember" && i.optional) &&
              this.raise(m.OptionalTypeBeforeRequired, i),
              s ||
                (s =
                  (r === "TSNamedTupleMember" && i.optional) ||
                  r === "TSOptionalType"));
      ...
      tsParseTupleElementType() {
        let t = this.state.startLoc,
          ...
          o,
          h,
          p = B(this.state.type) ? this.lookaheadCharCode() : null;
        if (p === 58)
          ((r = !0),
            (o = !1),
          ...
          this.lookaheadCharCode() === 58
            ? ((r = !0),
              ...
              this.expect(10),
              (h = this.tsParseType()))
            : ((r = !1), (h = d), this.expect(13));
        } else
          ((h = this.tsParseType()), (o = this.eat(13)), (r = this.eat(10)));
        if (r) {
          let f;
          (n
            ? ((f = this.startNodeAt(i)),
              ...
              this.eat(13) &&
                ((f.optional = !0),
                this.raise(
                  m.TupleOptionalAfterType,
                  this.state.lastTokStartLoc,
                )))
            : ((f = this.startNodeAt(i)),
              (f.optional = o),
              this.raise(m.InvalidTupleMemberLabel, h),
              (f.label = h),
          ...
          case 49:
            if (this.state.value === "-") {
              let t = this.startNode(),
                s = this.lookahead();
              return (
                s.type !== 131 && s.type !== 132 && this.unexpected(),
          ...
          case 6:
            if (!(this.optionFlags & 2048)) {
              ...
              return (
                ...
                this.addExtra(s, "parenStart", t.index),
                s
              );
            }
      ...
      tsParseTypeOperator() {
        ...
        return (
          ...
          s === "readonly" && this.tsCheckTypeAnnotationForReadOnly(t),
      ...
      tsParseInferType() {
        ...
        return (
          ...
          (t.typeParameter = this.finishNode(s, "TSTypeParameter")),
      ...
      tsParseTypeOperatorOrHigher() {
        return ki(this.state.type) && !this.state.containsEsc
      ...
      tsParseTypePredicateAsserts() {
        ...
        return (
          this.next(),
          !C(this.state.type) && !this.match(74)
            ? !1
            : (t &&
                this.raise(
                  l.InvalidEscapedReservedWord,
                  this.state.lastTokStartLoc,
      ...
      tsParseTypeAssertion() {
        ...
        return (
          (t.typeAnnotation = this.tsInType(
            () => (
              this.next(),
              this.match(71) ? this.tsParseTypeReference() : this.tsParseType()
            ),
          )),
          this.expect(44),
      ...
      tsParseHeritageClause(t) {
        let s = this.state.startLoc,
          i = this.tsParseDelimitedList("HeritageClauseElement", () => {
            ...
            Pe(r) ||
              this.raise(m.InvalidHeritageClauseType, r.start, { token: t });
            let n =
              t === "extends" ? "TSInterfaceHeritage" : "TSClassImplements";
        ...
        return (
          i.length || this.raise(m.EmptyHeritageClauseType, s, { token: t }),
          i
        );
      }
      tsParseInterfaceDeclaration(t, s = {}) {
        ...
        (this.expectContextual(125),
          s.declare && (t.declare = !0),
          C(this.state.type)
            ? ((t.id = this.parseIdentifier()), this.checkIdentifier(t.id, 130))
            : ((t.id = null),
              this.raise(m.MissingInterfaceName, this.state.startLoc)),
        ...
        return (
          ...
          (t.typeAnnotation = this.tsInType(() => {
            if (
              ...
              this.expect(25),
              this.isContextual(110) && this.lookaheadCharCode() !== 46)
            ) {
              let s = this.startNode();
      ...
      tsParseEnumMember() {
        ...
        return (
          (t.id = this.match(130)
            ...
            : this.parseIdentifier(!0)),
          this.eat(25) && (t.initializer = super.parseMaybeAssignAllowIn()),
      ...
      tsParseEnumDeclaration(t, s = {}) {
        return (
          ...
          (t.id = this.parseIdentifier()),
          this.checkIdentifier(t.id, t.const ? 8971 : 8459),
          (t.body = this.tsParseEnumBody()),
      ...
      tsParseModuleBlock(t) {
        ...
        return (
          t || this.scope.enter(0),
          this.expect(2),
          super.parseBlockOrModuleBlockBody((s.body = []), void 0, !0, 4),
          t || this.scope.exit(),
      ...
      tsParseNamespaceDeclaration(t) {
        return (
          (t.id = this.tsParseEntityName(0)),
          t.id.type === "Identifier" && this.checkIdentifier(t.id, 1024),
          this.scope.enter(2048),
          this.prodParam.enter(0),
          (t.body = this.tsParseModuleBlock(!1)),
          this.prodParam.exit(),
          this.scope.exit(),
      ...
      tsParseAmbientExternalModuleDeclaration(t) {
        ...
        return (
          s
            ? ((t.kind = "global"), (t.id = this.parseIdentifier()))
            : ((t.kind = "module"),
              (t.id = super.parseStringLiteral(this.state.value))),
          this.match(2)
            ? (s || this.scope.enter(1024),
              this.prodParam.enter(0),
              (t.body = this.tsParseModuleBlock(s)),
              this.prodParam.exit(),
              s || this.scope.exit())
            : this.semicolon(),
          this.finishNode(t, "TSModuleDeclaration")
      ...
      tsParseImportEqualsDeclaration(t, s) {
        ((t.id = s || this.parseIdentifier()),
          this.checkIdentifier(t.id, 4096),
          this.expect(25));
        let i = this.tsParseModuleReference();
        return (
          t.importKind === "type" &&
            i.type !== "TSExternalModuleReference" &&
            this.raise(m.ImportAliasHasImportType, i),
          (t.moduleReference = i),
          this.semicolon(),
        ...
        return this.tsInAmbientContext(() => {
          switch (s) {
            case 64:
              return (
                (t.declare = !0),
                super.parseFunctionStatement(t, !1, !1)
              );
            case 76:
            ...
            case 70:
              return !this.match(71) || !this.isLookaheadContextual("enum")
                ? ((t.declare = !0),
                  this.parseVarStatement(t, this.state.value, !0))
                : (this.expect(71),
            ...
            case 103:
              if (this.isUsing())
                return (
                  this.raise(
                    m.InvalidModifierOnUsingDeclaration,
                    this.state.startLoc,
                    "declare",
                  ),
                  (t.declare = !0),
                  this.parseVarStatement(t, "using", !0)
                );
              break;
            case 92:
              if (this.isAwaitUsing())
                return (
                  this.raise(
                    m.InvalidModifierOnAwaitUsingDeclaration,
                    this.state.startLoc,
                    "declare",
                  ),
                  (t.declare = !0),
                  this.next(),
                  this.parseVarStatement(t, "await using", !0)
                );
              break;
            case 125: {
            ...
            default:
              if (C(s))
                return this.tsParseDeclaration(t, this.state.type, !0, null);
          }
        });
      }
        ...
        switch (s) {
          case 120:
            if (
              ...
              (this.match(76) || C(this.state.type))
            )
              return this.tsParseAbstractDeclaration(t, r);
            break;
          case 123:
          ...
          case 124:
            if (this.tsCheckLineTerminator(i) && C(this.state.type))
              return (
                (t.kind = "namespace"),
                this.tsParseNamespaceDeclaration(t)
              );
            break;
          case 126:
            if (this.tsCheckLineTerminator(i) && C(this.state.type))
      ...
      tsTryParseGenericAsyncArrowFunction(t) {
        ...
        let s = this.tsTryParseAndCatch(() => {
          let i = this.startNodeAt(t);
          return (
            (i.typeParameters = this.tsParseTypeParameters(
              this.tsParseConstModifier,
            )),
      ...
      tsParseTypeArguments() {
        ...
        return (
          ...
          t.params.length === 0
            ? this.raise(m.EmptyTypeArguments, t)
            : !this.state.inType &&
              this.curContext() === w.brace &&
              this.reScan_lt_gt(),
          this.expect(44),
      ...
      parseBindingElement(t, s) {
        let i = s.length ? null : this.state.startLoc,
          r = {};
        this.tsParseModifiers(
          {
            allowedModifiers: [
        ...
        !(t & 4) &&
          (n || h || o) &&
          this.raise(m.UnexpectedParameterModifier, i || s[0]);
        let c = this.state.startLoc,
          p = this.parseMaybeDefault(c);
        t & 2 && this.parseFunctionParamType(p);
        let f = this.parseMaybeDefault(c, p);
        if (n || h || o) {
          let d = i ? this.startNodeAt(i) : this.startNodeAtNode(s[0]);
          return (
            s.length ? (d.decorators = s) : this.setLoc(i),
            n && (d.accessibility = n),
            h && (d.readonly = h),
            o && (d.override = o),
            f.type !== "Identifier" &&
              f.type !== "AssignmentPattern" &&
              this.raise(m.UnsupportedParameterPropertyKind, i || s[0]),
            (d.parameter = f),
            this.finishNode(d, "TSParameterProperty")
          );
        }
      ...
      tsDisallowOptionalPattern(t) {
        for (let s of t.params)
          s.type !== "Identifier" &&
            ...
            this.raise(m.PatternIsOptional, s);
      }
      setArrowFunctionParameters(t, s, i) {
        (super.setArrowFunctionParameters(t, s, i),
          this.tsDisallowOptionalPattern(t));
      }
      parseFunctionBodyAndFinish(t, s, i = !1) {
        this.match(10) &&
          (t.returnType = this.tsParseTypeOrTypePredicateAnnotation(10));
        let r =
          s === "FunctionDeclaration"
            ? "TSDeclareFunction"
        ...
        if (r && !this.match(2) && this.isLineTerminator()) {
          if (r === "TSDeclareMethod" && t.kind === "constructor")
            for (let n of t.params)
              n.type === "TSParameterProperty"
                ? this.raise(m.UnexpectedParameterModifier, n)
                : n.type === "AssignmentPattern" &&
                  this.raise(m.UnexpectedParameterInitializer, n);
          else
            for (let n of t.params)
              n.type === "AssignmentPattern" &&
                this.raise(m.UnexpectedParameterInitializer, n);
        ...
        return r &&
          this.state.isAmbientContext &&
          (this.raise(m.DeclareFunctionHasImplementation, this.state.startLoc),
          r === "TSDeclareFunction" && t.declare)
          ? super.parseFunctionBodyAndFinish(t, r, i)
          : (this.tsDisallowOptionalPattern(t),
            super.parseFunctionBodyAndFinish(t, s, i));
      }
      registerFunctionStatementId(t) {
        !t.body && t.id
          ? this.checkIdentifier(t.id, 1024)
          : super.registerFunctionStatementId(t);
      }
      tsCheckForInvalidTypeCasts(t) {
        t.forEach((s) => {
          s?.type === "TSTypeCastExpression" &&
            this.raise(m.UnexpectedTypeAnnotation, s.typeAnnotation);
        });
      }
      toReferencedList(t, s) {
      ...
      parseSubscript(t, s, i, r) {
        ...
        if (this.match(43) || this.match(47)) {
          ...
          if ((o && this.unexpected(o, 6), h))
            return (
              h.type === "TSInstantiationExpression" &&
                ((this.match(12) ||
                  (this.match(14) && this.lookaheadCharCode() !== 40)) &&
                  this.raise(
                    m.InvalidPropertyAccessAfterInstantiationExpression,
                    this.state.startLoc,
                  ),
                !this.match(12) &&
                  !this.match(14) &&
                  (h.expression = super.stopParseSubscript(t, r))),
              h
            );
        }
        return super.parseSubscript(t, s, i, r);
      ...
      parseNewCallee(t) {
        ...
        s.type === "TSInstantiationExpression" &&
          ...
          ((t.typeArguments = s.typeArguments), (t.callee = s.expression));
      }
      parseExprOp(t, s, i) {
        let r;
        if (
          It(54) > i &&
          !this.hasPrecedingLineBreak() &&
          (this.isContextual(89) || (r = this.isContextual(116)))
        ) {
          let n = this.startNodeAt(s);
          ((n.expression = t),
            (n.typeAnnotation = this.tsInType(
              () => (
                ...
                this.match(71)
                  ? (r &&
                      this.raise(l.UnexpectedKeyword, this.state.startLoc, {
                        keyword: "const",
                      }),
      ...
      applyImportPhase(t, s, i, r) {
        (super.applyImportPhase(t, s, i, r),
          s
            ? (t.exportKind = i === "type" ? "type" : "value")
            : (t.importKind = i === "type" || i === "typeof" ? i : "value"));
      }
      parseImport(t) {
        if (this.match(130))
          return (
            (t.importKind = "value"),
            this.scope.inTSNamespace && this.raise(m.ImportInTSNamespace, t),
            super.parseImport(t)
          );
        let s;
        if (C(this.state.type) && this.lookaheadCharCode() === 61) {
          ...
          return (
            this.scope.inTSNamespace &&
              i.moduleReference.type === "TSExternalModuleReference" &&
              this.raise(m.ImportInTSNamespace, t),
            i
          );
          ...
          if (this.lookaheadCharCode() === 61)
            return (
              this.scope.inTSNamespace && this.raise(m.ImportInTSNamespace, t),
              this.tsParseImportEqualsDeclaration(t, i)
            );
        ...
        return (
          ...
          s.specifiers[0].type === "ImportDefaultSpecifier"
            ? this.raise(m.TypeImportCannotSpecifyDefaultAndNamed, s)
            : this.scope.inTSNamespace && this.raise(m.ImportInTSNamespace, s),
          s
        );
      }
      parseExport(t, s) {
        if (this.match(79)) {
          ...
          return (
            ...
            (this.sawUnambiguousESM = !0),
            this.scope.inTSNamespace &&
              this.raise(m.ExportAssignmentInTSNamespace, i),
          ...
          return (
            ...
            this.checkIdentifier(i.id, 8201),
            this.semicolon(),
            this.scope.inTSNamespace &&
              this.raise(m.NamespaceExportInTSNamespace, i),
          ...
          return (
            this.scope.inTSNamespace &&
              (i.type !== "ExportNamedDeclaration" ||
                i.source ||
                (!i.declaration && !this.state.isAmbientContext)) &&
              this.raise(m.ExportInTSNamespace, i),
            i
          );
        }
      }
      ...
      parseVarStatement(t, s, i = !1) {
        ...
        if (!r) return n;
        if (!t.declare && (s === "using" || s === "await using"))
          return (
            this.raiseOverwrite(m.UsingDeclarationInAmbientContext, t, s),
            n
          );
        for (let { id: o, init: h } of n.declarations)
          h &&
            (s === "var" || s === "let" || o.typeAnnotation
              ? this.raise(m.InitializerNotAllowedInAmbientContext, h)
              : yr(h, this.hasPlugin("estree")) ||
                this.raise(
                  m.ConstInitializerMustBeStringOrNumericLiteralOrLiteralEnumReference,
                  h,
                ));
        return n;
      }
          ...
          switch (this.state.type) {
            ...
            case 121: {
              if (
                ...
                let o =
                  r === 121
                    ? this.tsTryParseDeclare(n)
                    : this.tsParseAbstractDeclaration(n, s);
                return o
                  ? (r === 121 && (o.declare = !0), o)
                  : ((n.expression = this.createIdentifier(
                      this.startNodeAtNode(n),
                      r === 121 ? "declare" : "abstract",
                    )),
                    this.semicolon(!1),
            ...
            case 125: {
              ...
              if (r)
                return (
                  i || this.raise(m.UnexpectedTypeDeclaration, r, "interface"),
                  r
                );
              break;
            }
            case 123: {
              if (this.nextTokenIsStringLiteralOnSameLine()) {
                ...
                this.raise(
                  m.InlineModuleDeclarationMustUseString,
                  this.state.startLoc,
                );
                let r = this.startNode();
            ...
            case 126: {
              if (this.nextTokenIsIdentifierOnSameLine()) {
                let r = this.startNode();
                return (
                  i || this.raise(m.UnexpectedTypeDeclaration, r, "type"),
                  this.next(),
                  this.tsParseTypeAliasDeclaration(r)
                );
              }
              break;
            }
          ...
          this.tsIsStartOfStaticBlocks()
            ? (this.next(),
              ...
              this.tsHasSomeModifiers(s, r) &&
                this.raise(
                  m.StaticBlockCannotHaveModifier,
                  this.state.curPosition(),
                ),
              super.parseClassStaticBlock(t, s))
            : this.parseClassMemberWithIsStatic(t, s, i, !!s.static);
        };
        (s.declare ? this.tsInAmbientContext(n) : n(),
          s.decorators &&
            s.decorators.length > 0 &&
            !this.hasPlugin("decorators-legacy") &&
            (s.type === "TSAbstractMethodDefinition" ||
            s.type === "TSDeclareMethod"
              ? this.raise(m.DecoratorAbstractMethod, s, {
                  kind: "abstract method",
                })
              : ((s.type === "ClassProperty" && s.abstract) ||
                  (s.type === "ClassProperty" && s.declare) ||
                  s.type === "TSAbstractPropertyDefinition" ||
                  (s.type === "PropertyDefinition" && s.declare)) &&
                this.raise(m.DecoratorAbstractMethod, s, {
                  kind: s.declare ? "declare field" : "abstract field",
                })));
      }
      parseClassMemberWithIsStatic(t, s, i, r) {
        ...
        if (n) {
          (t.body.push(n),
            s.abstract && this.raise(m.IndexSignatureHasAbstract, s),
            s.accessibility &&
              this.raise(m.IndexSignatureHasAccessibility, s, {
                modifier: s.accessibility,
              }),
            s.declare && this.raise(m.IndexSignatureHasDeclare, s),
            s.override && this.raise(m.IndexSignatureHasOverride, s));
          return;
        }
        (!this.state.inAbstractClass &&
          s.abstract &&
          this.raise(m.NonAbstractClassHasAbstractMethod, s),
          s.override &&
            (i.hadSuperClass || this.raise(m.OverrideNotInSubClass, s)),
      ...
      parsePostMemberNameModifiers(t) {
        (this.eat(13) && (t.optional = !0),
          t.readonly &&
            this.match(6) &&
            this.raise(m.ClassMethodHasReadonly, t),
          t.declare && this.match(6) && this.raise(m.ClassMethodHasDeclare, t));
      }
      shouldParseExportDeclaration() {
        return this.tsIsDeclarationStart()
          ? !0
      ...
      parseConditional(t, s, i) {
        ...
        return (
          ...
          (this.state.inConditionalConsequent = n),
          this.expect(10),
      ...
      parseExportDeclaration(t) {
        ...
        if (
          ...
          throw this.raise(
            m.ExpectedAmbientAfterExportDeclare,
            this.state.startLoc,
          );
        let n =
          (C(this.state.type) && this.tsTryParseExportDeclaration()) ||
      ...
      parseClassPrivateProperty(t) {
        return (
          t.abstract && this.raise(m.PrivateElementHasAbstract, t),
          t.accessibility &&
            this.raise(m.PrivateElementHasAccessibility, t, {
      ...
      parseClassAccessorProperty(t) {
        return (
          this.parseClassPropertyAnnotation(t),
          t.optional && this.raise(m.AccessorCannotBeOptional, t),
          super.parseClassAccessorProperty(t)
        );
      }
      pushClassMethod(t, s, i, r, n, o) {
        ...
        (c &&
          (p === "get" || p === "set") &&
          this.raise(m.DeclareAccessor, s, { kind: p }),
      ...
      declareClassPrivateMethodInScope(t, s) {
        t.type !== "TSDeclareMethod" &&
          ((t.type === "MethodDefinition" && t.value.body == null) ||
            super.declareClassPrivateMethodInScope(t, s));
      }
      parseClassSuper(t) {
        if ((super.parseClassSuper(t), t.superClass))
          if (t.superClass.type === "TSInstantiationExpression") {
            ...
            (this.takeSurroundingComments(r, r.start, r.end),
              (t.superClass = i),
              (t.superTypeArguments = r));
          } else
            (this.match(43) || this.match(47)) &&
              (t.superTypeArguments = this.tsParseTypeArgumentsInExpression());
        this.eatContextual(109) &&
      ...
      parseObjPropValue(t, s, i, r, n, o, h) {
        ...
        return (
          c && (t.typeParameters = c),
          super.parseObjPropValue(t, s, i, r, n, o, h)
        );
      }
      parseFunctionParams(t, s) {
      ...
      parseAsyncArrowFromCallExpression(t, s) {
        return (
          this.match(10) && (t.returnType = this.tsParseTypeAnnotation()),
          super.parseAsyncArrowFromCallExpression(t, s)
        );
      }
      parseMaybeAssign(t, s) {
        let i, r, n;
          ...
          h = this.tryParse((c) => {
            ...
            if (
              ((p.type !== "ArrowFunctionExpression" ||
                p.extra?.parenthesized) &&
                c(),
              o?.params.length !== 0 && this.resetStartLocationFromNode(p, o),
              (p.typeParameters = o),
              this.hasPlugin("jsx") &&
                p.typeParameters.params.length === 1 &&
                !p.typeParameters.extra?.trailingComma)
            ) {
              let f = p.typeParameters.params[0];
              f.constraint ||
                this.raise(
                  m.SingleTypeParameterWithoutTrailingComma,
                  this.optionFlags & 256 ? O(f.loc.end, 1) : f,
        ...
        if (
          ...
          (n = this.tryParse(() => super.parseMaybeAssign(t, s), i)),
          !n.error)
        )
          return n.node;
        if (r?.node) return ((this.state = r.failState), r.node);
      ...
      parseArrow(t) {
        if (this.match(10)) {
          ...
          if (s.aborted) return;
          s.thrown ||
            (s.error && (this.state = s.failState), (t.returnType = s.node));
        }
        return super.parseArrow(t);
      }
      parseFunctionParamType(t) {
      ...
      toAssignable(t, s = !1) {
        switch (t.type) {
          ...
          case "TSTypeAssertion":
            (s
              ? this.expressionScope.recordArrowParameterBindingError(
                  m.UnexpectedTypeCastInParameter,
                  t,
                )
              : this.raise(m.UnexpectedTypeCastInParameter, t),
      ...
      parseMaybeDefault(t, s) {
        ...
        return (
          i.type === "AssignmentPattern" &&
            i.typeAnnotation &&
            i.right.start < i.typeAnnotation.start &&
            this.raise(m.TypeAnnotationAfterAssign, i.typeAnnotation),
          i
        );
      }
      getTokenFromCode(t) {
      ...
      shouldParseArrow(t) {
        return this.match(10)
          ? t.every((s) => this.isAssignable(s, !0))
      ...
      tsParseAbstractDeclaration(t, s) {
        if (this.match(76))
          return (
            (t.abstract = !0),
            this.maybeTakeDecorators(s, this.parseClass(t, !0, !1))
          );
        if (this.isContextual(125))
          return this.hasFollowingLineBreak()
            ? null
            : ((t.abstract = !0),
              this.raise(m.NonClassMethodPropertyHasAbstractModifier, t),
      ...
      parseMethod(t, s, i, r, n, o, h) {
        ...
        if (
          (c.abstract || c.type === "TSAbstractMethodDefinition") &&
          (this.hasPlugin("estree") ? c.value : c).body
        ) {
          let { key: d } = c;
          this.raise(m.AbstractMethodHasImplementation, c, {
            methodName:
              d.type === "Identifier" && !c.computed
                ? d.name
      ...
      parseExportSpecifier(t, s, i, r) {
        return !s && r
          ? (this.parseTypeOnlyImportExportSpecifier(t, !1, i),
            this.finishNode(t, "ExportSpecifier"))
          : ((t.exportKind = "value"), super.parseExportSpecifier(t, s, i, r));
      }
      parseImportSpecifier(t, s, i, r, n) {
        return !s && r
          ? (this.parseTypeOnlyImportExportSpecifier(t, !0, i),
            this.finishNode(t, "ImportSpecifier"))
          : ((t.importKind = "value"),
            super.parseImportSpecifier(t, s, i, r, i ? 4098 : 4096));
      }
      parseTypeOnlyImportExportSpecifier(t, s, i) {
            ...
            s
              ? ((o = this.parseIdentifier(!0)),
                this.isContextual(89) ||
                  this.checkReservedWord(o.name, o.start, !0, !0))
              : (o = this.parseModuleExportName()));
        (c &&
          i &&
          this.raise(
            s
              ? m.TypeModifierIsUsedInTypeImports
              : m.TypeModifierIsUsedInTypeExports,
            f,
          ),
          (t[r] = o),
          (t[n] = h));
        ...
        ((t[d] = c ? "type" : "value"),
          p &&
            this.eatContextual(89) &&
            (t[n] = s ? this.parseIdentifier() : this.parseModuleExportName()),
          t[n] || (t[n] = this.cloneIdentifier(t[r])),
          s && this.checkIdentifier(t[n], c ? 4098 : 4096));
      }
      fillOptionalPropertiesForTSESLint(t) {
        switch (t.type) {
          ...
          case "ObjectPattern":
            (t.decorators ?? (t.decorators = []),
              ...
              t.typeAnnotation ?? (t.typeAnnotation = void 0));
            return;
          case "TSParameterProperty":
            (t.accessibility ?? (t.accessibility = void 0),
              t.decorators ?? (t.decorators = []),
              t.override ?? (t.override = !1),
              t.readonly ?? (t.readonly = !1),
              t.static ?? (t.static = !1));
            return;
          ...
          case "ClassPrivateMethod":
            (t.declare ?? (t.declare = !1),
              t.returnType ?? (t.returnType = void 0),
              t.typeParameters ?? (t.typeParameters = void 0));
            return;
          case "Property":
            t.optional ?? (t.optional = !1);
            return;
          ...
          case "ClassDeclaration":
            (t.abstract ?? (t.abstract = !1),
              t.declare ?? (t.declare = !1),
              t.decorators ?? (t.decorators = []),
              t.implements ?? (t.implements = []),
              t.superTypeArguments ?? (t.superTypeArguments = void 0),
              t.typeParameters ?? (t.typeParameters = void 0));
            return;
          ...
          case "TSEnumMember":
            ...
            return;
          case "TSImportType":
            (t.qualifier ?? (t.qualifier = null),
              t.options ?? (t.options = null),
              t.typeArguments ?? (t.typeArguments = null));
            return;
          ...
          case "TSModuleDeclaration":
            (t.declare ?? (t.declare = !1),
              t.global ?? (t.global = t.kind === "global"));
            return;
  ...
  function yr(a, e) {
    ...
    return !!(
      ps(a, e) ||
      xr(a, e) ||
      (t === "TemplateLiteral" && a.expressions.length === 0) ||
      mr(a)
    );
  }
  function ps(a, e) {
  ...
  var Pr = {
    ...
    gr = (a) =>
      class extends a {
        ...
        getTokenFromCode(t) {
          t === 37 && this.input.charCodeAt(this.state.pos + 1) === 37
            ? this.finishOp(129, 2)
            : super.getTokenFromCode(t);
        }
        parseExprAtom(t) {
        ...
        cloneIdentifier(t) {
          let s = super.cloneIdentifier(t);
          return (
            s.type === "Placeholder" && (s.expectedNode = t.expectedNode),
            s
          );
        }
        cloneStringLiteral(t) {
          return t.type === "Placeholder"
            ? this.cloneIdentifier(t)
            : super.cloneStringLiteral(t);
        }
        parseBindingAtom() {
        ...
        parseBlock(t, s, i) {
          return (
            this.parsePlaceholder("BlockStatement") || super.parseBlock(t, s, i)
          );
        }
        parseFunctionId(t) {
          return (
        ...
        parseClass(t, s, i) {
          ...
          if (o)
            if (this.match(77) || this.match(129) || this.match(2)) t.id = o;
            else {
              if (i || !s)
                return (
                  (t.id = null),
          ...
          return (
            ...
            (t.body =
              ...
              super.parseClassBody(!!t.superClass, n)),
            this.finishNode(t, r)
          );
        }
        parseExport(t, s) {
        ...
        isExportDefaultSpecifier() {
          if (this.match(61)) {
            ...
            if (
              ...
              this.input.startsWith(z(129), this.nextTokenStartSince(t + 4))
            )
              return !0;
          }
        ...
        maybeParseExportDefaultSpecifier(t, s) {
          return t.specifiers?.length
            ? !0
            : super.maybeParseExportDefaultSpecifier(t, s);
        }
        checkExport(t) {
          let { specifiers: s } = t;
          (s?.length &&
            (t.specifiers = s.filter((i) => i.exported.type === "Placeholder")),
            super.checkExport(t),
            (t.specifiers = s));
        }
        parseImport(t) {
          ...
          if (((t.specifiers = []), !this.isContextual(94) && !this.match(8)))
            return (
              (t.source = this.finishPlaceholder(s, "StringLiteral")),
              this.semicolon(),
          ...
          return (
            (i.local = s),
            t.specifiers.push(this.finishNode(i, "ImportDefaultSpecifier")),
            this.eat(8) &&
        ...
        assertNoSpace() {
          this.state.start >
            this.offsetToSourcePos(this.state.lastTokEndLoc.index) &&
            this.raise(Je.UnexpectedSpace, this.state.lastTokEndLoc);
        }
      },
    Tr = (a) =>
      class extends a {
        parseV8Intrinsic() {
          if (this.match(50)) {
            ...
            if ((this.next(), C(this.state.type))) {
              ...
              if ((this.castNodeTo(r, "V8IntrinsicIdentifier"), this.match(6)))
                return r;
            }
            this.unexpected(t);
          }
    ...
    Xe = ["^^", "@@", "^", "%", "#"];
  function br(a) {
    if (a.has("decorators") && a.has("decorators-legacy"))
      throw new Error(
    ...
    if (a.has("pipelineOperator")) {
      ...
      if (!Ge.includes(e)) {
        ...
        throw new Error(
          `"pipelineOperator" requires "proposal" option whose value must be one of: ${t}.`,
        );
      }
      if (e === "hack") {
  ...
  function Er(a, e) {
    ...
    if (a.charAt(e) === "/" && a.charAt(e + 1) === "*") {
      for (let t = e + 2; t < a.length; ++t)
        if (a.charAt(t) === "*" && a.charAt(t + 1) === "/") return t + 2;
    }
    return e;
  }
  var ys = Er;
...
`
  ...
  function Nr(a, e) {
    let t = null,
      s = e;
    for (; s !== t; )
      ((t = s), (s = ds(a, s)), (s = ys(a, s)), (s = gs(a, s)), (s = Ps(a, s)));
    return s;
  }
  var Ts = Nr;
  function bs(a) {
...
`);
  ...
  function N(a) {
    let e = a.range?.[0] ?? a.start,
      t = (a.declaration?.decorators ?? a.decorators)?.[0];
    return t ? Math.min(N(t), e) : e;
  }
  var Or = 5,
    Fr = 8,
    Br = 8,
    Cs = (a) => (e) => (e.label ? k(e.label) : N(e) + a),
    Rr = (a) => a.__contentEnd ?? rt(a),
    Es = [
      "ExpressionStatement",
      "Directive",
      "ImportDeclaration",
    ...
    Ur = new Map([
      ["BreakStatement", Cs(Or)],
      ["ContinueStatement", Cs(Fr)],
      ["DebuggerStatement", (a) => N(a) + Br],
      ["VariableDeclaration", (a) => k(Ss(0, a.declarations, -1))],
      ...Es.map((a) => [a, Rr]),
    ]),
    Ne = J(Es);
  function k(a) {
  ...
  var at = J(["Block", "CommentBlock", "MultiLine"]),
    ws = J([
      "Line",
      "CommentLine",
      "SingleLine",
  ...
  function Is(a) {
    return nt(
      ...
      a,
      (e) =>
        at(e) && e.value[0] === "*" && /@(?:type|satisfies)\b/.test(e.value),
    );
  }
  function jr(a) {
    return U(0, a, /[^\n]/g, " ");
...
`)) {
  ...
  function Gr(a, e) {
    let { text: t, astType: s } = e,
      i = s === "oxc-ts",
      { comments: r } = a;
    Ds(r);
    let n = a.type === "File" ? a.program : a;
    (n.interpreter && (r.unshift(n.interpreter), delete n.interpreter),
      a.hashbang && (i && r.unshift(a.hashbang), delete a.hashbang),
      a.type === "Program" && (a.range = [0, t.length]));
    let o;
    return (
      (a = Rs(a, {
        onEnter(h) {
          switch ((Xr(h, r, t), h.type)) {
            case "ParenthesizedExpression": {
              let { expression: c } = h,
                p = N(h);
              if (c.type === "TypeCastExpression")
                return ((c.range = [p, k(h)]), c);
              let f = !1;
              if (!i) {
                if (!o) {
                  o = [];
                  for (let x of r) Is(x) && o.push(k(x));
                }
                let d = As(0, o, (x) => x <= p);
              ...
              return f
                ? void 0
                : ((c.extra = { ...c.extra, parenthesized: !0 }), c);
            }
            ...
            case "ImportDeclaration":
              s === "hermes" &&
                h.assertions &&
                !h.attributes &&
                ((h.attributes = h.assertions), delete h.assertions);
              break;
          }
        },
        onLeave(h) {
  ...
  function Yr(a, e) {
    let t = new SyntaxError(
      a + " (" + e.loc.start.line + ":" + e.loc.start.column + ")",
    );
  ...
  function Qr(a) {
    ...
    if (!t) return a;
    let { line: i, column: r } = t,
      n = a;
    (s === "MissingPlugin" || s === "MissingOneOfPlugins") &&
      ((e = "Unexpected token."), (n = void 0));
    let o = ` (${i}:${r})`;
    return (
      e.endsWith(o) && (e = e.slice(0, -o.length)),
      e.startsWith(js) && (e = e.slice(js.length)),
      Ut(e, { loc: { start: { line: i, column: r + 1 } }, cause: n })
    );
  }
  var _t = Qr;
  var Zr = /\*\/$/,
...
`,
  ...
  var Hs = ["noformat", "noprettier"],
    Ks = ["format", "prettier"];
  function Ws(a) {
    let e = Ft(a);
    e && (a = a.slice(e.length + 1));
    let t = $s(a),
      { pragmas: s, comments: i } = zs(t);
  ...
  function oa(a) {
    let {
      ...
      n = { type: e, comments: s, range: [0, i.length], rootMarker: r };
  ...
  var ot = (a) => G(ua(a)),
    ...
    j = (a, e = ha) => ({ ...e, plugins: [...e.plugins, ...a] }),
    ca = /@(?:no)?flow\b/;
  function la(a, e) {
    ...
    let s = Ts(a, 0);
    return (s !== !1 && (a = a.slice(0, s)), ca.test(a));
  }
  function pa(a, e, t) {
    let s = a(e, t),
      i = s.errors.find((r) => !da.has(r.reasonCode));
    if (i) throw i;
    return s;
  }
  function ua({ isExpression: a = !1, optionsCombinations: e }) {
    return (t, s = {}) => {
      let { filepath: i } = s;
      if (
        (typeof i != "string" && (i = void 0),
        (s.parser === "babel" || s.parser === "__babel_estree") && la(t, i))
      )
        return ((s.parser = "babel-flow"), ti.parse(t, s));
      let r = e,
        n = s.__babelSourceType ?? Xs(i);
      n &&
        n !== jt &&
        (r = r.map((p) => ({
          ...p,
      ...
      let o = /%[A-Z]/.test(t);
      t.includes("|>")
        ? (r = (o ? [...Qs, Ys] : Qs).flatMap((f) => r.map((d) => j([f], d))))
        : o && (r = r.map((p) => j([Ys], p)));
      let h = a ? Mt : Dt,
        c;
      try {
      ...
      return (
        a && (c = Vt({ expression: c, text: t, rootMarker: s.rootMarker })),
        _s(c, { text: t })
      );
    };
  }
  var fa = [
    ...
    da = new Set(fa),
    Zs = [j(["jsx"])],
    ma = ot({ optionsCombinations: Zs }),
    ya = ot({
      optionsCombinations: [j(["jsx", "typescript"]), j(["typescript"])],
    }),
    xa = ot({ isExpression: !0, optionsCombinations: [j(["jsx"])] }),
    Pa = ot({ isExpression: !0, optionsCombinations: [j(["typescript"])] }),
    ti = ot({
      optionsCombinations: [j(["jsx", ["flow", { all: !0 }], "flowComments"])],
    }),
    ga = ot({ optionsCombinations: Zs.map((a) => j(["estree"], a)) });
  var Fe = {};
  $t(Fe, {
    json: () => Aa,
    "json-stringify": () => Ea,
  ...
  function ba(a) {
    let e = Dt(a, ei),
      { program: t } = e;
    if (t.body.length === 0 && t.directives.length === 0 && !t.interpreter)
      return { comments: e.comments };
  }
  function bt(a, e = {}) {
    let { allowComments: t = !0, allowEmpty: s = !1 } = e,
      i,
      r;
    try {
      ...
      if (
        s &&
        n.code === "BABEL_PARSER_SYNTAX_ERROR" &&
        n.reasonCode === "ParseExpressionEmptyInput"
      )
        try {
          ({ comments: r } = ba(a));
        } catch {}
    ...
    return (
      (!s || i) && ht(i),
      (i = Vt({ type: "JsonRoot", expression: i, comments: r, text: a })),
      i
    );
  }
  function H(a, e) {
